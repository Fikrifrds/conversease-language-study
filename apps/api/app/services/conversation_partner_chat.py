...
def _reply_system_prompt(
    ...
    return (
        ...
        "- CRITICAL: Read the conversation so far. The learner has ALREADY told you things (their "
        "name, where they are from, their city, etc.). NEVER ask about something they already "
        "answered, and NEVER ask the same question twice. Each reply must move forward to a NEW "
        "detail of the topic.\n"
        "- Do NOT bounce a question back to the learner that you just asked them (e.g. after they "
        "say where they are from, do not reply 'How about you? Where are you from?'). If you "
