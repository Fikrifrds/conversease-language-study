...
class AdminCmsTest(unittest.TestCase):
    def test_curriculum_and_email_templates_are_readable(self):
        ...
        self.assertEqual(summary["course"]["lesson_count"], 10)
        self.assertEqual(summary["readiness_overview"]["planned_lesson_count"], 200)
        self.assertEqual(summary["readiness_overview"]["implemented_lesson_count"], 10)
        self.assertEqual(
    ...
    def test_admin_cms_routes_require_admin_key(self):
        ...
        try:
            with TestClient(app) as client:
                ...
                self.assertEqual(authorized.json()["data"]["curriculum"]["course"]["lesson_count"], 10)
            self.assertEqual(
