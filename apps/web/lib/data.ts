...
export const lessonCatalog = [
  // <generated:lessons>
    ...
    },
    {
      ...
      title: "Framing a Complex Topic",
      unit: "Advanced Presentations",
      conversationGoal: "Latih percakapan Arab C1 untuk pembingkaian topik kompleks dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "Building a Persuasive Flow",
      unit: "Advanced Presentations",
      conversationGoal: "Latih percakapan Arab C1 untuk pembangunan alur persuasif dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "Using Precise Transitions",
      unit: "Advanced Presentations",
      conversationGoal: "Latih percakapan Arab C1 untuk penggunaan transisi yang presisi dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "Handling Challenging Questions",
      unit: "Advanced Presentations",
      conversationGoal: "Latih percakapan Arab C1 untuk penanganan pertanyaan menantang dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "Advanced Presentation Mission",
      unit: "Advanced Presentations",
      conversationGoal: "Latih percakapan Arab C1 untuk presentasi lanjutan yang jelas dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "Review Nuance and Strategy",
      unit: "C1 Review & Final Conversation",
      conversationGoal: "Latih percakapan Arab C1 untuk peninjauan nuansa dan strategi dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "Review Presenting and Debate",
      unit: "C1 Review & Final Conversation",
      conversationGoal: "Latih percakapan Arab C1 untuk peninjauan presentasi dan debat dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "Review Leadership and Listening",
      unit: "C1 Review & Final Conversation",
      conversationGoal: "Latih percakapan Arab C1 untuk peninjauan kepemimpinan dan listening dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "C1 Final Test Practice",
      unit: "C1 Review & Final Conversation",
      conversationGoal: "Latih percakapan Arab C1 untuk latihan tes akhir C1 dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
    ...
    },
    {
      ...
      title: "C1 Final Conversation",
      unit: "C1 Review & Final Conversation",
      conversationGoal: "Latih percakapan Arab C1 untuk percakapan akhir C1 yang utuh dengan nuansa, struktur, presisi, dan respons profesional.",
      visuals: {
...
export const coachTurnsByLessonSlug = {
  ...
  "arabic-b1-b1-final-test-practice": [
    { coach: "لِنَتَدَرَّبْ عَلَى تَدْرِيبِ الِاخْتِبَارِ النِّهَائِيِّ. كَيْفَ تَبْدَأُ الْحِوَارَ؟", hint: "Jawab dengan kalimat terhubung memakai: سَأُجِيبُ بِجُمَلٍ مُتَرَابِطَةٍ.", sampleAnswer: "سَأُجِيبُ بِجُمَلٍ مُتَرَابِطَةٍ.", focus: "Gunakan untuk percakapan B1 yang lebih terhubung.", expectedKeywords: ["سَأُجِيبُ", "بِجُمَلٍ", "مُتَرَابِطَةٍ"], indonesianExplanation: "Saya akan menjawab dengan kalimat yang terhubung." },
  ...
  "arabic-b1-review-goals-and-preferences": [
    { coach: "لِنَتَدَرَّبْ عَلَى مُرَاجَعَةِ الأَهْدَافِ وَالتَّفْضِيلَاتِ. كَيْفَ تَبْدَأُ الْحِوَارَ؟", hint: "Jawab dengan kalimat terhubung memakai: هَدَفِي وَاضِحٌ وَلَكِنَّ التَّحَدِّي مَوْجُودٌ.", sampleAnswer: "هَدَفِي وَاضِحٌ وَلَكِنَّ التَّحَدِّي مَوْجُودٌ.", focus: "Gunakan untuk percakapan B1 yang lebih terhubung.", expectedKeywords: ["هَدَفِي", "وَاضِحٌ", "وَلَكِنَّ", "التَّحَدِّي"], indonesianExplanation: "Tujuan saya jelas tetapi tantangannya ada." },
  ...
  "arabic-b1-review-problems-and-travel": [
    { coach: "لِنَتَدَرَّبْ عَلَى مُرَاجَعَةِ مُشْكِلَةٍ فِي السَّفَرِ. كَيْفَ تَبْدَأُ الْحِوَارَ؟", hint: "Jawab dengan kalimat terhubung memakai: سَأَشْرَحُ مُشْكِلَةً ثُمَّ أَقْتَرِحُ حَلًّا.", sampleAnswer: "سَأَشْرَحُ مُشْكِلَةً ثُمَّ أَقْتَرِحُ حَلًّا.", focus: "Gunakan untuk percakapan B1 yang lebih terhubung.", expectedKeywords: ["سَأَشْرَحُ", "مُشْكِلَةً", "ثُمَّ", "أَقْتَرِحُ"], indonesianExplanation: "Saya akan menjelaskan masalah lalu menyarankan solusi." },
  ...
  "arabic-b1-review-stories-and-work": [
    { coach: "لِنَتَدَرَّبْ عَلَى مُرَاجَعَةِ قِصَّةٍ وَتَحْدِيثِ عَمَلٍ. كَيْفَ تَبْدَأُ الْحِوَارَ؟", hint: "Jawab dengan kalimat terhubung memakai: سَأَبْدَأُ بِقِصَّةٍ قَصِيرَةٍ.", sampleAnswer: "سَأَبْدَأُ بِقِصَّةٍ قَصِيرَةٍ.", focus: "Gunakan untuk percakapan B1 yang lebih terhubung.", expectedKeywords: ["سَأَبْدَأُ", "بِقِصَّةٍ", "قَصِيرَةٍ"], indonesianExplanation: "Saya akan mulai dengan cerita singkat." },
  ...
  "arabic-b2-answering-questions": [
    { coach: "مَا رَأْيُكَ فِي أَسْئِلَةِ الْجُمْهُورِ بَعْدَ الْعَرْضِ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي أَسْئِلَةِ الْجُمْهُورِ بَعْدَ الْعَرْضِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي أَسْئِلَةِ الْجُمْهُورِ بَعْدَ الْعَرْضِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka presentasi.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "أَسْئِلَةِ", "الْجُمْهُورِ", "بَعْدَ"], indonesianExplanation: "Posisi saya adalah bahwa pertanyaan audiens setelah presentasi membutuhkan keputusan yang jelas." },
  ...
  "arabic-b2-b2-final-discussion": [
    { coach: "مَا رَأْيُكَ فِي النِّقَاشِ النِّهَائِيِّ فِي بِي اِثْنَيْنِ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي النِّقَاشِ النِّهَائِيِّ فِي بِي اِثْنَيْنِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي النِّقَاشِ النِّهَائِيِّ فِي بِي اِثْنَيْنِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka sesi peninjauan ulang.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "النِّقَاشِ", "النِّهَائِيِّ", "فِي"], indonesianExplanation: "Posisi saya adalah bahwa diskusi akhir B2 membutuhkan keputusan yang jelas." },
  ...
  "arabic-b2-b2-final-test-practice": [
    { coach: "مَا رَأْيُكَ فِي تَدْرِيبِ الِاخْتِبَارِ النِّهَائِيِّ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي تَدْرِيبِ الِاخْتِبَارِ النِّهَائِيِّ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي تَدْرِيبِ الِاخْتِبَارِ النِّهَائِيِّ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka sesi peninjauan ulang.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "تَدْرِيبِ", "الِاخْتِبَارِ", "النِّهَائِيِّ"], indonesianExplanation: "Posisi saya adalah bahwa latihan ujian akhir membutuhkan keputusan yang jelas." },
    { coach: "استخدم الفكرة: أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", hint: "Jawab dengan struktur B2 memakai: أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", sampleAnswer: "أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", focus: "Mereview kemampuan menyusun argumen.", expectedKeywords: ["أَسْتَطِيعُ", "أَنْ", "أُقَدِّمَ", "رَأْيًا", "وَأَدْعَمَهُ"], indonesianExplanation: "Saya bisa menyampaikan pendapat dan mendukungnya dengan bukti." },
    { coach: "استخدم الفكرة: أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", hint: "Jawab dengan struktur B2 memakai: أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", sampleAnswer: "أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", focus: "Mereview kemampuan percakapan profesional.", expectedKeywords: ["أَسْتَطِيعُ", "أَيْضًا", "أَنْ", "أُدِيرَ", "حِوَارًا"], indonesianExplanation: "Saya juga bisa mengelola percakapan profesional dengan jelas." },
    { coach: "استخدم الفكرة: إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", hint: "Jawab dengan struktur B2 memakai: إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", sampleAnswer: "إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", focus: "Mereview respons terhadap keberatan.", expectedKeywords: ["إِذَا", "ظَهَرَ", "اِعْتِرَاضٌ،", "فَسَأَرُدُّ", "عَلَيْهِ"], indonesianExplanation: "Jika muncul keberatan, saya akan menanggapinya dengan tenang." },
  ],
  ...
  "arabic-b2-explaining-benefits-and-risks": [
    { coach: "مَا رَأْيُكَ فِي شَرْحِ فَوَائِدِ الْأَتْمَتَةِ وَمَخَاطِرِهَا؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي شَرْحِ فَوَائِدِ الْأَتْمَتَةِ وَمَخَاطِرِهَا أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي شَرْحِ فَوَائِدِ الْأَتْمَتَةِ وَمَخَاطِرِهَا أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka presentasi.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "شَرْحِ", "فَوَائِدِ", "الْأَتْمَتَةِ"], indonesianExplanation: "Posisi saya adalah bahwa penjelasan manfaat dan risiko otomatisasi membutuhkan keputusan yang jelas." },
    { coach: "استخدم الفكرة: بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", hint: "Jawab dengan struktur B2 memakai: بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", sampleAnswer: "بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", focus: "Memberi signposting.", expectedKeywords: ["بَعْدَ", "ذَلِكَ،", "سَأَشْرَحُ", "الْفَائِدَةَ", "الْأَسَاسِيَّةَ"], indonesianExplanation: "Setelah itu, saya akan menjelaskan manfaat utamanya." },
    { coach: "استخدم الفكرة: مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", hint: "Jawab dengan struktur B2 memakai: مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", sampleAnswer: "مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", focus: "Menjelaskan risk secara seimbang.", expectedKeywords: ["مِنَ", "الْمُهِمِّ", "أَنْ", "نَذْكُرَ", "الْمَخَاطِرَ"], indonesianExplanation: "Penting juga untuk menyebutkan risikonya." },
    { coach: "استخدم الفكرة: إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", hint: "Jawab dengan struktur B2 memakai: إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", sampleAnswer: "إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", focus: "Menyiapkan Q&A.", expectedKeywords: ["إِذَا", "كَانَتْ", "هُنَاكَ", "أَسْئِلَةٌ،", "فَسَأُجِيبُ"], indonesianExplanation: "Jika ada pertanyaan, saya akan menjawabnya dengan jelas." },
  ],
  ...
  "arabic-b2-idea-presentation-mission": [
    { coach: "مَا رَأْيُكَ فِي تَقْدِيمِ فِكْرَةٍ أَمَامَ الْمُدِيرِ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي تَقْدِيمِ فِكْرَةٍ أَمَامَ الْمُدِيرِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي تَقْدِيمِ فِكْرَةٍ أَمَامَ الْمُدِيرِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka presentasi.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "تَقْدِيمِ", "فِكْرَةٍ", "أَمَامَ"], indonesianExplanation: "Posisi saya adalah bahwa presentasi ide di depan manajer membutuhkan keputusan yang jelas." },
    { coach: "استخدم الفكرة: بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", hint: "Jawab dengan struktur B2 memakai: بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", sampleAnswer: "بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", focus: "Memberi signposting.", expectedKeywords: ["بَعْدَ", "ذَلِكَ،", "سَأَشْرَحُ", "الْفَائِدَةَ", "الْأَسَاسِيَّةَ"], indonesianExplanation: "Setelah itu, saya akan menjelaskan manfaat utamanya." },
    { coach: "استخدم الفكرة: مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", hint: "Jawab dengan struktur B2 memakai: مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", sampleAnswer: "مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", focus: "Menjelaskan risk secara seimbang.", expectedKeywords: ["مِنَ", "الْمُهِمِّ", "أَنْ", "نَذْكُرَ", "الْمَخَاطِرَ"], indonesianExplanation: "Penting juga untuk menyebutkan risikonya." },
    { coach: "استخدم الفكرة: إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", hint: "Jawab dengan struktur B2 memakai: إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", sampleAnswer: "إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", focus: "Menyiapkan Q&A.", expectedKeywords: ["إِذَا", "كَانَتْ", "هُنَاكَ", "أَسْئِلَةٌ،", "فَسَأُجِيبُ"], indonesianExplanation: "Jika ada pertanyaan, saya akan menjawabnya dengan jelas." },
  ],
  ...
  "arabic-b2-review-arguments-and-meetings": [
    { coach: "مَا رَأْيُكَ فِي مُرَاجَعَةِ الْحُجَّةِ وَمُلَخَّصِ الِاجْتِمَاعِ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي مُرَاجَعَةِ الْحُجَّةِ وَمُلَخَّصِ الِاجْتِمَاعِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي مُرَاجَعَةِ الْحُجَّةِ وَمُلَخَّصِ الِاجْتِمَاعِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka sesi peninjauan ulang.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "مُرَاجَعَةِ", "الْحُجَّةِ", "وَمُلَخَّصِ"], indonesianExplanation: "Posisi saya adalah bahwa review argumen dan ringkasan rapat membutuhkan keputusan yang jelas." },
    { coach: "استخدم الفكرة: أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", hint: "Jawab dengan struktur B2 memakai: أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", sampleAnswer: "أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", focus: "Mereview kemampuan menyusun argumen.", expectedKeywords: ["أَسْتَطِيعُ", "أَنْ", "أُقَدِّمَ", "رَأْيًا", "وَأَدْعَمَهُ"], indonesianExplanation: "Saya bisa menyampaikan pendapat dan mendukungnya dengan bukti." },
    { coach: "استخدم الفكرة: أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", hint: "Jawab dengan struktur B2 memakai: أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", sampleAnswer: "أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", focus: "Mereview kemampuan percakapan profesional.", expectedKeywords: ["أَسْتَطِيعُ", "أَيْضًا", "أَنْ", "أُدِيرَ", "حِوَارًا"], indonesianExplanation: "Saya juga bisa mengelola percakapan profesional dengan jelas." },
    { coach: "استخدم الفكرة: إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", hint: "Jawab dengan struktur B2 memakai: إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", sampleAnswer: "إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", focus: "Mereview respons terhadap keberatan.", expectedKeywords: ["إِذَا", "ظَهَرَ", "اِعْتِرَاضٌ،", "فَسَأَرُدُّ", "عَلَيْهِ"], indonesianExplanation: "Jika muncul keberatan, saya akan menanggapinya dengan tenang." },
  ],
  "arabic-b2-review-information-and-clients": [
    { coach: "مَا رَأْيُكَ فِي مُرَاجَعَةِ الْمَعْلُومَاتِ وَحَدِيثِ الْعَمِيلِ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي مُرَاجَعَةِ الْمَعْلُومَاتِ وَحَدِيثِ الْعَمِيلِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي مُرَاجَعَةِ الْمَعْلُومَاتِ وَحَدِيثِ الْعَمِيلِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka sesi peninjauan ulang.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "مُرَاجَعَةِ", "الْمَعْلُومَاتِ", "وَحَدِيثِ"], indonesianExplanation: "Posisi saya adalah bahwa review informasi dan percakapan klien membutuhkan keputusan yang jelas." },
    { coach: "استخدم الفكرة: أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", hint: "Jawab dengan struktur B2 memakai: أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", sampleAnswer: "أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", focus: "Mereview kemampuan menyusun argumen.", expectedKeywords: ["أَسْتَطِيعُ", "أَنْ", "أُقَدِّمَ", "رَأْيًا", "وَأَدْعَمَهُ"], indonesianExplanation: "Saya bisa menyampaikan pendapat dan mendukungnya dengan bukti." },
    { coach: "استخدم الفكرة: أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", hint: "Jawab dengan struktur B2 memakai: أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", sampleAnswer: "أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", focus: "Mereview kemampuan percakapan profesional.", expectedKeywords: ["أَسْتَطِيعُ", "أَيْضًا", "أَنْ", "أُدِيرَ", "حِوَارًا"], indonesianExplanation: "Saya juga bisa mengelola percakapan profesional dengan jelas." },
    { coach: "استخدم الفكرة: إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", hint: "Jawab dengan struktur B2 memakai: إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", sampleAnswer: "إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", focus: "Mereview respons terhadap keberatan.", expectedKeywords: ["إِذَا", "ظَهَرَ", "اِعْتِرَاضٌ،", "فَسَأَرُدُّ", "عَلَيْهِ"], indonesianExplanation: "Jika muncul keberatan, saya akan menanggapinya dengan tenang." },
  ],
  "arabic-b2-review-negotiation-and-presenting": [
    { coach: "مَا رَأْيُكَ فِي مُرَاجَعَةِ التَّفَاوُضِ وَالْعَرْضِ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي مُرَاجَعَةِ التَّفَاوُضِ وَالْعَرْضِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي مُرَاجَعَةِ التَّفَاوُضِ وَالْعَرْضِ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka sesi peninjauan ulang.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "مُرَاجَعَةِ", "التَّفَاوُضِ", "وَالْعَرْضِ"], indonesianExplanation: "Posisi saya adalah bahwa review negosiasi dan presentasi membutuhkan keputusan yang jelas." },
    { coach: "استخدم الفكرة: أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", hint: "Jawab dengan struktur B2 memakai: أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", sampleAnswer: "أَسْتَطِيعُ أَنْ أُقَدِّمَ رَأْيًا وَأَدْعَمَهُ بِدَلِيلٍ.", focus: "Mereview kemampuan menyusun argumen.", expectedKeywords: ["أَسْتَطِيعُ", "أَنْ", "أُقَدِّمَ", "رَأْيًا", "وَأَدْعَمَهُ"], indonesianExplanation: "Saya bisa menyampaikan pendapat dan mendukungnya dengan bukti." },
    { coach: "استخدم الفكرة: أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", hint: "Jawab dengan struktur B2 memakai: أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", sampleAnswer: "أَسْتَطِيعُ أَيْضًا أَنْ أُدِيرَ حِوَارًا مِهَنِيًّا بِوُضُوحٍ.", focus: "Mereview kemampuan percakapan profesional.", expectedKeywords: ["أَسْتَطِيعُ", "أَيْضًا", "أَنْ", "أُدِيرَ", "حِوَارًا"], indonesianExplanation: "Saya juga bisa mengelola percakapan profesional dengan jelas." },
    { coach: "استخدم الفكرة: إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", hint: "Jawab dengan struktur B2 memakai: إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", sampleAnswer: "إِذَا ظَهَرَ اِعْتِرَاضٌ، فَسَأَرُدُّ عَلَيْهِ بِهُدُوءٍ.", focus: "Mereview respons terhadap keberatan.", expectedKeywords: ["إِذَا", "ظَهَرَ", "اِعْتِرَاضٌ،", "فَسَأَرُدُّ", "عَلَيْهِ"], indonesianExplanation: "Jika muncul keberatan, saya akan menanggapinya dengan tenang." },
  ],
  "arabic-b2-signposting-clearly": [
    { coach: "مَا رَأْيُكَ فِي تَرْتِيبِ عَرْضٍ عَنْ خِدْمَةٍ جَدِيدَةٍ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي تَرْتِيبِ عَرْضٍ عَنْ خِدْمَةٍ جَدِيدَةٍ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي تَرْتِيبِ عَرْضٍ عَنْ خِدْمَةٍ جَدِيدَةٍ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka presentasi.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "تَرْتِيبِ", "عَرْضٍ", "عَنْ"], indonesianExplanation: "Posisi saya adalah bahwa susunan presentasi layanan baru membutuhkan keputusan yang jelas." },
    { coach: "استخدم الفكرة: بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", hint: "Jawab dengan struktur B2 memakai: بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", sampleAnswer: "بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", focus: "Memberi signposting.", expectedKeywords: ["بَعْدَ", "ذَلِكَ،", "سَأَشْرَحُ", "الْفَائِدَةَ", "الْأَسَاسِيَّةَ"], indonesianExplanation: "Setelah itu, saya akan menjelaskan manfaat utamanya." },
    { coach: "استخدم الفكرة: مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", hint: "Jawab dengan struktur B2 memakai: مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", sampleAnswer: "مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", focus: "Menjelaskan risk secara seimbang.", expectedKeywords: ["مِنَ", "الْمُهِمِّ", "أَنْ", "نَذْكُرَ", "الْمَخَاطِرَ"], indonesianExplanation: "Penting juga untuk menyebutkan risikonya." },
    { coach: "استخدم الفكرة: إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", hint: "Jawab dengan struktur B2 memakai: إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", sampleAnswer: "إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", focus: "Menyiapkan Q&A.", expectedKeywords: ["إِذَا", "كَانَتْ", "هُنَاكَ", "أَسْئِلَةٌ،", "فَسَأُجِيبُ"], indonesianExplanation: "Jika ada pertanyaan, saya akan menjawabnya dengan jelas." },
  ],
  ...
  "arabic-b2-structuring-a-short-presentation": [
    { coach: "مَا رَأْيُكَ فِي فِكْرَةِ لَوْحَةِ مُتَابَعَةٍ جَدِيدَةٍ؟ دَعْنَا نُدَرِّبْ الْجَوَابَ بِسَبَبٍ وَمِثَالٍ وَخُطْوَةٍ تَالِيَةٍ.", hint: "Jawab dengan struktur B2 memakai: مَوْقِفِي فِي فِكْرَةِ لَوْحَةِ مُتَابَعَةٍ جَدِيدَةٍ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", sampleAnswer: "مَوْقِفِي فِي فِكْرَةِ لَوْحَةِ مُتَابَعَةٍ جَدِيدَةٍ أَنَّنَا نَحْتَاجُ إِلَى قَرَارٍ وَاضِحٍ.", focus: "Membuka presentasi.", expectedKeywords: ["مَوْقِفِي", "أَنَّ", "فِكْرَةِ", "لَوْحَةِ", "مُتَابَعَةٍ"], indonesianExplanation: "Posisi saya adalah bahwa ide dashboard baru membutuhkan keputusan yang jelas." },
    { coach: "استخدم الفكرة: بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", hint: "Jawab dengan struktur B2 memakai: بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", sampleAnswer: "بَعْدَ ذَلِكَ، سَأَشْرَحُ الْفَائِدَةَ الْأَسَاسِيَّةَ.", focus: "Memberi signposting.", expectedKeywords: ["بَعْدَ", "ذَلِكَ،", "سَأَشْرَحُ", "الْفَائِدَةَ", "الْأَسَاسِيَّةَ"], indonesianExplanation: "Setelah itu, saya akan menjelaskan manfaat utamanya." },
    { coach: "استخدم الفكرة: مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", hint: "Jawab dengan struktur B2 memakai: مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", sampleAnswer: "مِنَ الْمُهِمِّ أَنْ نَذْكُرَ الْمَخَاطِرَ أَيْضًا.", focus: "Menjelaskan risk secara seimbang.", expectedKeywords: ["مِنَ", "الْمُهِمِّ", "أَنْ", "نَذْكُرَ", "الْمَخَاطِرَ"], indonesianExplanation: "Penting juga untuk menyebutkan risikonya." },
    { coach: "استخدم الفكرة: إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", hint: "Jawab dengan struktur B2 memakai: إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", sampleAnswer: "إِذَا كَانَتْ هُنَاكَ أَسْئِلَةٌ، فَسَأُجِيبُ عَنْهَا بِوُضُوحٍ.", focus: "Menyiapkan Q&A.", expectedKeywords: ["إِذَا", "كَانَتْ", "هُنَاكَ", "أَسْئِلَةٌ،", "فَسَأُجِيبُ"], indonesianExplanation: "Jika ada pertanyaan, saya akan menjawabnya dengan jelas." },
  ],
  ...
  "arabic-c1-advanced-presentation-mission": [
    { coach: "كَيْفَ تُحَوِّلُ مَهَارَةَ تَقْدِيمِ عَرْضٍ مُتَقَدِّمٍ وَاضِحٍ إِلَى خُطْوَةٍ عَمَلِيَّةٍ؟", hint: "Jawab dengan struktur C1 memakai: فِي تَدْرِيبِ تَقْدِيمِ عَرْضٍ مُتَقَدِّمٍ وَاضِحٍ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", sampleAnswer: "فِي تَدْرِيبِ تَقْدِيمِ عَرْضٍ مُتَقَدِّمٍ وَاضِحٍ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", focus: "Membingkai topik kompleks. Fokus lesson: presentasi lanjutan yang jelas.", expectedKeywords: ["فِي", "تَدْرِيبِ", "تَقْدِيمِ", "عَرْضٍ", "مُتَقَدِّمٍ"], indonesianExplanation: "Dalam latihan presentasi lanjutan yang jelas, saya akan membingkai topiknya dulu agar audiens memahami konteksnya." },
    { coach: "استخدم الفكرة: عِنْدَ تَطْبِيقِ تَقْدِيمِ عَرْضٍ مُتَقَدِّمٍ وَاضِحٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", hint: "Jawab dengan struktur C1 memakai: عِنْدَ تَطْبِيقِ تَقْدِيمِ عَرْضٍ مُتَقَدِّمٍ وَاضِحٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", sampleAnswer: "عِنْدَ تَطْبِيقِ تَقْدِيمِ عَرْضٍ مُتَقَدِّمٍ وَاضِحٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", focus: "Membangun persuasive flow. Hubungkan dengan fokus lesson.", expectedKeywords: ["عِنْدَ", "تَطْبِيقِ", "تَقْدِيمِ", "عَرْضٍ", "مُتَقَدِّمٍ"], indonesianExplanation: "Saat menerapkan presentasi lanjutan yang jelas, setelah itu, saya akan membangun alur persuasif langkah demi langkah." },
    { coach: "استخدم الفكرة: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", hint: "Jawab dengan struktur C1 memakai: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", sampleAnswer: "الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", focus: "Memakai transisi presisi. Pakai sebagai penghubung dalam presentasi lanjutan yang jelas.", expectedKeywords: ["الِانْتِقَالُ", "الْأَدَقُّ", "هُنَا", "هُوَ", "أَنْ"], indonesianExplanation: "Transisi yang lebih tepat di sini adalah berpindah dari sebab ke dampak." },
    { coach: "استخدم الفكرة: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", hint: "Jawab dengan struktur C1 memakai: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", sampleAnswer: "إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", focus: "Menjawab pertanyaan menantang. Gunakan untuk repair dalam presentasi lanjutan yang jelas.", expectedKeywords: ["إِذَا", "جَاءَ", "سُؤَالٌ", "صَعْبٌ،", "فَسَأَعْتَرِفُ"], indonesianExplanation: "Jika ada pertanyaan sulit, saya akan mengakui batas jawaban lalu menjelaskan dasarnya." },
  ],
  ...
  "arabic-c1-building-a-persuasive-flow": [
    { coach: "مَا الطَّرِيقَةُ الأَدَقُّ لِاسْتِخْدَامِ مَهَارَةِ بِنَاءِ تَسَلْسُلٍ إِقْنَاعِيٍّ؟", hint: "Jawab dengan struktur C1 memakai: فِي تَدْرِيبِ بِنَاءِ تَسَلْسُلٍ إِقْنَاعِيٍّ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", sampleAnswer: "فِي تَدْرِيبِ بِنَاءِ تَسَلْسُلٍ إِقْنَاعِيٍّ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", focus: "Membingkai topik kompleks. Fokus lesson: pembangunan alur persuasif.", expectedKeywords: ["فِي", "تَدْرِيبِ", "بِنَاءِ", "تَسَلْسُلٍ", "إِقْنَاعِيٍّ،"], indonesianExplanation: "Dalam latihan pembangunan alur persuasif, saya akan membingkai topiknya dulu agar audiens memahami konteksnya." },
    { coach: "استخدم الفكرة: عِنْدَ تَطْبِيقِ بِنَاءِ تَسَلْسُلٍ إِقْنَاعِيٍّ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", hint: "Jawab dengan struktur C1 memakai: عِنْدَ تَطْبِيقِ بِنَاءِ تَسَلْسُلٍ إِقْنَاعِيٍّ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", sampleAnswer: "عِنْدَ تَطْبِيقِ بِنَاءِ تَسَلْسُلٍ إِقْنَاعِيٍّ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", focus: "Membangun persuasive flow. Hubungkan dengan fokus lesson.", expectedKeywords: ["عِنْدَ", "تَطْبِيقِ", "بِنَاءِ", "تَسَلْسُلٍ", "إِقْنَاعِيٍّ،"], indonesianExplanation: "Saat menerapkan pembangunan alur persuasif, setelah itu, saya akan membangun alur persuasif langkah demi langkah." },
    { coach: "استخدم الفكرة: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", hint: "Jawab dengan struktur C1 memakai: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", sampleAnswer: "الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", focus: "Memakai transisi presisi. Pakai sebagai penghubung dalam pembangunan alur persuasif.", expectedKeywords: ["الِانْتِقَالُ", "الْأَدَقُّ", "هُنَا", "هُوَ", "أَنْ"], indonesianExplanation: "Transisi yang lebih tepat di sini adalah berpindah dari sebab ke dampak." },
    { coach: "استخدم الفكرة: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", hint: "Jawab dengan struktur C1 memakai: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", sampleAnswer: "إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", focus: "Menjawab pertanyaan menantang. Gunakan untuk repair dalam pembangunan alur persuasif.", expectedKeywords: ["إِذَا", "جَاءَ", "سُؤَالٌ", "صَعْبٌ،", "فَسَأَعْتَرِفُ"], indonesianExplanation: "Jika ada pertanyaan sulit, saya akan mengakui batas jawaban lalu menjelaskan dasarnya." },
  ],
  "arabic-c1-c1-final-conversation": [
    { coach: "كَيْفَ تُحَوِّلُ مَهَارَةَ إِدَارَةِ مُحَادَثَةٍ نِهَائِيَّةٍ مُتَكَامِلَةٍ إِلَى خُطْوَةٍ عَمَلِيَّةٍ؟", hint: "Jawab dengan struktur C1 memakai: فِي الْمُحَادَثَةِ النِّهَائِيَّةِ الْمُتَكَامِلَةِ، أُدِيرُ النِّقَاشَ بِوُضُوحٍ وَمُرُونَةٍ.", sampleAnswer: "فِي الْمُحَادَثَةِ النِّهَائِيَّةِ الْمُتَكَامِلَةِ، أُدِيرُ النِّقَاشَ بِوُضُوحٍ وَمُرُونَةٍ.", focus: "Membuka final conversation dengan kontrol arah.", expectedKeywords: ["فِي", "الْمُحَادَثَةِ", "النِّهَائِيَّةِ", "الْمُتَكَامِلَةِ", "أُدِيرُ"], indonesianExplanation: "Dalam percakapan akhir yang utuh, saya mengelola diskusi dengan jelas dan fleksibel." },
    { coach: "استخدم الفكرة: أَبْدَأُ بِتَحْدِيدِ الْمَوْضُوعِ، ثُمَّ أَدْعُو الطَّرَفَ الْآخَرَ إِلَى الرَّدِّ.", hint: "Jawab dengan struktur C1 memakai: أَبْدَأُ بِتَحْدِيدِ الْمَوْضُوعِ، ثُمَّ أَدْعُو الطَّرَفَ الْآخَرَ إِلَى الرَّدِّ.", sampleAnswer: "أَبْدَأُ بِتَحْدِيدِ الْمَوْضُوعِ، ثُمَّ أَدْعُو الطَّرَفَ الْآخَرَ إِلَى الرَّدِّ.", focus: "Membuka interaksi dua arah secara terstruktur.", expectedKeywords: ["أَبْدَأُ", "بِتَحْدِيدِ", "الْمَوْضُوعِ", "ثُمَّ", "أَدْعُو"], indonesianExplanation: "Saya mulai dengan menentukan topik, lalu mengundang pihak lain untuk merespons." },
    { coach: "استخدم الفكرة: أَرْبِطُ بَيْنَ الرَّأْيِ وَالدَّلِيلِ وَالسُّؤَالِ حَتَّى يَظَلَّ الْحِوَارُ مُتَّصِلًا.", hint: "Jawab dengan struktur C1 memakai: أَرْبِطُ بَيْنَ الرَّأْيِ وَالدَّلِيلِ وَالسُّؤَالِ حَتَّى يَظَلَّ الْحِوَارُ مُتَّصِلًا.", sampleAnswer: "أَرْبِطُ بَيْنَ الرَّأْيِ وَالدَّلِيلِ وَالسُّؤَالِ حَتَّى يَظَلَّ الْحِوَارُ مُتَّصِلًا.", focus: "Menjaga percakapan panjang tetap koheren.", expectedKeywords: ["أَرْبِطُ", "بَيْنَ", "الرَّأْيِ", "وَالدَّلِيلِ", "وَالسُّؤَالِ"], indonesianExplanation: "Saya menghubungkan pendapat, bukti, dan pertanyaan agar percakapan tetap tersambung." },
    { coach: "استخدم الفكرة: إِذَا تَغَيَّرَتْ نَبْرَةُ الْحِوَارِ، أُخَفِّفُ اللُّغَةَ وَأُعِيدُ تَوْجِيهَ النِّقَاشِ.", hint: "Jawab dengan struktur C1 memakai: إِذَا تَغَيَّرَتْ نَبْرَةُ الْحِوَارِ، أُخَفِّفُ اللُّغَةَ وَأُعِيدُ تَوْجِيهَ النِّقَاشِ.", sampleAnswer: "إِذَا تَغَيَّرَتْ نَبْرَةُ الْحِوَارِ، أُخَفِّفُ اللُّغَةَ وَأُعِيدُ تَوْجِيهَ النِّقَاشِ.", focus: "Menyesuaikan nada saat percakapan berubah.", expectedKeywords: ["إِذَا", "تَغَيَّرَتْ", "نَبْرَةُ", "الْحِوَارِ", "أُخَفِّفُ"], indonesianExplanation: "Jika nada percakapan berubah, saya melunakkan bahasa dan mengarahkan ulang diskusi." },
  ],
  "arabic-c1-c1-final-test-practice": [
    { coach: "كَيْفَ تُحَافِظُ عَلَى الْوُضُوحِ عِنْدَ تَدْرِيبِ الِاخْتِبَارِ النِّهَائِيِّ؟", hint: "Jawab dengan struktur C1 memakai: فِي تَدْرِيبِ الِاخْتِبَارِ النِّهَائِيِّ، أَجْمَعُ الدِّقَّةَ وَالطَّلَاقَةَ وَالْوُضُوحَ.", sampleAnswer: "فِي تَدْرِيبِ الِاخْتِبَارِ النِّهَائِيِّ، أَجْمَعُ الدِّقَّةَ وَالطَّلَاقَةَ وَالْوُضُوحَ.", focus: "Menjawab tes akhir dengan tiga target utama.", expectedKeywords: ["فِي", "تَدْرِيبِ", "الِاخْتِبَارِ", "النِّهَائِيِّ", "أَجْمَعُ"], indonesianExplanation: "Dalam latihan tes akhir, saya menggabungkan ketepatan, kefasihan, dan kejelasan." },
    { coach: "استخدم الفكرة: أُجِيبُ أَوَّلًا عَنْ السُّؤَالِ، ثُمَّ أُضِيفُ سَبَبًا وَمِثَالًا قَصِيرًا.", hint: "Jawab dengan struktur C1 memakai: أُجِيبُ أَوَّلًا عَنْ السُّؤَالِ، ثُمَّ أُضِيفُ سَبَبًا وَمِثَالًا قَصِيرًا.", sampleAnswer: "أُجِيبُ أَوَّلًا عَنْ السُّؤَالِ، ثُمَّ أُضِيفُ سَبَبًا وَمِثَالًا قَصِيرًا.", focus: "Membuat jawaban tes tetap lengkap dan terarah.", expectedKeywords: ["أُجِيبُ", "أَوَّلًا", "عَنْ", "السُّؤَالِ", "ثُمَّ"], indonesianExplanation: "Saya menjawab pertanyaan terlebih dahulu, lalu menambahkan alasan dan contoh singkat." },
    { coach: "استخدم الفكرة: إِذَا نَسِيتُ كَلِمَةً، أُعِيدُ الصِّيَاغَةَ وَلَا أَتَوَقَّفُ طَوِيلًا.", hint: "Jawab dengan struktur C1 memakai: إِذَا نَسِيتُ كَلِمَةً، أُعِيدُ الصِّيَاغَةَ وَلَا أَتَوَقَّفُ طَوِيلًا.", sampleAnswer: "إِذَا نَسِيتُ كَلِمَةً، أُعِيدُ الصِّيَاغَةَ وَلَا أَتَوَقَّفُ طَوِيلًا.", focus: "Menjaga kelancaran saat ada kata yang terlupa.", expectedKeywords: ["إِذَا", "نَسِيتُ", "كَلِمَةً", "أُعِيدُ", "الصِّيَاغَةَ"], indonesianExplanation: "Jika saya lupa satu kata, saya menyusun ulang kalimat dan tidak berhenti terlalu lama." },
    { coach: "استخدم الفكرة: إِذَا ضَاقَ الْوَقْتُ، أَخْتَارُ جُمْلَةً وَاضِحَةً بَدَلًا مِنْ جُمْلَةٍ مُعَقَّدَةٍ.", hint: "Jawab dengan struktur C1 memakai: إِذَا ضَاقَ الْوَقْتُ، أَخْتَارُ جُمْلَةً وَاضِحَةً بَدَلًا مِنْ جُمْلَةٍ مُعَقَّدَةٍ.", sampleAnswer: "إِذَا ضَاقَ الْوَقْتُ، أَخْتَارُ جُمْلَةً وَاضِحَةً بَدَلًا مِنْ جُمْلَةٍ مُعَقَّدَةٍ.", focus: "Memprioritaskan kejelasan saat waktu terbatas.", expectedKeywords: ["إِذَا", "ضَاقَ", "الْوَقْتُ", "أَخْتَارُ", "جُمْلَةً"], indonesianExplanation: "Jika waktu sempit, saya memilih kalimat yang jelas daripada kalimat yang rumit." },
  ],
  ...
  "arabic-c1-framing-a-complex-topic": [
    { coach: "كَيْفَ تُطَبِّقُ مَهَارَةَ تَأْطِيرِ مَوْضُوعٍ مُعَقَّدٍ فِي حِوَارٍ رَسْمِيٍّ؟", hint: "Jawab dengan struktur C1 memakai: فِي تَدْرِيبِ تَأْطِيرِ مَوْضُوعٍ مُعَقَّدٍ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", sampleAnswer: "فِي تَدْرِيبِ تَأْطِيرِ مَوْضُوعٍ مُعَقَّدٍ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", focus: "Membingkai topik kompleks. Fokus lesson: pembingkaian topik kompleks.", expectedKeywords: ["فِي", "تَدْرِيبِ", "تَأْطِيرِ", "مَوْضُوعٍ", "مُعَقَّدٍ،"], indonesianExplanation: "Dalam latihan pembingkaian topik kompleks, saya akan membingkai topiknya dulu agar audiens memahami konteksnya." },
    { coach: "استخدم الفكرة: عِنْدَ تَطْبِيقِ تَأْطِيرِ مَوْضُوعٍ مُعَقَّدٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", hint: "Jawab dengan struktur C1 memakai: عِنْدَ تَطْبِيقِ تَأْطِيرِ مَوْضُوعٍ مُعَقَّدٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", sampleAnswer: "عِنْدَ تَطْبِيقِ تَأْطِيرِ مَوْضُوعٍ مُعَقَّدٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", focus: "Membangun persuasive flow. Hubungkan dengan fokus lesson.", expectedKeywords: ["عِنْدَ", "تَطْبِيقِ", "تَأْطِيرِ", "مَوْضُوعٍ", "مُعَقَّدٍ،"], indonesianExplanation: "Saat menerapkan pembingkaian topik kompleks, setelah itu, saya akan membangun alur persuasif langkah demi langkah." },
    { coach: "استخدم الفكرة: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", hint: "Jawab dengan struktur C1 memakai: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", sampleAnswer: "الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", focus: "Memakai transisi presisi. Pakai sebagai penghubung dalam pembingkaian topik kompleks.", expectedKeywords: ["الِانْتِقَالُ", "الْأَدَقُّ", "هُنَا", "هُوَ", "أَنْ"], indonesianExplanation: "Transisi yang lebih tepat di sini adalah berpindah dari sebab ke dampak." },
    { coach: "استخدم الفكرة: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", hint: "Jawab dengan struktur C1 memakai: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", sampleAnswer: "إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", focus: "Menjawab pertanyaan menantang. Gunakan untuk repair dalam pembingkaian topik kompleks.", expectedKeywords: ["إِذَا", "جَاءَ", "سُؤَالٌ", "صَعْبٌ،", "فَسَأَعْتَرِفُ"], indonesianExplanation: "Jika ada pertanyaan sulit, saya akan mengakui batas jawaban lalu menjelaskan dasarnya." },
  ],
  ...
  "arabic-c1-handling-challenging-questions": [
    { coach: "كَيْفَ تُحَافِظُ عَلَى الْوُضُوحِ عِنْدَ التَّعَامُلِ مَعَ أَسْئِلَةٍ صَعْبَةٍ؟", hint: "Jawab dengan struktur C1 memakai: فِي تَدْرِيبِ التَّعَامُلِ مَعَ أَسْئِلَةٍ صَعْبَةٍ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", sampleAnswer: "فِي تَدْرِيبِ التَّعَامُلِ مَعَ أَسْئِلَةٍ صَعْبَةٍ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", focus: "Membingkai topik kompleks. Fokus lesson: penanganan pertanyaan menantang.", expectedKeywords: ["فِي", "تَدْرِيبِ", "التَّعَامُلِ", "مَعَ", "أَسْئِلَةٍ"], indonesianExplanation: "Dalam latihan penanganan pertanyaan menantang, saya akan membingkai topiknya dulu agar audiens memahami konteksnya." },
    { coach: "استخدم الفكرة: عِنْدَ تَطْبِيقِ التَّعَامُلِ مَعَ أَسْئِلَةٍ صَعْبَةٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", hint: "Jawab dengan struktur C1 memakai: عِنْدَ تَطْبِيقِ التَّعَامُلِ مَعَ أَسْئِلَةٍ صَعْبَةٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", sampleAnswer: "عِنْدَ تَطْبِيقِ التَّعَامُلِ مَعَ أَسْئِلَةٍ صَعْبَةٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", focus: "Membangun persuasive flow. Hubungkan dengan fokus lesson.", expectedKeywords: ["عِنْدَ", "تَطْبِيقِ", "التَّعَامُلِ", "مَعَ", "أَسْئِلَةٍ"], indonesianExplanation: "Saat menerapkan penanganan pertanyaan menantang, setelah itu, saya akan membangun alur persuasif langkah demi langkah." },
    { coach: "استخدم الفكرة: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", hint: "Jawab dengan struktur C1 memakai: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", sampleAnswer: "الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", focus: "Memakai transisi presisi. Pakai sebagai penghubung dalam penanganan pertanyaan menantang.", expectedKeywords: ["الِانْتِقَالُ", "الْأَدَقُّ", "هُنَا", "هُوَ", "أَنْ"], indonesianExplanation: "Transisi yang lebih tepat di sini adalah berpindah dari sebab ke dampak." },
    { coach: "استخدم الفكرة: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", hint: "Jawab dengan struktur C1 memakai: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", sampleAnswer: "إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", focus: "Menjawab pertanyaan menantang. Gunakan untuk repair dalam penanganan pertanyaan menantang.", expectedKeywords: ["إِذَا", "جَاءَ", "سُؤَالٌ", "صَعْبٌ،", "فَسَأَعْتَرِفُ"], indonesianExplanation: "Jika ada pertanyaan sulit, saya akan mengakui batas jawaban lalu menjelaskan dasarnya." },
  ],
  ...
  "arabic-c1-review-leadership-and-listening": [
    { coach: "كَيْفَ تَجْعَلُ جَوَابَكَ فِي مُرَاجَعَةِ الْقِيَادَةِ وَحُسْنِ الِاسْتِمَاعِ مُقْنِعًا وَمُتَوَازِنًا؟", hint: "Jawab dengan struktur C1 memakai: عِنْدَ مُرَاجَعَةِ الْقِيَادَةِ وَحُسْنِ الِاسْتِمَاعِ، أُصْغِي أَوَّلًا ثُمَّ أُوَجِّهُ الْحِوَارَ.", sampleAnswer: "عِنْدَ مُرَاجَعَةِ الْقِيَادَةِ وَحُسْنِ الِاسْتِمَاعِ، أُصْغِي أَوَّلًا ثُمَّ أُوَجِّهُ الْحِوَارَ.", focus: "Memimpin dengan mendengar sebelum memberi arahan.", expectedKeywords: ["عِنْدَ", "مُرَاجَعَةِ", "الْقِيَادَةِ", "وَحُسْنِ", "الِاسْتِمَاعِ"], indonesianExplanation: "Saat meninjau kepemimpinan dan listening, saya mendengarkan dulu lalu mengarahkan percakapan." },
    { coach: "استخدم الفكرة: أَسْأَلُ سُؤَالًا مُفْتُوحًا لِأَفْهَمَ مَا يَحْتَاجُهُ الطَّرَفُ الْآخَرُ.", hint: "Jawab dengan struktur C1 memakai: أَسْأَلُ سُؤَالًا مُفْتُوحًا لِأَفْهَمَ مَا يَحْتَاجُهُ الطَّرَفُ الْآخَرُ.", sampleAnswer: "أَسْأَلُ سُؤَالًا مُفْتُوحًا لِأَفْهَمَ مَا يَحْتَاجُهُ الطَّرَفُ الْآخَرُ.", focus: "Menggali kebutuhan sebelum menawarkan respons.", expectedKeywords: ["أَسْأَلُ", "سُؤَالًا", "مُفْتُوحًا", "لِأَفْهَمَ", "مَا"], indonesianExplanation: "Saya mengajukan pertanyaan terbuka untuk memahami kebutuhan pihak lain." },
    { coach: "استخدم الفكرة: أُعِيدُ النُّقْطَةَ بِكَلِمَاتِي لِأَتَأَكَّدَ أَنَّنِي فَهِمْتُهَا.", hint: "Jawab dengan struktur C1 memakai: أُعِيدُ النُّقْطَةَ بِكَلِمَاتِي لِأَتَأَكَّدَ أَنَّنِي فَهِمْتُهَا.", sampleAnswer: "أُعِيدُ النُّقْطَةَ بِكَلِمَاتِي لِأَتَأَكَّدَ أَنَّنِي فَهِمْتُهَا.", focus: "Menunjukkan active listening dengan parafrasa.", expectedKeywords: ["أُعِيدُ", "النُّقْطَةَ", "بِكَلِمَاتِي", "لِأَتَأَكَّدَ", "أَنَّنِي"], indonesianExplanation: "Saya mengulang poin dengan kata-kata saya sendiri untuk memastikan saya memahaminya." },
    { coach: "استخدم الفكرة: إِذَا اخْتَلَفَتِ الْآرَاءُ، أُحَافِظُ عَلَى الْهُدُوءِ وَأُوَضِّحُ الْخُطْوَةَ التَّالِيَةَ.", hint: "Jawab dengan struktur C1 memakai: إِذَا اخْتَلَفَتِ الْآرَاءُ، أُحَافِظُ عَلَى الْهُدُوءِ وَأُوَضِّحُ الْخُطْوَةَ التَّالِيَةَ.", sampleAnswer: "إِذَا اخْتَلَفَتِ الْآرَاءُ، أُحَافِظُ عَلَى الْهُدُوءِ وَأُوَضِّحُ الْخُطْوَةَ التَّالِيَةَ.", focus: "Menjaga arah saat percakapan menegang.", expectedKeywords: ["إِذَا", "اخْتَلَفَتِ", "الْآرَاءُ", "أُحَافِظُ", "عَلَى"], indonesianExplanation: "Jika pendapat berbeda, saya tetap tenang dan menjelaskan langkah berikutnya." },
  ],
  "arabic-c1-review-nuance-and-strategy": [
    { coach: "كَيْفَ تُطَبِّقُ مَهَارَةَ مُرَاجَعَةِ الدِّقَّةِ وَالِاسْتِرَاتِيجِيَّةِ فِي حِوَارٍ رَسْمِيٍّ؟", hint: "Jawab dengan struktur C1 memakai: عِنْدَ مُرَاجَعَةِ الدِّقَّةِ وَالِاسْتِرَاتِيجِيَّةِ، أُوَازِنُ بَيْنَ الصَّرَاحَةِ وَاللُّبَاقَةِ.", sampleAnswer: "عِنْدَ مُرَاجَعَةِ الدِّقَّةِ وَالِاسْتِرَاتِيجِيَّةِ، أُوَازِنُ بَيْنَ الصَّرَاحَةِ وَاللُّبَاقَةِ.", focus: "Menempatkan opini dengan presisi tanpa terdengar berlebihan.", expectedKeywords: ["عِنْدَ", "مُرَاجَعَةِ", "الدِّقَّةِ", "وَالِاسْتِرَاتِيجِيَّةِ", "أُوَازِنُ"], indonesianExplanation: "Saat meninjau nuansa dan strategi, saya menyeimbangkan keterusterangan dan kesantunan." },
    { coach: "استخدم الفكرة: فِي الْحِوَارِ الْمِهَنِيِّ، أَرْبِطُ الرَّأْيَ بِالسِّيَاقِ وَالْمَخَاطِرِ الْمُحْتَمَلَةِ.", hint: "Jawab dengan struktur C1 memakai: فِي الْحِوَارِ الْمِهَنِيِّ، أَرْبِطُ الرَّأْيَ بِالسِّيَاقِ وَالْمَخَاطِرِ الْمُحْتَمَلَةِ.", sampleAnswer: "فِي الْحِوَارِ الْمِهَنِيِّ، أَرْبِطُ الرَّأْيَ بِالسِّيَاقِ وَالْمَخَاطِرِ الْمُحْتَمَلَةِ.", focus: "Menambahkan konteks agar strategi terdengar matang.", expectedKeywords: ["فِي", "الْحِوَارِ", "الْمِهَنِيِّ", "أَرْبِطُ", "الرَّأْيَ"], indonesianExplanation: "Dalam dialog profesional, saya mengaitkan pendapat dengan konteks dan risiko yang mungkin muncul." },
    { coach: "استخدم الفكرة: أُقَدِّمُ الْفِكْرَةَ بِتَسَلْسُلٍ يُسَهِّلُ عَلَى الطَّرَفِ الآخَرِ مُتَابَعَتَهَا.", hint: "Jawab dengan struktur C1 memakai: أُقَدِّمُ الْفِكْرَةَ بِتَسَلْسُلٍ يُسَهِّلُ عَلَى الطَّرَفِ الآخَرِ مُتَابَعَتَهَا.", sampleAnswer: "أُقَدِّمُ الْفِكْرَةَ بِتَسَلْسُلٍ يُسَهِّلُ عَلَى الطَّرَفِ الآخَرِ مُتَابَعَتَهَا.", focus: "Membangun alur argumentasi yang bisa diikuti.", expectedKeywords: ["أُقَدِّمُ", "الْفِكْرَةَ", "بِتَسَلْسُلٍ", "يُسَهِّلُ", "عَلَى"], indonesianExplanation: "Saya menyampaikan ide dengan urutan yang memudahkan pihak lain mengikutinya." },
    { coach: "استخدم الفكرة: إِذَا ظَهَرَ سُوءُ فَهْمٍ، أُعِيدُ الصِّيَاغَةَ بِلُطْفٍ وَدِقَّةٍ.", hint: "Jawab dengan struktur C1 memakai: إِذَا ظَهَرَ سُوءُ فَهْمٍ، أُعِيدُ الصِّيَاغَةَ بِلُطْفٍ وَدِقَّةٍ.", sampleAnswer: "إِذَا ظَهَرَ سُوءُ فَهْمٍ، أُعِيدُ الصِّيَاغَةَ بِلُطْفٍ وَدِقَّةٍ.", focus: "Memperbaiki miskomunikasi tanpa menaikkan tensi.", expectedKeywords: ["إِذَا", "ظَهَرَ", "سُوءُ", "فَهْمٍ", "أُعِيدُ"], indonesianExplanation: "Jika muncul salah paham, saya menyusun ulang kalimat dengan lembut dan tepat." },
  ],
  "arabic-c1-review-presenting-and-debate": [
    { coach: "مَا الطَّرِيقَةُ الأَدَقُّ لِاسْتِخْدَامِ مَهَارَةِ مُرَاجَعَةِ الْعَرْضِ وَالنِّقَاشِ؟", hint: "Jawab dengan struktur C1 memakai: عِنْدَ مُرَاجَعَةِ الْعَرْضِ وَالنِّقَاشِ، أُحَدِّدُ ادِّعَائِي ثُمَّ أَدْعَمُهُ بِدَلِيلٍ.", sampleAnswer: "عِنْدَ مُرَاجَعَةِ الْعَرْضِ وَالنِّقَاشِ، أُحَدِّدُ ادِّعَائِي ثُمَّ أَدْعَمُهُ بِدَلِيلٍ.", focus: "Membuka presentasi atau debat dengan klaim yang jelas.", expectedKeywords: ["عِنْدَ", "مُرَاجَعَةِ", "الْعَرْضِ", "وَالنِّقَاشِ", "أُحَدِّدُ"], indonesianExplanation: "Saat meninjau presentasi dan debat, saya menetapkan klaim lalu mendukungnya dengan bukti." },
    { coach: "استخدم الفكرة: أَفْصِلُ بَيْنَ النُّقْطَةِ الرَّئِيسِيَّةِ وَالتَّفَاصِيلِ حَتَّى يَبْقَى الْعَرْضُ مُرَكَّزًا.", hint: "Jawab dengan struktur C1 memakai: أَفْصِلُ بَيْنَ النُّقْطَةِ الرَّئِيسِيَّةِ وَالتَّفَاصِيلِ حَتَّى يَبْقَى الْعَرْضُ مُرَكَّزًا.", sampleAnswer: "أَفْصِلُ بَيْنَ النُّقْطَةِ الرَّئِيسِيَّةِ وَالتَّفَاصِيلِ حَتَّى يَبْقَى الْعَرْضُ مُرَكَّزًا.", focus: "Menjaga struktur presentasi tetap rapi.", expectedKeywords: ["أَفْصِلُ", "بَيْنَ", "النُّقْطَةِ", "الرَّئِيسِيَّةِ", "وَالتَّفَاصِيلِ"], indonesianExplanation: "Saya memisahkan poin utama dan detail agar presentasi tetap fokus." },
    { coach: "استخدم الفكرة: أَتَوَقَّعُ الِاعْتِرَاضَ، وَأُجِيبُ عَنْهُ بِهُدُوءٍ.", hint: "Jawab dengan struktur C1 memakai: أَتَوَقَّعُ الِاعْتِرَاضَ، وَأُجِيبُ عَنْهُ بِهُدُوءٍ.", sampleAnswer: "أَتَوَقَّعُ الِاعْتِرَاضَ، وَأُجِيبُ عَنْهُ بِهُدُوءٍ.", focus: "Menangani counterpoint tanpa kehilangan arah.", expectedKeywords: ["أَتَوَقَّعُ", "الِاعْتِرَاضَ", "وَأُجِيبُ", "عَنْهُ", "بِهُدُوءٍ"], indonesianExplanation: "Saya mengantisipasi sanggahan dan menjawabnya dengan tenang." },
    { coach: "استخدم الفكرة: إِذَا قَاطَعَنِي أَحَدٌ، أَعُودُ إِلَى النُّقْطَةِ بِجُمْلَةٍ قَصِيرَةٍ.", hint: "Jawab dengan struktur C1 memakai: إِذَا قَاطَعَنِي أَحَدٌ، أَعُودُ إِلَى النُّقْطَةِ بِجُمْلَةٍ قَصِيرَةٍ.", sampleAnswer: "إِذَا قَاطَعَنِي أَحَدٌ، أَعُودُ إِلَى النُّقْطَةِ بِجُمْلَةٍ قَصِيرَةٍ.", focus: "Mengambil kembali alur diskusi secara profesional.", expectedKeywords: ["إِذَا", "قَاطَعَنِي", "أَحَدٌ", "أَعُودُ", "إِلَى"], indonesianExplanation: "Jika seseorang memotong saya, saya kembali ke poin utama dengan kalimat singkat." },
  ],
  ...
  "arabic-c1-using-precise-transitions": [
    { coach: "كَيْفَ تَجْعَلُ جَوَابَكَ فِي اِسْتِخْدَامِ اِنْتِقَالَاتٍ دَقِيقَةٍ مُقْنِعًا وَمُتَوَازِنًا؟", hint: "Jawab dengan struktur C1 memakai: فِي تَدْرِيبِ اِسْتِخْدَامِ اِنْتِقَالَاتٍ دَقِيقَةٍ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", sampleAnswer: "فِي تَدْرِيبِ اِسْتِخْدَامِ اِنْتِقَالَاتٍ دَقِيقَةٍ، سَأُؤَطِّرُ الْمَوْضُوعَ أَوَّلًا حَتَّى يَفْهَمَ الْجُمْهُورُ سِيَاقَهُ.", focus: "Membingkai topik kompleks. Fokus lesson: penggunaan transisi yang presisi.", expectedKeywords: ["فِي", "تَدْرِيبِ", "اِسْتِخْدَامِ", "اِنْتِقَالَاتٍ", "دَقِيقَةٍ،"], indonesianExplanation: "Dalam latihan penggunaan transisi yang presisi, saya akan membingkai topiknya dulu agar audiens memahami konteksnya." },
    { coach: "استخدم الفكرة: عِنْدَ تَطْبِيقِ اِسْتِخْدَامِ اِنْتِقَالَاتٍ دَقِيقَةٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", hint: "Jawab dengan struktur C1 memakai: عِنْدَ تَطْبِيقِ اِسْتِخْدَامِ اِنْتِقَالَاتٍ دَقِيقَةٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", sampleAnswer: "عِنْدَ تَطْبِيقِ اِسْتِخْدَامِ اِنْتِقَالَاتٍ دَقِيقَةٍ، بَعْدَ ذَلِكَ، سَأَبْنِي التَّسَلْسُلَ الْإِقْنَاعِيَّ خُطْوَةً فَخُطْوَةً.", focus: "Membangun persuasive flow. Hubungkan dengan fokus lesson.", expectedKeywords: ["عِنْدَ", "تَطْبِيقِ", "اِسْتِخْدَامِ", "اِنْتِقَالَاتٍ", "دَقِيقَةٍ،"], indonesianExplanation: "Saat menerapkan penggunaan transisi yang presisi, setelah itu, saya akan membangun alur persuasif langkah demi langkah." },
    { coach: "استخدم الفكرة: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", hint: "Jawab dengan struktur C1 memakai: الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", sampleAnswer: "الِانْتِقَالُ الْأَدَقُّ هُنَا هُوَ أَنْ نَنْتَقِلَ مِنَ السَّبَبِ إِلَى التَّأْثِيرِ.", focus: "Memakai transisi presisi. Pakai sebagai penghubung dalam penggunaan transisi yang presisi.", expectedKeywords: ["الِانْتِقَالُ", "الْأَدَقُّ", "هُنَا", "هُوَ", "أَنْ"], indonesianExplanation: "Transisi yang lebih tepat di sini adalah berpindah dari sebab ke dampak." },
    { coach: "استخدم الفكرة: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", hint: "Jawab dengan struktur C1 memakai: إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", sampleAnswer: "إِذَا جَاءَ سُؤَالٌ صَعْبٌ، فَسَأَعْتَرِفُ بِحُدُودِ الْجَوَابِ ثُمَّ أُوَضِّحُ الْأَسَاسَ.", focus: "Menjawab pertanyaan menantang. Gunakan untuk repair dalam penggunaan transisi yang presisi.", expectedKeywords: ["إِذَا", "جَاءَ", "سُؤَالٌ", "صَعْبٌ،", "فَسَأَعْتَرِفُ"], indonesianExplanation: "Jika ada pertanyaan sulit, saya akan mengakui batas jawaban lalu menjelaskan dasarnya." },
  ],
