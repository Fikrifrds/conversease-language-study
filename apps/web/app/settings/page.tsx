        ...
        <div className="mt-8 space-y-5">
          <section className="rounded-lg border border-ink/10 bg-white p-5 shadow-sm">
            ...
            <div className="mt-5 space-y-3">
              {["Pengingat belajar", "Progress mingguan", "Pengingat langganan", "Pengingat evaluasi"].map((item) => (
          ...
          <section className="rounded-lg border border-ink/10 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold">Email keamanan</h2>
            </div>
            <p className="mt-3 text-sm leading-6 text-ink/60">
              Email verifikasi, reset password, billing, dan keamanan tetap aktif.
            </p>
          </section>
        </div>
      </section>
