      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 leading-7 text-ink/70">
            Pantau progres belajar, tentukan level yang ingin diuji, lalu lanjutkan attempt level test yang sedang berjalan.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-[0.72fr_0.28fr]">
          ...
          <aside className="space-y-4">
            ...
            <section className="rounded-lg bg-ink p-5 text-white">
              ...
              <h2 className="mt-1 text-2xl font-semibold">Level Tests</h2>
              <p className="mt-3 text-sm leading-6 text-white/70">
                Buka daftar semua level test, pilih level yang ingin dikerjakan, lalu lanjutkan draft attempt kapan saja.
              </p>
              <Link
                href={productRoutes.levelTests}
