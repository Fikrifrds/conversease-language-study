...
- Level: **B1**
- Unit 6: **Explaining Preferences**
- Lesson 5: **Preference Discussion Mission**
- Lesson key: `lesson-05-preference-discussion-mission`
- Web slug: `preference-discussion-mission`
- Dialogue speakers: **Hilmi, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-06-explaining-preferences/lesson-05-preference-discussion-mission`
...
| `card-1.png` | 1254×1254 | Eating out is easier, but it's more expensive. |
| `card-2.png` | 1254×1254 | I prefer cooking at home because it's cheaper. |
| `card-3.png` | 1254×1254 | What are the pros and cons? |
...
- The named cast must match the dialogue speakers: Hilmi, Faris. Do not change their genders, duplicate them, or replace them with generic people.
...
Lesson: Preference Discussion Mission (B1, Unit 6, Lesson 5)
Conversation goal: Complete a mini conversation: compare options, explain your preference with reasons, discuss pros and cons, and reach an agreement.
Situation: Misi: kamu diskusi pilihan bareng teman. Kamu bandingin opsi, jelasin preferensi dan alasan, bahas pro/kontra, lalu sepakat.

Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
- Speaker arrangement: The speakers are physically present in the same appropriate scene.

Cast and continuity:
- Hilmi: adult man wearing an olive long-sleeved modest shirt, loose dark trousers ending above the ankle bones, visible socks, and closed shoes.
...
- Hilmi: We have two options: eat out or cook at home.
- Faris: Eating out is easier, but it's more expensive.
- Hilmi: So what do you prefer?
- Faris: I prefer cooking at home because it's cheaper.
- Hilmi: What are the pros and cons of cooking?
- Faris: The advantage is it's healthier. One downside is it takes time.
...
## Card 1 prompt — Eating out is easier, but it's more expensive.
...
Card focus: “Eating out is easier, but it's more expensive.”
Conversation moment: Faris says “Eating out is easier, but it's more expensive.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
## Card 2 prompt — I prefer cooking at home because it's cheaper.
...
Card focus: “I prefer cooking at home because it's cheaper.”
Conversation moment: Faris says “I prefer cooking at home because it's cheaper.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
## Card 3 prompt — What are the pros and cons?
...
Card focus: “What are the pros and cons?”
Conversation moment: Hilmi says “What are the pros and cons of cooking?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
Composition: medium or close conversational shot, clear focus on Hilmi, all needed conversation partners still contextually visible, and no cropped hands.
```
