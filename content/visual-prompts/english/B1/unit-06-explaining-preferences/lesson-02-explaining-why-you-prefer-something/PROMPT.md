...
- Lesson 2: **Explaining Why You Prefer Something**
- Lesson key: `lesson-02-explaining-why-you-prefer-something`
- Web slug: `explaining-why-you-prefer-something`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-06-explaining-preferences/lesson-02-explaining-why-you-prefer-something`
...
| `card-1.png` | 1254×1254 | I prefer the earlier flight. |
| `card-2.png` | 1254×1254 | Because it gives us more time. |
| `card-3.png` | 1254×1254 | The main reason is I don't want to arrive too late. |
...
Lesson: Explaining Why You Prefer Something (B1, Unit 6, Lesson 2)
Conversation goal: State a preference and explain the main reason clearly.
Situation: Kamu jelasin kenapa kamu prefer satu opsi. Kamu sebut preferensinya dan alasan utamanya.
...
- Faris: So which one do you prefer?
- Dimas: I prefer the earlier flight.
- Faris: Why?
- Dimas: Because it gives us more time in the afternoon.
- Faris: That makes sense. Any other reasons?
- Dimas: The main reason is I don't want to arrive too late.
...
## Card 1 prompt — I prefer the earlier flight.
...
Card focus: “I prefer the earlier flight.”
Conversation moment: Dimas says “I prefer the earlier flight.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
## Card 2 prompt — Because it gives us more time.
...
Card focus: “Because it gives us more time.”
Conversation moment: Dimas says “Because it gives us more time in the afternoon.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
## Card 3 prompt — The main reason is I don't want to arrive too late.
...
Card focus: “The main reason is I don't want to arrive too late.”
Conversation moment: Dimas says “The main reason is I don't want to arrive too late.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
