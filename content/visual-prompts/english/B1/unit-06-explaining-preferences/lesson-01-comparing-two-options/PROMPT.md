...
- Lesson 1: **Comparing Two Options**
- Lesson key: `lesson-01-comparing-two-options`
- Web slug: `comparing-two-options`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/B1/unit-06-explaining-preferences/lesson-01-comparing-two-options`
...
| `card-2.png` | 1254×1254 | Option A is nicer, but it's more expensive. |
| `card-3.png` | 1254×1254 | It's cheaper and faster. |
...
Lesson: Comparing Two Options (B1, Unit 6, Lesson 1)
Conversation goal: Compare two options and ask what the other person prefers.
Situation: Kamu pilih antara dua opsi (misalnya dua restoran). Kamu bandingin singkat, lalu tanya preferensi teman kamu.
...
- Faris: We have two options for dinner: Sushi Place or Noodle House.
- Hilmi: Okay. What's the difference?
- Faris: Sushi Place is nicer, but it's more expensive.
- Hilmi: And Noodle House?
- Faris: It's cheaper and faster, but it's usually crowded.
- Hilmi: Hmm. Which do you prefer?
...
Conversation moment: Faris says “We have two options for dinner: Sushi Place or Noodle House.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — Option A is nicer, but it's more expensive.
...
Card focus: “Option A is nicer, but it's more expensive.”
Conversation moment: Hilmi says “Okay. What's the difference?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — It's cheaper and faster.
...
Card focus: “It's cheaper and faster.”
Conversation moment: Faris says “It's cheaper and faster, but it's usually crowded.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
