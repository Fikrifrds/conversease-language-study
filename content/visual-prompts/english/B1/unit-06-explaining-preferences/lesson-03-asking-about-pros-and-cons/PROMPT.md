...
- Lesson 3: **Asking About Pros and Cons**
- Lesson key: `lesson-03-asking-about-pros-and-cons`
- Web slug: `asking-about-pros-and-cons`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/B1/unit-06-explaining-preferences/lesson-03-asking-about-pros-and-cons`
...
| `card-1.png` | 1254×1254 | What are the pros and cons? |
| `card-2.png` | 1254×1254 | The advantage is you save time. |
| `card-3.png` | 1254×1254 | One downside is you might feel isolated. |
...
Lesson: Asking About Pros and Cons (B1, Unit 6, Lesson 3)
Conversation goal: Ask about pros and cons and respond with one advantage and one downside.
Situation: Kamu lagi diskusi pilihan (misalnya remote vs office). Kamu tanya pros and cons, lalu respon dengan satu kelebihan dan satu kekurangan.
...
- Faris: What are the pros and cons of working remotely?
- Hilmi: The advantage is you save commuting time.
- Faris: True. Any downsides?
- Hilmi: One downside is you might feel isolated.
- Faris: Yeah, I get that.
...
## Card 1 prompt — What are the pros and cons?
...
Conversation moment: Faris says “What are the pros and cons of working remotely?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
## Card 2 prompt — The advantage is you save time.
...
Card focus: “The advantage is you save time.”
Conversation moment: Hilmi says “The advantage is you save commuting time.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
## Card 3 prompt — One downside is you might feel isolated.
...
Card focus: “One downside is you might feel isolated.”
Conversation moment: Hilmi says “One downside is you might feel isolated.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
