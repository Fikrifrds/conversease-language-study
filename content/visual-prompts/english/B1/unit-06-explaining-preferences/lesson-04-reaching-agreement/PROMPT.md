...
- Lesson 4: **Reaching Agreement**
- Lesson key: `lesson-04-reaching-agreement`
- Web slug: `reaching-agreement`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-06-explaining-preferences/lesson-04-reaching-agreement`
...
| `card-1.png` | 1254×1254 | How about we go with the cheaper one? |
| `card-2.png` | 1254×1254 | I'm okay with that. |
| `card-3.png` | 1254×1254 | That works for me. |
...
Lesson: Reaching Agreement (B1, Unit 6, Lesson 4)
Conversation goal: Suggest a plan, respond politely, and confirm an agreement.
Situation: Kamu mau mencapai kesepakatan. Kamu usul rencana, dengar respons, lalu konfirmasi keputusan bareng.
...
- Faris: So which restaurant should we choose?
- Dimas: How about we go with the cheaper one tonight?
- Faris: I'm okay with that, but is it too crowded?
- Dimas: It might be, so let's go early.
- Faris: That works for me.
- Dimas: Great. So we agree on Noodle House at 6:30?
...
## Card 1 prompt — How about we go with the cheaper one?
...
Card focus: “How about we go with the cheaper one?”
Conversation moment: Dimas says “How about we go with the cheaper one tonight?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
## Card 2 prompt — I'm okay with that.
...
Card focus: “I'm okay with that.”
Conversation moment: Faris says “I'm okay with that, but is it too crowded?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
...
## Card 3 prompt — That works for me.
...
Card focus: “That works for me.”
Conversation moment: Faris says “That works for me.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public decision-making table in a community workspace.
- Required background cues: two clearly separated option cards, matching object samples, and a central agreement marker without text.
- Context guardrail: The options are being discussed before a decision; do not place the speakers inside either restaurant, office arrangement, or destination mentioned as an option.
