...
- Lesson 1: **Talking About Goals**
- Lesson key: `lesson-01-talking-about-goals`
- Web slug: `talking-about-goals`
- Dialogue speakers: **Hilmi, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-05-goals-and-progress/lesson-01-talking-about-goals`
...
| `card-1.png` | 1254×1254 | My goal is to speak more confidently. |
| `card-2.png` | 1254×1254 | By the end of this month. |
| `card-3.png` | 1254×1254 | Because I want to join meetings without feeling nervous. |
...
Lesson: Talking About Goals (B1, Unit 5, Lesson 1)
Conversation goal: Talk about a personal goal, give a time frame, and explain why it matters.
Situation: Kamu ngobrol sama teman. Kamu cerita goal kamu, kapan targetnya, dan kenapa penting buat kamu.
...
- Hilmi: So, what's your goal this month?
- Faris: My goal is to speak more confidently.
- Hilmi: Nice. By when?
- Faris: By the end of this month.
- Hilmi: Why is that important to you?
- Faris: Because I want to join meetings without feeling nervous.
...
## Card 1 prompt — My goal is to speak more confidently.
...
Card focus: “My goal is to speak more confidently.”
Conversation moment: Faris says “My goal is to speak more confidently.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
## Card 2 prompt — By the end of this month.
...
Card focus: “By the end of this month.”
Conversation moment: Faris says “By the end of this month.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
## Card 3 prompt — Because I want to join meetings without feeling nervous.
...
Card focus: “Because I want to join meetings without feeling nervous.”
Conversation moment: Faris says “Because I want to join meetings without feeling nervous.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
