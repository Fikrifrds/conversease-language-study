...
- Level: **B1**
- Unit 5: **Goals & Progress**
- Lesson 5: **Goals Progress Mission**
- Lesson key: `lesson-05-goals-progress-mission`
- Web slug: `goals-progress-mission`
- Dialogue speakers: **Hilmi, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-05-goals-and-progress/lesson-05-goals-progress-mission`
...
| `card-1.png` | 1254×1254 | My goal is to speak more confidently by the end of this month. |
| `card-2.png` | 1254×1254 | I'm making progress. I've been practicing every morning. |
| `card-3.png` | 1254×1254 | The biggest challenge is staying consistent after work. |
...
Lesson: Goals Progress Mission (B1, Unit 5, Lesson 5)
Conversation goal: Complete a mini conversation: state a goal, share progress, describe a challenge, and set a next-step plan.
Situation: Misi: kamu cerita goal kamu, update progress, sebut tantangan, lalu bikin next step plan yang realistis.

Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
- Faris: My goal is to speak more confidently by the end of this month.
- Hilmi: Nice. How's it going?
- Faris: I'm making progress. I've been practicing every morning.
- Hilmi: Any challenges?
- Faris: The biggest challenge is staying consistent after work. I get distracted by my phone.
...
## Card 1 prompt — My goal is to speak more confidently by the end of this month.
...
Card focus: “My goal is to speak more confidently by the end of this month.”
Conversation moment: Faris says “My goal is to speak more confidently by the end of this month.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
## Card 2 prompt — I'm making progress. I've been practicing every morning.
...
Card focus: “I'm making progress. I've been practicing every morning.”
Conversation moment: Faris says “I'm making progress. I've been practicing every morning.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
## Card 3 prompt — The biggest challenge is staying consistent after work.
...
Card focus: “The biggest challenge is staying consistent after work.”
Conversation moment: Faris says “The biggest challenge is staying consistent after work. I get distracted by my phone.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
