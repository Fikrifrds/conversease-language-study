...
- Lesson 3: **Discussing Challenges**
- Lesson key: `lesson-03-discussing-challenges`
- Web slug: `discussing-challenges`
- Dialogue speakers: **Hilmi, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-05-goals-and-progress/lesson-03-discussing-challenges`
...
| `card-1.png` | 1254×1254 | The biggest challenge is staying consistent. |
| `card-2.png` | 1254×1254 | I'm struggling with motivation. |
| `card-3.png` | 1254×1254 | It's hard to stay consistent after work. |
...
Lesson: Discussing Challenges (B1, Unit 5, Lesson 3)
Conversation goal: Describe a challenge, explain why it is difficult, and ask for a simple suggestion.
Situation: Kamu cerita tantangan belajar. Kamu jelaskan kendalanya, kenapa susah, lalu minta saran sederhana.
...
- Hilmi: How is your practice going this week?
- Faris: Honestly, it's been challenging.
- Hilmi: What's the biggest challenge?
- Faris: The biggest challenge is staying consistent after work.
- Hilmi: Why is it hard?
- Faris: I get distracted by my phone, and I feel tired.
...
## Card 1 prompt — The biggest challenge is staying consistent.
...
Card focus: “The biggest challenge is staying consistent.”
Conversation moment: Faris says “The biggest challenge is staying consistent after work.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
## Card 2 prompt — I'm struggling with motivation.
...
Card focus: “I'm struggling with motivation.”
Conversation moment: Faris says “Honestly, it's been challenging.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
## Card 3 prompt — It's hard to stay consistent after work.
...
Card focus: “It's hard to stay consistent after work.”
Conversation moment: Hilmi says “What's the biggest challenge?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
