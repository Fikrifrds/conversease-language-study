...
- Lesson 4: **Making Next-step Plans**
- Lesson key: `lesson-04-making-next-step-plans`
- Web slug: `making-next-step-plans`
- Dialogue speakers: **Hilmi, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-05-goals-and-progress/lesson-04-making-next-step-plans`
...
| `card-1.png` | 1254×1254 | My next step is to practice with Conversation Coach. |
| `card-2.png` | 1254×1254 | I'll do it three times this week. |
| `card-3.png` | 1254×1254 | I'm going to keep it simple. |
...
Lesson: Making Next-step Plans (B1, Unit 5, Lesson 4)
Conversation goal: State your next step, set a simple schedule, and confirm the plan clearly.
Situation: Kamu bikin rencana langkah berikutnya. Kamu sebut next step, jadwal sederhana, dan konfirmasi plan-nya.
...
- Hilmi: So what's your next step?
- Faris: My next step is to practice with Conversation Coach.
- Hilmi: Nice. When will you do it?
- Faris: I'll do it three times this week.
- Hilmi: Great. Which days?
- Faris: Monday, Wednesday, and Friday.
...
## Card 1 prompt — My next step is to practice with Conversation Coach.
...
Card focus: “My next step is to practice with Conversation Coach.”
Conversation moment: Faris says “My next step is to practice with Conversation Coach.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
## Card 2 prompt — I'll do it three times this week.
...
Card focus: “I'll do it three times this week.”
Conversation moment: Faris says “I'll do it three times this week.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
...
## Card 3 prompt — I'm going to keep it simple.
...
Card focus: “I'm going to keep it simple.”
Conversation moment: Faris says “Yeah. I'm going to keep it simple.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning and coaching studio.
- Required background cues: a goal board made only of shapes, progress blocks, a blank weekly planner, practice books, and two next-step cards.
- Context guardrail: Show a present planning conversation, not a graduation scene, sports event, literal career outcome, or private tutoring room.
