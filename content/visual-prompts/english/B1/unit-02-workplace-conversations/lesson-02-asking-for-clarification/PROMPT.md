...
- Lesson 2: **Asking for Clarification**
- Lesson key: `lesson-02-asking-for-clarification`
- Web slug: `asking-for-clarification`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-02-workplace-conversations/lesson-02-asking-for-clarification`
...
| `card-1.png` | 1254×1254 | Could you clarify which sections you need? |
| `card-2.png` | 1254×1254 | Just to confirm, you want the latest numbers too, right? |
| `card-3.png` | 1254×1254 | Do you mean the summary or the full report? |
...
Lesson: Asking for Clarification (B1, Unit 2, Lesson 2)
Conversation goal: Ask for clarification politely when you are not sure about a task.
Situation: Kamu dapat instruksi kerja. Kamu belum yakin, jadi kamu minta klarifikasi dengan sopan.
...
- Faris: Can you update the report for Friday?
- Dimas: Sure. Could you clarify which sections you need?
- Faris: Focus on the summary and the risks.
- Dimas: Got it. Just to confirm, you want the latest numbers too, right?
- Faris: Yes, please include the latest numbers.
- Dimas: Okay. I'll send it by Thursday afternoon.
...
## Card 1 prompt — Could you clarify which sections you need?
...
Card focus: “Could you clarify which sections you need?”
Conversation moment: Dimas says “Sure. Could you clarify which sections you need?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
## Card 2 prompt — Just to confirm, you want the latest numbers too, right?
...
Card focus: “Just to confirm, you want the latest numbers too, right?”
Conversation moment: Dimas says “Got it. Just to confirm, you want the latest numbers too, right?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
## Card 3 prompt — Do you mean the summary or the full report?
...
Card focus: “Do you mean the summary or the full report?”
Conversation moment: Faris says “Focus on the summary and the risks.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
