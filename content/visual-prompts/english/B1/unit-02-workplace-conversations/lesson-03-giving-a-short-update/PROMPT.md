...
- Lesson 3: **Giving a Short Update**
- Lesson key: `lesson-03-giving-a-short-update`
- Web slug: `giving-a-short-update`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-02-workplace-conversations/lesson-03-giving-a-short-update`
...
| `card-2.png` | 1254×1254 | I'm almost done with the summary. |
| `card-3.png` | 1254×1254 | What's left? |
...
Lesson: Giving a Short Update (B1, Unit 2, Lesson 3)
Conversation goal: Give a short work update with progress, a plan, and one risk or blocker.
Situation: Kamu kasih update singkat ke manager: progress, rencana berikutnya, dan risiko kecil.
...
- Faris: Quick update: how is the report going?
- Dimas: I'm making good progress. I'm almost done with the summary.
- Faris: Great. What's left?
- Dimas: I still need to update the risk section and double-check the numbers.
- Faris: Any concerns?
- Dimas: One concern is time. I might need an extra hour to review everything.
...
## Card 2 prompt — I'm almost done with the summary.
...
Card focus: “I'm almost done with the summary.”
Conversation moment: Dimas says “I'm making good progress. I'm almost done with the summary.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
Card focus: “What's left?”
Conversation moment: Faris says “Great. What's left?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
