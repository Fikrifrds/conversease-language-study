...
- Lesson 4: **Joining a Simple Meeting**
- Lesson key: `lesson-04-joining-a-simple-meeting`
- Web slug: `joining-a-simple-meeting`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-02-workplace-conversations/lesson-04-joining-a-simple-meeting`
...
| `card-1.png` | 1254×1254 | I'd like to add one point. |
| `card-2.png` | 1254×1254 | Go ahead. |
| `card-3.png` | 1254×1254 | I suggest we move the deadline to Thursday. |
...
Lesson: Joining a Simple Meeting (B1, Unit 2, Lesson 4)
Conversation goal: Join a simple meeting, state your point briefly, and ask for the next step.
Situation: Kamu ikut meeting singkat. Kamu tambahkan satu poin, lalu tanya next step.
...
- Faris: Any updates before we close?
- Dimas: I'd like to add one point about the schedule.
- Faris: Sure, go ahead.
- Dimas: I suggest we move the deadline to Thursday to reduce risk.
- Faris: That makes sense. Anything else?
- Dimas: No. What are the next steps?
...
## Card 1 prompt — I'd like to add one point.
...
Card focus: “I'd like to add one point.”
Conversation moment: Dimas says “I'd like to add one point about the schedule.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
Card focus: “Go ahead.”
Conversation moment: Faris says “Sure, go ahead.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
## Card 3 prompt — I suggest we move the deadline to Thursday.
...
Card focus: “I suggest we move the deadline to Thursday.”
Conversation moment: Dimas says “I suggest we move the deadline to Thursday to reduce risk.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
