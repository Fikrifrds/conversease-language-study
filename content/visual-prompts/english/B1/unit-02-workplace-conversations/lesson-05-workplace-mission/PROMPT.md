...
- Level: **B1**
- Unit 2: **Workplace Conversations**
- Lesson 5: **Workplace Mission**
- Lesson key: `lesson-05-workplace-mission`
- Web slug: `workplace-mission`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-02-workplace-conversations/lesson-05-workplace-mission`
...
| `card-1.png` | 1254×1254 | I'm making good progress. |
| `card-2.png` | 1254×1254 | Could you clarify which risks you want me to focus on? |
| `card-3.png` | 1254×1254 | Just to confirm, you need it by Friday morning, right? |
...
Lesson: Workplace Mission (B1, Unit 2, Lesson 5)
Conversation goal: Complete a workplace mini-conversation: give an update, ask for clarification, and confirm a deadline.
Situation: Misi: kamu kasih update kerja, minta klarifikasi, lalu konfirmasi deadline dengan jelas.

Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
- Faris: Hi Dimas. Quick update on the report?
- Dimas: I'm making good progress. I'm almost done with the summary.
- Faris: Great. Please update the risk section too.
- Dimas: Sure. Could you clarify which risks you want me to focus on?
- Faris: Focus on timeline and budget risks.
- Dimas: Got it. Just to confirm, you need it by Friday morning, right?
...
## Card 1 prompt — I'm making good progress.
...
Card focus: “I'm making good progress.”
Conversation moment: Dimas says “I'm making good progress. I'm almost done with the summary.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
## Card 2 prompt — Could you clarify which risks you want me to focus on?
...
Card focus: “Could you clarify which risks you want me to focus on?”
Conversation moment: Dimas says “Sure. Could you clarify which risks you want me to focus on?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
## Card 3 prompt — Just to confirm, you need it by Friday morning, right?
...
Card focus: “Just to confirm, you need it by Friday morning, right?”
Conversation moment: Dimas says “Got it. Just to confirm, you need it by Friday morning, right?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
