...
- Lesson 1: **Explaining Your Task**
- Lesson key: `lesson-01-explaining-your-task`
- Web slug: `explaining-your-task`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-02-workplace-conversations/lesson-01-explaining-your-task`
...
| `card-1.png` | 1254×1254 | I'm working on the onboarding email flow. |
| `card-2.png` | 1254×1254 | What's the next step? |
| `card-3.png` | 1254×1254 | Next, I'll review the copy. |
...
Lesson: Explaining Your Task (B1, Unit 2, Lesson 1)
Conversation goal: Explain what you are working on and what the next step is in a short, clear way.
Situation: Kamu ngobrol sama manager. Kamu jelaskan kamu lagi ngerjain apa dan langkah berikutnya.
...
- Faris: Hi Dimas. What are you working on today?
- Dimas: I'm working on the onboarding email flow.
- Faris: Great. What's the next step?
- Dimas: Next, I'll review the copy and update the templates.
- Faris: Sounds good. Any blockers?
- Dimas: Not right now, but I may need feedback later.
...
## Card 1 prompt — I'm working on the onboarding email flow.
...
Card focus: “I'm working on the onboarding email flow.”
Conversation moment: Dimas says “I'm working on the onboarding email flow.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
## Card 2 prompt — What's the next step?
...
Card focus: “What's the next step?”
Conversation moment: Faris says “Great. What's the next step?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
...
## Card 3 prompt — Next, I'll review the copy.
...
Card focus: “Next, I'll review the copy.”
Conversation moment: Dimas says “Next, I'll review the copy and update the templates.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open manager-and-team workspace.
- Required background cues: a shared worktable, laptop with blank screen, task cards without writing, folders, and a simple progress diagram made of shapes.
- Context guardrail: This is an active work update or clarification, not a job interview, classroom, or closed executive office.
