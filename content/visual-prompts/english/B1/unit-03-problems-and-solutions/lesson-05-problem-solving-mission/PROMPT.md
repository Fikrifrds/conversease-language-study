...
- Lesson 5: **Problem Solving Mission**
- Lesson key: `lesson-05-problem-solving-mission`
- Web slug: `problem-solving-mission`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-03-problems-and-solutions/lesson-05-problem-solving-mission`
...
| `card-1.png` | 1254×1254 | Quick check: what's the issue? |
| `card-2.png` | 1254×1254 | There's a problem with the login page. |
| `card-3.png` | 1254×1254 | We could roll back now because it's quick. |
...
Lesson: Problem Solving Mission (B1, Unit 3, Lesson 5)
Conversation goal: Complete a mini problem-solving conversation: describe a problem, suggest a solution, respond to a concern, and decide next steps.
Situation: Misi: kamu jelaskan problem, kasih solusi, tanggapi concern, lalu putuskan next step.
...
- Dimas: There's a problem with the login page. Users can't sign in.
- Faris: When did it start?
- Dimas: It started this morning after the deploy, so it's urgent.
- Faris: What should we do?
- Dimas: We could roll back now because it's quick.
...
## Card 1 prompt — Quick check: what's the issue?
...
Card focus: “Quick check: what's the issue?”
Conversation moment: Faris says “Quick check: what's the issue?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — There's a problem with the login page.
...
Conversation moment: Dimas says “There's a problem with the login page. Users can't sign in.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — We could roll back now because it's quick.
...
Card focus: “We could roll back now because it's quick.”
Conversation moment: Dimas says “We could roll back now because it's quick.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
