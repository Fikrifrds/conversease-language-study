...
- Lesson 2: **Suggesting a Solution**
- Lesson key: `lesson-02-suggesting-a-solution`
- Web slug: `suggesting-a-solution`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-03-problems-and-solutions/lesson-02-suggesting-a-solution`
...
| `card-1.png` | 1254×1254 | We could roll back the update. |
| `card-2.png` | 1254×1254 | I suggest we roll it back. |
| `card-3.png` | 1254×1254 | Because rollback is quick. |
...
Lesson: Suggesting a Solution (B1, Unit 3, Lesson 2)
Conversation goal: Suggest a solution politely and explain why it could help.
Situation: Kamu diskusi solusi. Kamu kasih saran, jelaskan alasan, dan pilih langkah aman.
...
- Faris: Any ideas to fix it?
- Dimas: We could roll back the update.
- Faris: Why do you think that's best?
- Dimas: Because the issue started after the deploy, and rollback is quick.
- Faris: That makes sense. Anything else?
- Dimas: We should also add a quick test so it doesn't happen again.
...
## Card 1 prompt — We could roll back the update.
...
Card focus: “We could roll back the update.”
Conversation moment: Dimas says “We could roll back the update.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — I suggest we roll it back.
...
Card focus: “I suggest we roll it back.”
Conversation moment: Dimas says “We could roll back the update.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — Because rollback is quick.
...
Card focus: “Because rollback is quick.”
Conversation moment: Faris says “Why do you think that's best?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
