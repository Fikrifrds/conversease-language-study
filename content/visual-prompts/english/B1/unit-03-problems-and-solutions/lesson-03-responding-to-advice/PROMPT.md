...
- Lesson 3: **Responding to Advice**
- Lesson key: `lesson-03-responding-to-advice`
- Web slug: `responding-to-advice`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/B1/unit-03-problems-and-solutions/lesson-03-responding-to-advice`
...
| `card-1.png` | 1254×1254 | Maybe you should set a small daily goal. |
| `card-2.png` | 1254×1254 | That sounds good. |
| `card-3.png` | 1254×1254 | You're right. |
...
Lesson: Responding to Advice (B1, Unit 3, Lesson 3)
Conversation goal: Respond to advice politely and decide what you will do next.
Situation: Kamu cerita masalah kecil, teman kasih saran. Kamu respon dengan sopan dan bilang langkahmu.
...
- Faris: I'm stressed because I keep missing my speaking practice.
- Hilmi: Maybe you should set a small daily goal.
- Faris: That sounds good. What do you suggest?
- Hilmi: Try five minutes every morning.
- Faris: You're right. I'll try that starting tomorrow.
- Hilmi: And maybe track it in a checklist.
...
## Card 1 prompt — Maybe you should set a small daily goal.
...
Card focus: “Maybe you should set a small daily goal.”
Conversation moment: Hilmi says “Maybe you should set a small daily goal.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
...
## Card 2 prompt — That sounds good.
...
Card focus: “That sounds good.”
Conversation moment: Faris says “That sounds good. What do you suggest?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
...
Card focus: “You're right.”
Conversation moment: Faris says “You're right. I'll try that starting tomorrow.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
