...
- Lesson 4: **Making a Simple Decision**
- Lesson key: `lesson-04-making-a-simple-decision`
- Web slug: `making-a-simple-decision`
- Dialogue speakers: **Hilmi, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-03-problems-and-solutions/lesson-04-making-a-simple-decision`
...
| `card-1.png` | 1254×1254 | We have two options. |
| `card-2.png` | 1254×1254 | I'd rather fix it now. |
| `card-3.png` | 1254×1254 | We could do a quick rollback. |
...
Lesson: Making a Simple Decision (B1, Unit 3, Lesson 4)
Conversation goal: Compare two options and make a simple decision with a clear reason.
Situation: Kamu pilih antara dua opsi. Kamu jelaskan alasan singkat dan putuskan bareng.

Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
...
- Hilmi: We have two options: fix it now or wait until tomorrow.
- Faris: I'd rather fix it now because users are blocked.
- Hilmi: True. But it's late.
- Faris: We could do a quick rollback and then sleep.
- Hilmi: That sounds reasonable.
- Faris: Okay, let's roll back now and do a full review tomorrow.
...
## Card 1 prompt — We have two options.
...
Card focus: “We have two options.”
Conversation moment: Hilmi says “We have two options: fix it now or wait until tomorrow.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
...
## Card 2 prompt — I'd rather fix it now.
...
Card focus: “I'd rather fix it now.”
Conversation moment: Faris says “I'd rather fix it now because users are blocked.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
...
## Card 3 prompt — We could do a quick rollback.
...
Card focus: “We could do a quick rollback.”
Conversation moment: Faris says “We could do a quick rollback and then sleep.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
