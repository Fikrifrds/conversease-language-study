...
- Lesson key: `lesson-01-describing-a-problem`
- Web slug: `describing-a-problem`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-03-problems-and-solutions/lesson-01-describing-a-problem`
...
| `card-1.png` | 1254×1254 | There's a problem with the login page. |
| `card-2.png` | 1254×1254 | It started this morning. |
| `card-3.png` | 1254×1254 | It happened when we deployed the update. |
...
Lesson: Describing a Problem (B1, Unit 3, Lesson 1)
Conversation goal: Describe a problem clearly and explain what happened and why it matters.
Situation: Kamu ngobrol sama manager. Kamu jelaskan masalah yang terjadi dan dampaknya.
...
- Faris: Hey Dimas. You look concerned. What's going on?
- Dimas: There's a problem with the login page.
- Faris: What happened?
- Dimas: It started this morning when we deployed the update.
- Faris: How bad is it?
- Dimas: Users can't sign in, so they can't access their lessons.
...
## Card 1 prompt — There's a problem with the login page.
...
Card focus: “There's a problem with the login page.”
Conversation moment: Dimas says “There's a problem with the login page.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
...
## Card 2 prompt — It started this morning.
...
Card focus: “It started this morning.”
Conversation moment: Dimas says “It started this morning when we deployed the update.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
...
## Card 3 prompt — It happened when we deployed the update.
...
Card focus: “It happened when we deployed the update.”
Conversation moment: Faris says “What happened?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving table.
- Required background cues: one clearly relevant problem object, two solution cards represented by shapes, and a simple decision marker.
- Context guardrail: Show the speakers diagnosing and deciding together; do not depict an emergency, argument, repair workshop, or unrelated presentation.
