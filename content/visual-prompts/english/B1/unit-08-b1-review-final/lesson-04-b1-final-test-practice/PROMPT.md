...
- Lesson 4: **B1 Final Test Practice**
- Lesson key: `lesson-04-b1-final-test-practice`
- Web slug: `b1-final-test-practice`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B1/unit-08-b1-review-final/lesson-04-b1-final-test-practice`
...
| `card-1.png` | 1254×1254 | Let's do a quick practice round. |
| `card-2.png` | 1254×1254 | The biggest challenge is staying consistent. |
| `card-3.png` | 1254×1254 | So I'm keeping sessions short. |
...
Lesson: B1 Final Test Practice (B1, Unit 8, Lesson 4)
Conversation goal: Practice a short mixed conversation with clear, accurate sentences across B1 topics.
Situation: Latihan test: kamu jawab beberapa prompt cepat (goal, progress, problem, preference) dengan kalimat jelas.
...
- Faris: Let's do a quick B1 practice round.
- Dimas: Okay, I'm ready.
- Faris: What's your goal this month?
...
## Card 1 prompt — Let's do a quick practice round.
...
Card focus: “Let's do a quick practice round.”
Conversation moment: Faris says “Let's do a quick B1 practice round.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open language assessment room with another staff member or learner visible in the background. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — The biggest challenge is staying consistent.
...
Conversation moment: Dimas says “The biggest challenge is staying consistent after work, so I'm keeping sessions short.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open language assessment room with another staff member or learner visible in the background. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — So I'm keeping sessions short.
...
Card focus: “So I'm keeping sessions short.”
Conversation moment: Dimas says “The biggest challenge is staying consistent after work, so I'm keeping sessions short.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open language assessment room with another staff member or learner visible in the background. The speakers are physically present in the same appropriate scene.
