...
- Lesson 2: **Review Problems and Travel**
- Lesson key: `lesson-02-review-problems-and-travel`
- Web slug: `review-problems-and-travel`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-08-b1-review-final/lesson-02-review-problems-and-travel`
...
| `card-1.png` | 1254×1254 | There's a problem with the meeting link. |
| `card-2.png` | 1254×1254 | People can't join, so we need a new link. |
| `card-3.png` | 1254×1254 | I'm running a bit late. |
...
Lesson: Review Problems and Travel (B1, Unit 8, Lesson 2)
Conversation goal: Explain a problem, describe the impact, and give a travel-style delay update with an estimate.
Situation: Review: kamu jelasin masalah (impact), lalu kasih update telat (delay + estimasi).
...
- Ilham: Quick check: what's the issue?
- Faris: There's a problem with the meeting link.
- Ilham: What's the impact?
- Faris: People can't join, so we need a new link.
- Ilham: Okay. Are you on your way?
- Faris: Yes, but I'm running a bit late. My train is delayed.
...
## Card 1 prompt — There's a problem with the meeting link.
...
Card focus: “There's a problem with the meeting link.”
Conversation moment: Faris says “There's a problem with the meeting link.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open B1 conversation assessment workspace.
- Required background cues: a story notebook, progress board, problem-and-solution cards, travel bag, and two choice cards arranged around one table.
- Context guardrail: Keep the connected review in one present conversation; do not make a multi-location montage or literalize every topic mentioned.
...
## Card 2 prompt — People can't join, so we need a new link.
...
Card focus: “People can't join, so we need a new link.”
Conversation moment: Faris says “People can't join, so we need a new link.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open B1 conversation assessment workspace.
- Required background cues: a story notebook, progress board, problem-and-solution cards, travel bag, and two choice cards arranged around one table.
- Context guardrail: Keep the connected review in one present conversation; do not make a multi-location montage or literalize every topic mentioned.
...
## Card 3 prompt — I'm running a bit late.
...
Card focus: “I'm running a bit late.”
Conversation moment: Faris says “Yes, but I'm running a bit late. My train is delayed.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open B1 conversation assessment workspace.
- Required background cues: a story notebook, progress board, problem-and-solution cards, travel bag, and two choice cards arranged around one table.
- Context guardrail: Keep the connected review in one present conversation; do not make a multi-location montage or literalize every topic mentioned.
