...
- Level: **B1**
- Unit 8: **B1 Review & Final Conversation**
- Lesson 3: **Review Goals and Preferences**
- Lesson key: `lesson-03-review-goals-and-preferences`
- Web slug: `review-goals-and-preferences`
- Dialogue speakers: **Hilmi, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-08-b1-review-final/lesson-03-review-goals-and-preferences`
...
| `card-2.png` | 1254×1254 | I've been practicing every morning. |
| `card-3.png` | 1254×1254 | I prefer Conversation Coach because it gives me feedback. |
...
Lesson: Review Goals and Preferences (B1, Unit 8, Lesson 3)
Conversation goal: State a goal, share progress, and explain a preference with a clear reason.
Situation: Review: kamu cerita goal + progress, lalu jelasin preferensi kamu dengan alasan.

Scene and background:
- Actual conversation location: an open B1 conversation assessment workspace.
- Required background cues: a story notebook, progress board, problem-and-solution cards, travel bag, and two choice cards arranged around one table.
- Context guardrail: Keep the connected review in one present conversation; do not make a multi-location montage or literalize every topic mentioned.
...
- Hilmi: How's it going?
- Faris: I'm making progress. I've been practicing every morning.
- Hilmi: Nice. What do you prefer for practice: coach or shadowing?
- Faris: I prefer Conversation Coach because it gives me feedback.
...
## Card 2 prompt — I've been practicing every morning.
...
Card focus: “I've been practicing every morning.”
...
## Card 3 prompt — I prefer Conversation Coach because it gives me feedback.
...
Card focus: “I prefer Conversation Coach because it gives me feedback.”
Conversation moment: Faris says “I prefer Conversation Coach because it gives me feedback.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open B1 conversation assessment workspace.
- Required background cues: a story notebook, progress board, problem-and-solution cards, travel bag, and two choice cards arranged around one table.
- Context guardrail: Keep the connected review in one present conversation; do not make a multi-location montage or literalize every topic mentioned.
