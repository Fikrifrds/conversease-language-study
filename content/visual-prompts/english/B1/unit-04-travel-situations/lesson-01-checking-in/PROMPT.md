...
- Lesson key: `lesson-01-checking-in`
- Web slug: `checking-in`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-04-travel-situations/lesson-01-checking-in`
...
| `card-1.png` | 1254×1254 | I'd like to check in. |
| `card-2.png` | 1254×1254 | Do you have a reservation? |
| `card-3.png` | 1254×1254 | I have a reservation under Faris Kim. |
...
Lesson: Checking In (B1, Unit 4, Lesson 1)
Conversation goal: Check in at a hotel, confirm your reservation, and ask one practical question.
Situation: Kamu baru sampai hotel. Kamu check-in, konfirmasi reservasi, lalu tanya info penting (sarapan / check-out).

Scene and background:
- Actual conversation location: a bright public hotel reception counter immediately after arrival.
- Required background cues: luggage beside the guest, a blank reservation card and identity-card shape, room-key sleeve, and breakfast icon made only of objects.
- Context guardrail: Show check-in at reception; do not place the speakers in a guest room, restaurant, train station, or private office.
...
- Ilham: Welcome. How can I help you?
- Faris: Hi. I'd like to check in.
- Ilham: Sure. Do you have a reservation?
- Faris: Yes. I have a reservation under Faris Kim.
- Ilham: Great. Could I see your ID, please?
- Faris: Of course. Here you go.
...
## Card 1 prompt — I'd like to check in.
...
Card focus: “I'd like to check in.”
Conversation moment: Faris says “Hi. I'd like to check in.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a bright public hotel reception counter immediately after arrival.
- Required background cues: luggage beside the guest, a blank reservation card and identity-card shape, room-key sleeve, and breakfast icon made only of objects.
- Context guardrail: Show check-in at reception; do not place the speakers in a guest room, restaurant, train station, or private office.
...
## Card 2 prompt — Do you have a reservation?
...
Card focus: “Do you have a reservation?”
Conversation moment: Ilham says “Sure. Do you have a reservation?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a bright public hotel reception counter immediately after arrival.
- Required background cues: luggage beside the guest, a blank reservation card and identity-card shape, room-key sleeve, and breakfast icon made only of objects.
- Context guardrail: Show check-in at reception; do not place the speakers in a guest room, restaurant, train station, or private office.
...
## Card 3 prompt — I have a reservation under Faris Kim.
...
Card focus: “I have a reservation under Faris Kim.”
Conversation moment: Faris says “Yes. I have a reservation under Faris Kim.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a bright public hotel reception counter immediately after arrival.
- Required background cues: luggage beside the guest, a blank reservation card and identity-card shape, room-key sleeve, and breakfast icon made only of objects.
- Context guardrail: Show check-in at reception; do not place the speakers in a guest room, restaurant, train station, or private office.
