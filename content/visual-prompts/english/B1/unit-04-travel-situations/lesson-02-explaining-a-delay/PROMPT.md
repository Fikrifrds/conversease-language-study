...
- Lesson 2: **Explaining a Delay**
- Lesson key: `lesson-02-explaining-a-delay`
- Web slug: `explaining-a-delay`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B1/unit-04-travel-situations/lesson-02-explaining-a-delay`
...
| `card-1.png` | 1254×1254 | I'm running a bit late. |
| `card-2.png` | 1254×1254 | My train is delayed. |
| `card-3.png` | 1254×1254 | I'll be there in about 20 minutes. |
...
Lesson: Explaining a Delay (B1, Unit 4, Lesson 2)
Conversation goal: Explain that you are delayed, give an updated arrival time, and ask to adjust the plan.
Situation: Kamu telat karena transport delay. Kamu kasih kabar, sebut estimasi, dan minta mulai sedikit lebih lambat.

Scene and background:
- Actual conversation location: a split phone-call scene with Faris in a public station waiting zone and Ilham in an open hotel lobby or workplace reception.
- Required background cues: both hold phones; Faris has luggage and a stationary train-status board made only of abstract delay shapes, while Ilham has a blank schedule card.
- Context guardrail: They are physically separate during the delay call; do not show them face to face, on a moving train, or already checking in.
...
## Card 1 prompt — I'm running a bit late.
...
Conversation moment: Faris says “Yes, but I'm running a bit late.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a split phone-call scene with Faris in a public station waiting zone and Ilham in an open hotel lobby or workplace reception.
- Required background cues: both hold phones; Faris has luggage and a stationary train-status board made only of abstract delay shapes, while Ilham has a blank schedule card.
- Context guardrail: They are physically separate during the delay call; do not show them face to face, on a moving train, or already checking in.
...
## Card 2 prompt — My train is delayed.
...
Card focus: “My train is delayed.”
Conversation moment: Faris says “My train is delayed because of a signal problem.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a split phone-call scene with Faris in a public station waiting zone and Ilham in an open hotel lobby or workplace reception.
- Required background cues: both hold phones; Faris has luggage and a stationary train-status board made only of abstract delay shapes, while Ilham has a blank schedule card.
- Context guardrail: They are physically separate during the delay call; do not show them face to face, on a moving train, or already checking in.
...
## Card 3 prompt — I'll be there in about 20 minutes.
