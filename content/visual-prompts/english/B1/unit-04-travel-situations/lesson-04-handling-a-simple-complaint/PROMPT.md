...
- Lesson 4: **Handling a Simple Complaint**
- Lesson key: `lesson-04-handling-a-simple-complaint`
- Web slug: `handling-a-simple-complaint`
- Dialogue speakers: **Faris, Ilham**
- Prompt folder: `content/visual-prompts/english/B1/unit-04-travel-situations/lesson-04-handling-a-simple-complaint`
...
| `card-1.png` | 1254×1254 | There's a problem with my room. |
| `card-2.png` | 1254×1254 | The air conditioning isn't working. |
| `card-3.png` | 1254×1254 | Could you send someone to take a look? |
...
Lesson: Handling a Simple Complaint (B1, Unit 4, Lesson 4)
Conversation goal: Explain a simple problem politely and ask for help or an alternative.
Situation: Kamu punya masalah kecil di hotel. Kamu jelaskan masalahnya, lalu minta bantuan atau ganti kamar.

Scene and background:
- Actual conversation location: a public hotel guest-service counter in the open lobby.
- Required background cues: a room-key sleeve, a small tabletop air-conditioning control or fan icon, a blank maintenance card, and luggage kept nearby.
- Context guardrail: The guest reports the room problem at the service counter; do not place both speakers alone inside the guest room or show a repair already happening.
...
## Card 1 prompt — There's a problem with my room.
...
Card focus: “There's a problem with my room.”
Conversation moment: Faris says “Hi. There's a problem with my room.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public hotel guest-service counter in the open lobby.
- Required background cues: a room-key sleeve, a small tabletop air-conditioning control or fan icon, a blank maintenance card, and luggage kept nearby.
- Context guardrail: The guest reports the room problem at the service counter; do not place both speakers alone inside the guest room or show a repair already happening.
...
## Card 2 prompt — The air conditioning isn't working.
...
Card focus: “The air conditioning isn't working.”
Conversation moment: Faris says “The air conditioning isn't working.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public hotel guest-service counter in the open lobby.
- Required background cues: a room-key sleeve, a small tabletop air-conditioning control or fan icon, a blank maintenance card, and luggage kept nearby.
- Context guardrail: The guest reports the room problem at the service counter; do not place both speakers alone inside the guest room or show a repair already happening.
...
## Card 3 prompt — Could you send someone to take a look?
...
Card focus: “Could you send someone to take a look?”
Conversation moment: Faris says “The air conditioning isn't working.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public hotel guest-service counter in the open lobby.
- Required background cues: a room-key sleeve, a small tabletop air-conditioning control or fan icon, a blank maintenance card, and luggage kept nearby.
