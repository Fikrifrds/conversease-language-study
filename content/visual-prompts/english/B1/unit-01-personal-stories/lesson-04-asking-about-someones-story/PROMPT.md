...
- Lesson 4: **Asking About Someone's Story**
- Lesson key: `lesson-04-asking-about-someones-story`
- Web slug: `asking-about-someones-story`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/B1/unit-01-personal-stories/lesson-04-asking-about-someones-story`
...
| `card-1.png` | 1254×1254 | What happened next? |
| `card-2.png` | 1254×1254 | Why did you choose that route? |
| `card-3.png` | 1254×1254 | How did you feel at that moment? |
...
Lesson: Asking About Someone's Story (B1, Unit 1, Lesson 4)
Conversation goal: Ask follow-up questions to keep someone's story going (next event, reason, feelings).
Situation: Kamu dengar cerita teman. Kamu tanya follow-up: next, alasan, dan perasaan.
...
- Faris: So you got lost. What happened next?
- Hilmi: We asked a local person for help.
- Faris: Why did you choose that route?
- Hilmi: Because my cousin thought it was faster.
- Faris: How did you feel at that moment?
- Hilmi: I felt worried, but then I felt relieved.
...
## Card 1 prompt — What happened next?
...
Card focus: “What happened next?”
Conversation moment: Faris says “So you got lost. What happened next?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
## Card 2 prompt — Why did you choose that route?
...
Card focus: “Why did you choose that route?”
Conversation moment: Faris says “Why did you choose that route?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
## Card 3 prompt — How did you feel at that moment?
...
Card focus: “How did you feel at that moment?”
Conversation moment: Faris says “How did you feel at that moment?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
