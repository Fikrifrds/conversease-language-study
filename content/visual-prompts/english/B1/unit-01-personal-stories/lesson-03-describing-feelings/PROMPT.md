...
- Lesson 3: **Describing Feelings**
- Lesson key: `lesson-03-describing-feelings`
- Web slug: `describing-feelings`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/B1/unit-01-personal-stories/lesson-03-describing-feelings`
...
| `card-1.png` | 1254×1254 | How did you feel? |
| `card-2.png` | 1254×1254 | I felt nervous. |
| `card-3.png` | 1254×1254 | I felt relieved. |
...
Lesson: Describing Feelings (B1, Unit 1, Lesson 3)
Conversation goal: Describe how you felt during a story using feeling adjectives.
Situation: Kamu cerita pengalaman dan jelaskan perasaan kamu (nervous, excited, relieved).
...
## Card 1 prompt — How did you feel?
...
Card focus: “How did you feel?”
Conversation moment: Faris says “How did you feel during the trip?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
Card focus: “I felt nervous.”
Conversation moment: Hilmi says “At first, I felt nervous because we got lost.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
Card focus: “I felt relieved.”
Conversation moment: Hilmi says “We asked for directions, and (sighs) I felt relieved.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
