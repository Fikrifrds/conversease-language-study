...
- Level: **B1**
- Unit 1: **Personal Stories**
- Lesson 5: **Personal Story Mission**
- Lesson key: `lesson-05-personal-story-mission`
- Web slug: `personal-story-mission`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/B1/unit-01-personal-stories/lesson-05-personal-story-mission`
...
| `card-1.png` | 1254×1254 | Tell me about something interesting that happened recently. |
| `card-2.png` | 1254×1254 | First, we explored the city. |
| `card-3.png` | 1254×1254 | Then we got lost for a while. |
...
Lesson: Personal Story Mission (B1, Unit 1, Lesson 5)
Conversation goal: Tell a connected personal story with a clear scene, ordered events, and feelings, then answer a follow-up question.
Situation: Misi: kamu cerita pengalaman kemarin. Kamu set the scene, urutkan kejadian, jelaskan perasaan, lalu jawab follow-up.

Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
- Faris: Tell me about something interesting that happened recently.
- Hilmi: Last weekend, I was in Bandung with my cousin.
- Faris: Okay. What happened?
- Hilmi: First, we explored the city. Then we got lost for a while.
- Faris: Oh no. How did you feel?
- Hilmi: I felt nervous, but after we asked for directions, (sighs) I felt relieved.
...
## Card 1 prompt — Tell me about something interesting that happened recently.
...
Card focus: “Tell me about something interesting that happened recently.”
Conversation moment: Faris says “Tell me about something interesting that happened recently.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
## Card 2 prompt — First, we explored the city.
...
Card focus: “First, we explored the city.”
Conversation moment: Hilmi says “First, we explored the city. Then we got lost for a while.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
## Card 3 prompt — Then we got lost for a while.
...
Card focus: “Then we got lost for a while.”
Conversation moment: Hilmi says “First, we explored the city. Then we got lost for a while.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
