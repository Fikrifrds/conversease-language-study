...
Scene: a bright public travel lounge or café where a personal story is being shared. The speakers are physically present in the same appropriate scene.
...
- The foreground cast must match the named dialogue speakers: Faris, Hilmi. Do not change their genders, duplicate them, or replace them with generic people.
