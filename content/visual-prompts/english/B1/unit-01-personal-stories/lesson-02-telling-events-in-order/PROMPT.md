...
- Lesson 2: **Telling Events in Order**
- Lesson key: `lesson-02-telling-events-in-order`
- Web slug: `telling-events-in-order`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/B1/unit-01-personal-stories/lesson-02-telling-events-in-order`
...
| `card-1.png` | 1254×1254 | First, we checked in at the hotel. |
| `card-2.png` | 1254×1254 | Then we walked around. |
| `card-3.png` | 1254×1254 | What happened after that? |
...
Lesson: Telling Events in Order (B1, Unit 1, Lesson 2)
Conversation goal: Tell story events in order using simple linking words (first, then, after that, finally).
Situation: Kamu cerita kejadian berurutan. Kamu pakai first/then/after that/finally supaya jelas.
...
- Faris: So what did you do on your trip?
- Hilmi: First, we checked in at the hotel.
- Faris: Okay. Then what?
- Hilmi: Then we walked around and tried street food.
- Faris: Nice. What happened after that?
- Hilmi: After that, we met my aunt for dinner.
...
## Card 1 prompt — First, we checked in at the hotel.
...
Card focus: “First, we checked in at the hotel.”
Conversation moment: Hilmi says “First, we checked in at the hotel.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
## Card 2 prompt — Then we walked around.
...
Card focus: “Then we walked around.”
Conversation moment: Hilmi says “Then we walked around and tried street food.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
...
## Card 3 prompt — What happened after that?
...
Card focus: “What happened after that?”
Conversation moment: Faris says “Nice. What happened after that?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a quiet open public lounge arranged for a present-day conversation.
- Required background cues: a notebook, one neutral keepsake, and a few object-only photo cards that can support a story without showing people.
- Context guardrail: Show one person telling a past story to the other now; do not recreate the past event as the current location or add flashback panels.
