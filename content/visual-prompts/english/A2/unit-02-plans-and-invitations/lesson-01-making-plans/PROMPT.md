...
- Lesson key: `lesson-01-making-plans`
- Web slug: `making-plans`
- Dialogue speakers: **Ben, Faris**
- Prompt folder: `content/visual-prompts/english/A2/unit-02-plans-and-invitations/lesson-01-making-plans`
...
| `card-1.png` | 1254×1254 | Are you free tomorrow? |
| `card-2.png` | 1254×1254 | Let's get coffee. |
| `card-3.png` | 1254×1254 | How about 6 pm? |
...
Lesson: Making Plans (A2, Unit 2, Lesson 1)
Conversation goal: Make a simple plan with a time and a place.
Situation: Kamu ngobrol dengan teman setelah kelas. Kamu mau ngajak ketemu sebentar, pilih waktu, dan pilih tempat.
...
- Ben: Hey Faris. Are you free tomorrow?
- Faris: Tomorrow? Yes, I think so. Why?
- Ben: Let's get coffee after work.
- Faris: Sure. What time?
- Ben: How about 6 pm?
- Faris: 6 pm works for me. Where should we meet?
...
## Card 1 prompt — Are you free tomorrow?
...
Card focus: “Are you free tomorrow?”
Conversation moment: Ben says “Hey Faris. Are you free tomorrow?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
...
## Card 2 prompt — Let's get coffee.
...
Card focus: “Let's get coffee.”
Conversation moment: Ben says “Let's get coffee after work.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
...
Card focus: “How about 6 pm?”
Conversation moment: Ben says “How about 6 pm?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
