...
- Lesson 4: **Rescheduling**
- Lesson key: `lesson-04-rescheduling`
- Web slug: `rescheduling`
- Dialogue speakers: **Faris, Ben**
- Prompt folder: `content/visual-prompts/english/A2/unit-02-plans-and-invitations/lesson-04-rescheduling`
...
| `card-1.png` | 1254×1254 | Can we reschedule? |
| `card-2.png` | 1254×1254 | Something came up. |
| `card-3.png` | 1254×1254 | When are you free? |
...
Lesson: Rescheduling (A2, Unit 2, Lesson 4)
Conversation goal: Reschedule a plan and agree on a new time.
Situation: Kamu sudah punya rencana, tapi tiba-tiba tidak bisa. Kamu minta reschedule dan menawarkan waktu baru.

Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
...
- Faris: Hi Ben. Can we reschedule our coffee?
- Ben: Sure. What happened?
- Faris: Something came up at work.
- Ben: No problem. When are you free?
- Faris: How about Friday evening?
- Ben: Friday is good. Does 7 pm work for you?
...
## Card 1 prompt — Can we reschedule?
...
Card focus: “Can we reschedule?”
Conversation moment: Faris says “Hi Ben. Can we reschedule our coffee?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
...
## Card 2 prompt — Something came up.
...
Card focus: “Something came up.”
Conversation moment: Faris says “Something came up at work.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
...
## Card 3 prompt — When are you free?
...
Card focus: “When are you free?”
Conversation moment: Ben says “No problem. When are you free?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
