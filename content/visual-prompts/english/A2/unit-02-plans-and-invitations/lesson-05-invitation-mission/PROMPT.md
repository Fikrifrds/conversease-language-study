...
- Lesson 5: **Invitation Mission**
- Lesson key: `lesson-05-invitation-mission`
- Web slug: `invitation-mission`
- Dialogue speakers: **Ben, Faris**
- Prompt folder: `content/visual-prompts/english/A2/unit-02-plans-and-invitations/lesson-05-invitation-mission`
...
| `card-1.png` | 1254×1254 | Do you want to grab coffee? |
| `card-2.png` | 1254×1254 | Sorry, I can't. |
| `card-3.png` | 1254×1254 | Something came up. |
...
Lesson: Invitation Mission (A2, Unit 2, Lesson 5)
Conversation goal: Invite someone, decline politely with a reason, reschedule, and confirm the new plan.
Situation: Ini misi gabungan Unit 2. Kamu ngajak teman ketemu, temanmu tidak bisa, lalu kalian atur ulang waktu dan tempat.
...
## Card 1 prompt — Do you want to grab coffee?
...
Card focus: “Do you want to grab coffee?”
Conversation moment: Ben says “Hi Faris. Do you want to grab coffee tomorrow?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
...
Card focus: “Sorry, I can't.”
Conversation moment: Faris says “Thanks, but I can't tomorrow.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
...
## Card 3 prompt — Something came up.
...
Conversation moment: Faris says “Yes. Something came up at work.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public learning-center lobby planning corner.
- Required background cues: a blank event notice card, calendar blocks without text, and two simple location photo cards without people.
- Context guardrail: The speakers are making, accepting, declining, or rescheduling a future plan; do not depict them already attending the event.
