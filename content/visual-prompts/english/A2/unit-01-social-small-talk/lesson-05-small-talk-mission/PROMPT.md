...
Scene: a bright public café or community lounge with other visitors visible. The speakers are physically present in the same appropriate scene.
...
- The foreground cast must match the named dialogue speakers: Ben, Raka. Do not change their genders, duplicate them, or replace them with generic people.
