...
- Lesson 3: **Describing a Simple Experience**
- Lesson key: `lesson-03-describing-a-simple-experience`
- Web slug: `describing-a-simple-experience`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/A2/unit-06-past-experiences/lesson-03-describing-a-simple-experience`
...
| `card-1.png` | 1254×1254 | I tried a new restaurant yesterday. |
| `card-2.png` | 1254×1254 | How was it? |
| `card-3.png` | 1254×1254 | It was delicious. |
...
Lesson: Describing a Simple Experience (A2, Unit 6, Lesson 3)
Conversation goal: Describe a simple experience and how it felt.
Situation: Kamu cerita pengalaman singkat (makan di tempat baru). Kamu jelaskan rasanya dengan kata sifat sederhana.
...
- Faris: I tried a new restaurant yesterday.
- Hilmi: Oh nice. How was it?
- Faris: It was delicious. I really liked it.
- Hilmi: What did you eat?
- Faris: I ate grilled chicken and salad.
...
## Card 1 prompt — I tried a new restaurant yesterday.
...
Card focus: “I tried a new restaurant yesterday.”
Conversation moment: Faris says “I tried a new restaurant yesterday.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open public park pavilion where friends can talk.
- Required background cues: a bench, small table, travel keepsake, and an object connected to the story such as a plain food container or ticket shape without text.
- Context guardrail: Show the present conversation about yesterday, not a literal flashback, restaurant recreation, or multiple-event montage.
...
Conversation moment: Hilmi says “Oh nice. How was it?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open public park pavilion where friends can talk.
- Required background cues: a bench, small table, travel keepsake, and an object connected to the story such as a plain food container or ticket shape without text.
- Context guardrail: Show the present conversation about yesterday, not a literal flashback, restaurant recreation, or multiple-event montage.
...
## Card 3 prompt — It was delicious.
...
Card focus: “It was delicious.”
Conversation moment: Faris says “It was delicious. I really liked it.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open public park pavilion where friends can talk.
- Required background cues: a bench, small table, travel keepsake, and an object connected to the story such as a plain food container or ticket shape without text.
- Context guardrail: Show the present conversation about yesterday, not a literal flashback, restaurant recreation, or multiple-event montage.
