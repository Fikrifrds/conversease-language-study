...
- Lesson 2: **Saying Where You Went**
- Lesson key: `lesson-02-saying-where-you-went`
- Web slug: `saying-where-you-went`
- Dialogue speakers: **Staff, Raka**
- Prompt folder: `content/visual-prompts/english/A2/unit-06-past-experiences/lesson-02-saying-where-you-went`
...
| `card-1.png` | 1254×1254 | Where did you go? |
| `card-2.png` | 1254×1254 | I went to the museum. |
| `card-3.png` | 1254×1254 | Did you go anywhere interesting? |
...
- Staff: Hi! Did you go anywhere interesting yesterday?
- Raka: Yes, I went to the museum.
- Staff: Oh nice. Where did you go after that?
- Raka: I went to a cafe near the river.
- Staff: Sounds relaxing.
- Raka: Yeah. Where did you go?
...
- The foreground cast must match the named dialogue speakers: Staff, Raka. Do not change their genders, duplicate them, or replace them with generic people.
...
## Card 1 prompt — Where did you go?
...
Composition: medium or close conversational shot, clear focus on Staff, all needed conversation partners still contextually visible, and no cropped hands.
```

## Card 2 prompt — I went to the museum.
...
## Card 3 prompt — Did you go anywhere interesting?
