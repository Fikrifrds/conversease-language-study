...
- Level: **A2**
- Unit 8: **A2 Review & Final Conversation**
- Lesson 5: **A2 Final Conversation**
- Lesson key: `lesson-05-a2-final-conversation`
- Web slug: `a2-final-conversation`
- Dialogue speakers: **Faris, Hilmi**
- Prompt folder: `content/visual-prompts/english/A2/unit-08-a2-review-final/lesson-05-a2-final-conversation`
...
| `card-1.png` | 1254×1254 | Would you recommend it? |
| `card-2.png` | 1254×1254 | Yes, because the coffee is good and it is quiet. |
| `card-3.png` | 1254×1254 | Do you want to go there this weekend? |
...
- The named cast must match the dialogue speakers: Faris, Hilmi. Do not change their genders, duplicate them, or replace them with generic people.
...
Lesson: A2 Final Conversation (A2, Unit 8, Lesson 5)
Conversation goal: Complete a longer everyday conversation using multiple A2 skills (plans, past, opinions, requests).
Situation: Final: kamu ketemu teman. Kamu small talk, cerita kemarin, kasih opini, lalu bikin rencana dan minta bantuan kecil.

Scene and background:
- Actual conversation location: an open practical-language assessment studio.
- Required background cues: a travel bag, abstract station map, two shop products, blank appointment card, and planning cards arranged as one exercise station.
- Context guardrail: Keep all review topics inside one coherent practice setting; do not create a collage, flashback montage, or several disconnected locations.
...
- Hilmi: adult man wearing a navy long-sleeved modest shirt, loose beige trousers ending above the ankle bones, visible socks, and closed shoes.
...
- Faris: Hey Hilmi! How have you been?
- Hilmi: Good. (sighs) A bit tired, though.
- Faris: Oh no. Did you sleep late last night?
- Hilmi: Yes. I worked on a project.
- Faris: I went to a new cafe yesterday. It was great.
- Hilmi: Really? Would you recommend it?
...
## Card 1 prompt — Would you recommend it?
...
Card focus: “Would you recommend it?”
Conversation moment: Hilmi says “Really? Would you recommend it?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open practical-language assessment studio.
- Required background cues: a travel bag, abstract station map, two shop products, blank appointment card, and planning cards arranged as one exercise station.
- Context guardrail: Keep all review topics inside one coherent practice setting; do not create a collage, flashback montage, or several disconnected locations.
...
## Card 2 prompt — Yes, because the coffee is good and it is quiet.
...
Card focus: “Yes, because the coffee is good and it is quiet.”
Conversation moment: Faris says “Yes, because the coffee is good and it is quiet.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open practical-language assessment studio.
- Required background cues: a travel bag, abstract station map, two shop products, blank appointment card, and planning cards arranged as one exercise station.
- Context guardrail: Keep all review topics inside one coherent practice setting; do not create a collage, flashback montage, or several disconnected locations.
...
## Card 3 prompt — Do you want to go there this weekend?
...
Card focus: “Do you want to go there this weekend?”
Conversation moment: Hilmi says “Nice. Do you want to go there this weekend?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open practical-language assessment studio.
- Required background cues: a travel bag, abstract station map, two shop products, blank appointment card, and planning cards arranged as one exercise station.
- Context guardrail: Keep all review topics inside one coherent practice setting; do not create a collage, flashback montage, or several disconnected locations.
