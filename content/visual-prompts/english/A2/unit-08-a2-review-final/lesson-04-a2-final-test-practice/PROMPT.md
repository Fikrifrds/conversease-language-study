...
- Lesson 4: **A2 Final Test Practice**
- Lesson key: `lesson-04-a2-final-test-practice`
- Web slug: `a2-final-test-practice`
- Dialogue speakers: **Faris, Raka**
- Prompt folder: `content/visual-prompts/english/A2/unit-08-a2-review-final/lesson-04-a2-final-test-practice`
...
| `card-1.png` | 1254×1254 | Do you want to grab coffee this weekend? |
| `card-2.png` | 1254×1254 | Do you have a USB-C charger? |
| `card-3.png` | 1254×1254 | I've had a cough for two days. |
...
- The named cast must match the dialogue speakers: Faris, Raka. Do not change their genders, duplicate them, or replace them with generic people.
...
Lesson: A2 Final Test Practice (A2, Unit 8, Lesson 4)
Conversation goal: Practice mixed A2 skills with short prompts (plans, shopping, symptoms, past, opinions).
Situation: Latihan final: kamu jawab prompt campuran dengan kalimat pendek yang benar dan jelas.
...
## Card 1 prompt — Do you want to grab coffee this weekend?
...
Conversation moment: Raka says “Do you want to grab coffee this weekend?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open practical-language assessment studio.
- Required background cues: a travel bag, abstract station map, two shop products, blank appointment card, and planning cards arranged as one exercise station.
- Context guardrail: Keep all review topics inside one coherent practice setting; do not create a collage, flashback montage, or several disconnected locations.
...
## Card 2 prompt — Do you have a USB-C charger?
...
Card focus: “Do you have a USB-C charger?”
Conversation moment: Raka says “Excuse me, do you have a USB-C charger?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open practical-language assessment studio.
- Required background cues: a travel bag, abstract station map, two shop products, blank appointment card, and planning cards arranged as one exercise station.
- Context guardrail: Keep all review topics inside one coherent practice setting; do not create a collage, flashback montage, or several disconnected locations.
...
## Card 3 prompt — I've had a cough for two days.
