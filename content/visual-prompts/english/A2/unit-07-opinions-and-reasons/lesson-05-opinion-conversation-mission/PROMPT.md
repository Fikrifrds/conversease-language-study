...
- Level: **A2**
- Unit 7: **Opinions & Reasons**
- Lesson 5: **Opinion Conversation Mission**
- Lesson key: `lesson-05-opinion-conversation-mission`
- Web slug: `opinion-conversation-mission`
- Dialogue speakers: **Raka, Friend**
- Prompt folder: `content/visual-prompts/english/A2/unit-07-opinions-and-reasons/lesson-05-opinion-conversation-mission`
...
| `card-1.png` | 1254×1254 | What do you think about this restaurant? |
| `card-2.png` | 1254×1254 | I think it's good because it's cheap. |
| `card-3.png` | 1254×1254 | I'm not sure. |
...
- The named cast must match the dialogue speakers: Raka, Friend. Do not change their genders, duplicate them, or replace them with generic people.
...
Lesson: Opinion Conversation Mission (A2, Unit 7, Lesson 5)
Conversation goal: Have a short opinion conversation: ask for an opinion, give a reason, and respond politely.
Situation: Misi: kamu dan teman memilih tempat makan. Kamu tanya pendapat, kasih alasan, dan tanggapi dengan sopan.

Scene and background:
- Actual conversation location: a public community-lounge dining-choice table.
- Required background cues: two object-only dining photo cards, neutral reason markers, and a shared choice card without text.
- Context guardrail: They are choosing where to eat before going there; do not depict a restaurant interior, meal, kitchen, or service counter.
...
- Friend: adult man wearing a navy long-sleeved modest shirt, loose beige trousers ending above the ankle bones, visible socks, and closed shoes.
...
- Raka: What do you think about this restaurant?
- Friend: I think it's good because it's cheap.
- Raka: I'm not sure. The service might be slow.
- Friend: That's fair. Do you have another idea?
- Raka: Yes. I think the cafe next door is better.
- Friend: Why?
...
## Card 1 prompt — What do you think about this restaurant?
...
Card focus: “What do you think about this restaurant?”
Conversation moment: Raka says “What do you think about this restaurant?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public community-lounge dining-choice table.
- Required background cues: two object-only dining photo cards, neutral reason markers, and a shared choice card without text.
- Context guardrail: They are choosing where to eat before going there; do not depict a restaurant interior, meal, kitchen, or service counter.
...
Composition: medium or close conversational shot, clear focus on Raka, all needed conversation partners still contextually visible, and no cropped hands.
```

## Card 2 prompt — I think it's good because it's cheap.
...
Card focus: “I think it's good because it's cheap.”
Conversation moment: Friend says “I think it's good because it's cheap.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public community-lounge dining-choice table.
- Required background cues: two object-only dining photo cards, neutral reason markers, and a shared choice card without text.
- Context guardrail: They are choosing where to eat before going there; do not depict a restaurant interior, meal, kitchen, or service counter.
...
Composition: medium or close conversational shot, clear focus on Friend, all needed conversation partners still contextually visible, and no cropped hands.
```

## Card 3 prompt — I'm not sure.
...
Card focus: “I'm not sure.”
Conversation moment: Raka says “I'm not sure. The service might be slow.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public community-lounge dining-choice table.
- Required background cues: two object-only dining photo cards, neutral reason markers, and a shared choice card without text.
- Context guardrail: They are choosing where to eat before going there; do not depict a restaurant interior, meal, kitchen, or service counter.
