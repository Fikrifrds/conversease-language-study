...
- Lesson 2: **Asking About Departure Time**
- Lesson key: `lesson-02-asking-about-departure-time`
- Web slug: `asking-about-departure-time`
- Dialogue speakers: **Dimas, Staff**
- Prompt folder: `content/visual-prompts/english/A2/unit-03-travel-and-transport/lesson-02-asking-about-departure-time`
...
| `card-2.png` | 1254×1254 | What time does the train leave? |
| `card-3.png` | 1254×1254 | It leaves at 6:30. |
...
- PEOPLE COUNT — show exactly 1 adult man and 1 adult woman as the named foreground speakers: Dimas, Staff. Include exactly two additional modestly dressed adult men as small, distant background figures to make the setting clearly public and prevent mixed-gender seclusion. No additional women, children, silhouettes, reflections, portraits, people on screens, or other human figures anywhere.
...
- The named cast must match the dialogue speakers: Dimas, Staff. Do not change their genders, duplicate them, or replace them with generic people.
...
- Dimas: Excuse me. What time does the train leave?
- Staff: Which train?
- Dimas: The train to Bandung.
- Staff: It leaves at 6:30 pm.
- Dimas: Okay. Which platform?
- Staff: Platform 2.
...
## Card 2 prompt — What time does the train leave?
...
## Card 3 prompt — It leaves at 6:30.
