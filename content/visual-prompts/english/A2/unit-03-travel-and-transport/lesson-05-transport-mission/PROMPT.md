...
- Lesson 5: **Transport Mission**
- Lesson key: `lesson-05-transport-mission`
- Web slug: `transport-mission`
- Dialogue speakers: **Staff, Dimas, Driver**
- Prompt folder: `content/visual-prompts/english/A2/unit-03-travel-and-transport/lesson-05-transport-mission`
...
| `card-1.png` | 1254×1254 | I'd like one ticket to Bandung, please. |
| `card-2.png` | 1254×1254 | It leaves at 6:30 pm. |
| `card-3.png` | 1254×1254 | from platform 2 |
...
- PEOPLE COUNT — show exactly 2 adult men and 1 adult woman as the named foreground speakers: Staff, Dimas, Driver. Include exactly two additional modestly dressed adult men as small, distant background figures to make the setting clearly public and prevent mixed-gender seclusion. No additional women, children, silhouettes, reflections, portraits, people on screens, or other human figures anywhere.
...
- The named cast must match the dialogue speakers: Staff, Dimas, Driver. Do not change their genders, duplicate them, or replace them with generic people.
...
- Driver: adult man wearing a navy long-sleeved modest shirt, loose beige trousers ending above the ankle bones, visible socks, and closed shoes.
...
- Staff: Hi. Where are you going?
- Dimas: Hi. I'd like one ticket to Bandung, please.
- Staff: One-way or round-trip?
- Dimas: One-way, please.
- Staff: Okay. It leaves at 6:30 pm from platform 2.
- Dimas: Great. Thank you.
...
## Card 1 prompt — I'd like one ticket to Bandung, please.
...
## Card 2 prompt — It leaves at 6:30 pm.
