...
- Lesson 3: **Comparing Simple Options**
- Lesson key: `lesson-03-comparing-simple-options`
- Web slug: `comparing-simple-options`
- Dialogue speakers: **Ben, Staff**
- Prompt folder: `content/visual-prompts/english/A2/unit-04-shopping-services/lesson-03-comparing-simple-options`
...
| `card-1.png` | 1254×1254 | Which one is cheaper? |
| `card-2.png` | 1254×1254 | This one is cheaper. |
| `card-3.png` | 1254×1254 | The other one |
...
- Ben: Excuse me. Which one is cheaper?
- Staff: This one is cheaper. It's 80,000 rupiah.
- Ben: And the other one?
- Staff: The other one is 120,000 rupiah, but it's better quality.
- Ben: Okay. I'll take the cheaper one.
- Staff: Sure.
...
- The foreground cast must match the named dialogue speakers: Ben, Staff. Do not change their genders, duplicate them, or replace them with generic people.
...
## Card 1 prompt — Which one is cheaper?
...
## Card 2 prompt — This one is cheaper.
