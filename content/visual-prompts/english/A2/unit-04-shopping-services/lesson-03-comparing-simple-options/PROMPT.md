...
- PEOPLE COUNT — show exactly 1 adult man and 1 adult woman as the named foreground speakers: Ben, Staff. Include exactly two additional modestly dressed adult men as small, distant background figures to make the setting clearly public and prevent mixed-gender seclusion. No additional women, children, silhouettes, reflections, portraits, people on screens, or other human figures anywhere.
...
- The named cast must match the dialogue speakers: Ben, Staff. Do not change their genders, duplicate them, or replace them with generic people.
