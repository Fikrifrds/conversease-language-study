...
- Lesson 2: **Describing Simple Symptoms**
- Lesson key: `lesson-02-describing-simple-symptoms`
- Web slug: `describing-simple-symptoms`
- Dialogue speakers: **Nurse, Raka**
- Prompt folder: `content/visual-prompts/english/A2/unit-05-health-and-appointments/lesson-02-describing-simple-symptoms`
...
| `card-1.png` | 1254×1254 | What seems to be the problem? |
| `card-2.png` | 1254×1254 | I've had a sore throat since yesterday. |
| `card-3.png` | 1254×1254 | Do you have a fever? |
...
- Raka: I've had a sore throat since yesterday.
- Nurse: Do you have a fever?
- Raka: A little. And I have a cough.
- Nurse: How long have you been coughing?
- Raka: For two days.
...
- The foreground cast must match the named dialogue speakers: Nurse, Raka. Do not change their genders, duplicate them, or replace them with generic people.
...
## Card 1 prompt — What seems to be the problem?
...
Composition: medium or close conversational shot, clear focus on Nurse, all needed conversation partners still contextually visible, and no cropped hands.
```

## Card 2 prompt — I've had a sore throat since yesterday.
...
## Card 3 prompt — Do you have a fever?
