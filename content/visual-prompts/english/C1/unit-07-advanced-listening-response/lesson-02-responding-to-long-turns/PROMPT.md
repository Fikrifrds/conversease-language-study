...
- Lesson 2: **Responding to Long Turns**
- Lesson key: `lesson-02-responding-to-long-turns`
- Web slug: `responding-to-long-turns`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-07-advanced-listening-response/lesson-02-responding-to-long-turns`
...
| `card-1.png` | 1254×1254 | Let me make sure I got this: ... |
| `card-2.png` | 1254×1254 | The key points are: ... |
| `card-3.png` | 1254×1254 | If I understand correctly, ... |
...
Lesson: Responding to Long Turns (C1, Unit 7, Lesson 2)
Conversation goal: Respond to long turns by extracting key points, acknowledging emotions, and replying in a structured way.
Situation: Kamu dengar penjelasan panjang. Kamu harus merespons dengan rapi: rangkum poin, konfirmasi, lalu jawab.
...
- Ilham: So the issue is: multiple teams depend on this, the timeline is tight, and leadership wants visibility. Also, clients are sensitive to changes.
- Faris: Let me make sure I got this: we need to manage dependencies, time pressure, and stakeholder visibility.
- Ilham: Exactly.
- Faris: The key points are: keep changes small, communicate clearly, and monitor risk.
- Ilham: So what do you suggest?
- Faris: If I understand correctly, a phased rollout is the safest move.
...
## Card 1 prompt — Let me make sure I got this: ...
...
Conversation moment: Faris says “Let me make sure I got this: we need to manage dependencies, time pressure, and stakeholder visibility.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open learning and coaching studio with other learners visible in the background. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — The key points are: ...
...
Card focus: “The key points are: ...”
Conversation moment: Faris says “The key points are: keep changes small, communicate clearly, and monitor risk.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open learning and coaching studio with other learners visible in the background. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — If I understand correctly, ...
...
Card focus: “If I understand correctly, ...”
Conversation moment: Faris says “If I understand correctly, a phased rollout is the safest move.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open learning and coaching studio with other learners visible in the background. The speakers are physically present in the same appropriate scene.
