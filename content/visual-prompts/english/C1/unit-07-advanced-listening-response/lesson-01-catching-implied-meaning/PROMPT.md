...
- Lesson 1: **Catching Implied Meaning**
- Lesson key: `lesson-01-catching-implied-meaning`
- Web slug: `catching-implied-meaning`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-07-advanced-listening-response/lesson-01-catching-implied-meaning`
...
| `card-1.png` | 1254×1254 | It sounds like timing is the main concern. |
| `card-2.png` | 1254×1254 | Just to check, are you implying that we should delay the rollout? |
| `card-3.png` | 1254×1254 | What I'm hearing is we need a phased plan to reduce risk. |
...
Lesson: Catching Implied Meaning (C1, Unit 7, Lesson 1)
Conversation goal: Catch implied meaning by listening for hints, hedges, and what is not said explicitly.
Situation: Kamu ngobrol dengan stakeholder yang ngomongnya halus/indirect. Kamu perlu nangkep maksud tersirat dan cek pemahaman.
...
- Ilham: The proposal is interesting. It's just... not sure it's the right time.
- Faris: It sounds like timing is the main concern.
- Ilham: Well, there are a few moving parts.
- Faris: Just to check, are you implying that we should delay the rollout?
- Ilham: Possibly, yes.
- Faris: What I'm hearing is we need a phased plan to reduce risk.
...
## Card 1 prompt — It sounds like timing is the main concern.
...
Card focus: “It sounds like timing is the main concern.”
Conversation moment: Faris says “It sounds like timing is the main concern.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
...
## Card 2 prompt — Just to check, are you implying that we should delay the rollout?
...
Card focus: “Just to check, are you implying that we should delay the rollout?”
Conversation moment: Faris says “Just to check, are you implying that we should delay the rollout?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
...
## Card 3 prompt — What I'm hearing is we need a phased plan to reduce risk.
...
Card focus: “What I'm hearing is we need a phased plan to reduce risk.”
Conversation moment: Faris says “What I'm hearing is we need a phased plan to reduce risk.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
