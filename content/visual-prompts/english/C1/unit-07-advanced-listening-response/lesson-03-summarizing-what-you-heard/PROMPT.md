...
- Lesson key: `lesson-03-summarizing-what-you-heard`
- Web slug: `summarizing-what-you-heard`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-07-advanced-listening-response/lesson-03-summarizing-what-you-heard`
...
| `card-1.png` | 1254×1254 | So, to summarize: ... |
| `card-2.png` | 1254×1254 | The decision is to propose a phased rollout with clear metrics. |
| `card-3.png` | 1254×1254 | The open questions are around resourcing and internal alignment. |
...
Lesson: Summarizing What You Heard (C1, Unit 7, Lesson 3)
Conversation goal: Summarize accurately by separating facts, concerns, and decisions, then confirm with the speaker.
Situation: Kamu habis meeting. Kamu rangkum dengan rapi (fakta, concern, keputusan) dan cek konfirmasi.
...
- Ilham: Can you summarize the meeting?
- Faris: Sure. So, to summarize: the timeline is tight and clients are sensitive to change.
- Ilham: Any decisions?
- Faris: The decision is to propose a phased rollout with clear metrics.
- Ilham: What concerns remain?
- Faris: The open questions are around resourcing and internal alignment.
...
Card focus: “So, to summarize: ...”
Conversation moment: Faris says “Sure. So, to summarize: the timeline is tight and clients are sensitive to change.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
...
## Card 2 prompt — The decision is to propose a phased rollout with clear metrics.
...
Conversation moment: Faris says “The decision is to propose a phased rollout with clear metrics.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
...
## Card 3 prompt — The open questions are around resourcing and internal alignment.
...
Card focus: “The open questions are around resourcing and internal alignment.”
Conversation moment: Faris says “The open questions are around resourcing and internal alignment.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
