...
- Level: **C1**
- Unit 7: **Advanced Listening & Response**
- Lesson 5: **Advanced Listening Mission**
- Lesson key: `lesson-05-advanced-listening-mission`
- Web slug: `advanced-listening-mission`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-07-advanced-listening-response/lesson-05-advanced-listening-mission`
...
| `card-1.png` | 1254×1254 | It sounds like timing and risk are the main concerns. |
| `card-2.png` | 1254×1254 | Let me make sure I got this: ... |
| `card-3.png` | 1254×1254 | The decision is to propose a phased rollout with clear metrics. |
...
Lesson: Advanced Listening Mission (C1, Unit 7, Lesson 5)
Conversation goal: Handle advanced listening: implied meaning, long turns, accurate summary, and high-quality follow-ups.
Situation: Misi: kamu harus menangkap maksud tersirat, merespons penjelasan panjang, merangkum akurat, dan tanya follow-up berkualitas.

Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
...
- Ilham: The client says the plan is 'ambitious', and leadership wants visibility. Also, a few teams are nervous about changes.
- Faris: It sounds like timing and risk are the main concerns. Just to check, are you implying we should slow down?
- Ilham: Possibly.
- Faris: Let me make sure I got this: dependencies, time pressure, and visibility. The decision is to propose a phased rollout with clear metrics.
- Ilham: Yes, but we need more caution.
- Faris: When you say 'more cautious', do you mean smaller scope or slower timing? What would change your mind about the timeline?
...
## Card 1 prompt — It sounds like timing and risk are the main concerns.
...
Card focus: “It sounds like timing and risk are the main concerns.”
Conversation moment: Faris says “It sounds like timing and risk are the main concerns. Just to check, are you implying we should slow down?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
...
## Card 2 prompt — Let me make sure I got this: ...
...
Card focus: “Let me make sure I got this: ...”
Conversation moment: Faris says “Let me make sure I got this: dependencies, time pressure, and visibility. The decision is to propose a phased rollout with clear metrics.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
- Context guardrail: Show careful listening and response in the present, not a recording studio, podcast set, surveillance room, or literal replay of earlier events.
...
## Card 3 prompt — The decision is to propose a phased rollout with clear metrics.
...
Card focus: “The decision is to propose a phased rollout with clear metrics.”
Conversation moment: Faris says “Let me make sure I got this: dependencies, time pressure, and visibility. The decision is to propose a phased rollout with clear metrics.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open quiet meeting-recap room.
- Required background cues: headphones resting on the table, an abstract audio-wave shape, summary cards, concern markers, and follow-up cards without words.
