...
- Lesson key: `lesson-02-managing-expectations`
- Web slug: `managing-expectations`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-02-strategic-workplace-communication/lesson-02-managing-expectations`
...
| `card-1.png` | 1254×1254 | What we can commit to is a smaller release by next week. |
| `card-2.png` | 1254×1254 | To avoid surprises, I'd rather under-promise and deliver reliably. |
| `card-3.png` | 1254×1254 | The earliest we can deliver the full scope is two weeks later. |
...
Lesson: Managing Expectations (C1, Unit 2, Lesson 2)
Conversation goal: Manage expectations by setting clear boundaries, timelines, and what success looks like.
Situation: Ada permintaan besar. Kamu harus set ekspektasi yang realistis, jelas, dan tetap menjaga hubungan baik.
...
- Ilham: Can we deliver the full scope by next week?
- Faris: What we can commit to is a smaller release by next week.
- Ilham: Why not the full scope?
- Faris: To avoid surprises, I'd rather under-promise and deliver reliably.
- Ilham: So when can we deliver everything?
- Faris: The earliest we can deliver the full scope is two weeks later, assuming no new blockers.
...
## Card 1 prompt — What we can commit to is a smaller release by next week.
...
Card focus: “What we can commit to is a smaller release by next week.”
Conversation moment: Faris says “What we can commit to is a smaller release by next week.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 2 prompt — To avoid surprises, I'd rather under-promise and deliver reliably.
...
Card focus: “To avoid surprises, I'd rather under-promise and deliver reliably.”
Conversation moment: Faris says “To avoid surprises, I'd rather under-promise and deliver reliably.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 3 prompt — The earliest we can deliver the full scope is two weeks later.
...
Card focus: “The earliest we can deliver the full scope is two weeks later.”
Conversation moment: Faris says “The earliest we can deliver the full scope is two weeks later, assuming no new blockers.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
