...
- Lesson 3: **Handling Sensitive Feedback**
- Lesson key: `lesson-03-handling-sensitive-feedback`
- Web slug: `handling-sensitive-feedback`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-02-strategic-workplace-communication/lesson-03-handling-sensitive-feedback`
...
| `card-1.png` | 1254×1254 | I wanted to flag one point about the messaging. |
| `card-2.png` | 1254×1254 | The impact is that some teams interpreted it as a hard deadline. |
| `card-3.png` | 1254×1254 | I appreciate the intent, and I think we can make it clearer. |
...
Lesson: Handling Sensitive Feedback (C1, Unit 2, Lesson 3)
Conversation goal: Give sensitive feedback tactfully, focusing on impact and concrete next steps.
Situation: Kamu perlu kasih feedback sensitif ke stakeholder. Kamu tetap sopan, fokus ke impact, dan tawarkan next step yang konkret.
...
- Ilham: How did the last review go?
- Faris: I wanted to flag one point about the messaging.
- Ilham: Sure—what is it?
- Faris: The impact is that some teams interpreted it as a hard deadline.
- Ilham: That's not what I meant.
- Faris: I appreciate the intent, and I think we can make it clearer with one sentence.
...
## Card 1 prompt — I wanted to flag one point about the messaging.
...
Card focus: “I wanted to flag one point about the messaging.”
Conversation moment: Faris says “I wanted to flag one point about the messaging.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 2 prompt — The impact is that some teams interpreted it as a hard deadline.
...
Card focus: “The impact is that some teams interpreted it as a hard deadline.”
Conversation moment: Faris says “The impact is that some teams interpreted it as a hard deadline.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 3 prompt — I appreciate the intent, and I think we can make it clearer.
...
Card focus: “I appreciate the intent, and I think we can make it clearer.”
Conversation moment: Faris says “I appreciate the intent, and I think we can make it clearer with one sentence.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
