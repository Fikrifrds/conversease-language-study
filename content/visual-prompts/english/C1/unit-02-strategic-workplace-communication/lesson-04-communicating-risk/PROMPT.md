...
- Lesson 4: **Communicating Risk**
- Lesson key: `lesson-04-communicating-risk`
- Web slug: `communicating-risk`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-02-strategic-workplace-communication/lesson-04-communicating-risk`
...
| `card-1.png` | 1254×1254 | The main risk is a spike in incidents during rollout. |
| `card-2.png` | 1254×1254 | There's a reasonable chance, given recent instability. |
| `card-3.png` | 1254×1254 | The impact would be delayed revenue and higher support load. |
...
Lesson: Communicating Risk (C1, Unit 2, Lesson 4)
Conversation goal: Communicate risk clearly by describing likelihood, impact, and mitigation options.
Situation: Kamu harus komunikasi risiko ke stakeholder. Kamu jelasin probabilitas, dampak, dan mitigasi dengan bahasa yang jelas.
...
- Ilham: Leadership wants the briefing tomorrow, and they expect a candid picture. What risks should we highlight to leadership?
- Faris: The main risk is a spike in incidents during rollout. Everything else is secondary to that.
- Ilham: How likely is that, realistically? They'll push back if we sound alarmist.
- Faris: There's a reasonable chance, given recent instability. Two of the last three deploys needed hotfixes.
- Ilham: And if it does happen, what's the impact in business terms?
- Faris: The impact would be delayed revenue and higher support load. In the worst case, roughly a two-week slip on the revenue plan.
...
## Card 1 prompt — The main risk is a spike in incidents during rollout.
...
Card focus: “The main risk is a spike in incidents during rollout.”
Conversation moment: Faris says “The main risk is a spike in incidents during rollout. Everything else is secondary to that.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 2 prompt — There's a reasonable chance, given recent instability.
...
Card focus: “There's a reasonable chance, given recent instability.”
Conversation moment: Faris says “There's a reasonable chance, given recent instability. Two of the last three deploys needed hotfixes.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 3 prompt — The impact would be delayed revenue and higher support load.
...
Card focus: “The impact would be delayed revenue and higher support load.”
Conversation moment: Faris says “The impact would be delayed revenue and higher support load. In the worst case, roughly a two-week slip on the revenue plan.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
