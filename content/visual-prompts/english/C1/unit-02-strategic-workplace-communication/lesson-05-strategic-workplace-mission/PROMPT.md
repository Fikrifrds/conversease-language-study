...
- Level: **C1**
- Unit 2: **Strategic Workplace Communication**
- Lesson 5: **Strategic Workplace Mission**
- Lesson key: `lesson-05-strategic-workplace-mission`
- Web slug: `strategic-workplace-mission`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-02-strategic-workplace-communication/lesson-05-strategic-workplace-mission`
...
| `card-1.png` | 1254×1254 | To make sure we're aligned, what's your top priority and biggest constraint? |
| `card-2.png` | 1254×1254 | What we can commit to is a smaller release by next week, assuming no new blockers. |
| `card-3.png` | 1254×1254 | I wanted to flag the impact: it was interpreted as a hard deadline. |
...
Lesson: Strategic Workplace Mission (C1, Unit 2, Lesson 5)
Conversation goal: Lead a strategic workplace conversation: align stakeholders, manage expectations, give sensitive feedback, and communicate risk.
Situation: Misi: kamu memimpin diskusi lintas tim. Kamu selaraskan stakeholder, set ekspektasi, kasih feedback sensitif, dan jelasin risk + mitigasi.

Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
- Ilham: We need to align on priorities and deliver next week.
- Faris: To make sure we're aligned, what's your top priority and biggest constraint?
- Ilham: Speed, and we can't add headcount.
- Faris: Understood. What we can commit to is a smaller release by next week, assuming no new blockers.
- Ilham: Some teams think it's a hard deadline.
- Faris: I wanted to flag the impact: it was interpreted as a hard deadline. Would you be open to adding an explicit 'earliest possible' line?
...
## Card 1 prompt — To make sure we're aligned, what's your top priority and biggest constraint?
...
Card focus: “To make sure we're aligned, what's your top priority and biggest constraint?”
Conversation moment: Faris says “To make sure we're aligned, what's your top priority and biggest constraint?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 2 prompt — What we can commit to is a smaller release by next week, assuming no new blockers.
...
Card focus: “What we can commit to is a smaller release by next week, assuming no new blockers.”
Conversation moment: Faris says “Understood. What we can commit to is a smaller release by next week, assuming no new blockers.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 3 prompt — I wanted to flag the impact: it was interpreted as a hard deadline.
...
Card focus: “I wanted to flag the impact: it was interpreted as a hard deadline.”
Conversation moment: Faris says “I wanted to flag the impact: it was interpreted as a hard deadline. Would you be open to adding an explicit 'earliest possible' line?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
