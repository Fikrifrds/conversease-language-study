...
- Lesson 1: **Aligning Stakeholders**
- Lesson key: `lesson-01-aligning-stakeholders`
- Web slug: `aligning-stakeholders`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-02-strategic-workplace-communication/lesson-01-aligning-stakeholders`
...
| `card-1.png` | 1254×1254 | To make sure we're aligned, can you share your top priority? |
| `card-2.png` | 1254×1254 | From your perspective, what's the biggest constraint? |
| `card-3.png` | 1254×1254 | The key constraint is capacity. |
...
Lesson: Aligning Stakeholders (C1, Unit 2, Lesson 1)
Conversation goal: Align stakeholders by clarifying priorities, surfacing constraints, and confirming a shared decision.
Situation: Kamu fasilitasi alignment meeting lintas tim. Kamu klarifikasi prioritas tiap pihak, highlight constraint, lalu sepakati keputusan.
...
- Ilham: We have conflicting priorities across teams.
- Faris: To make sure we're aligned, can you share your top priority?
- Ilham: Speed. We need impact this quarter.
- Faris: Got it. From your perspective, what's the biggest constraint?
- Ilham: We can't add headcount.
- Faris: Understood. The key constraint is capacity. Can we agree that we ship a smaller scope first?
...
## Card 1 prompt — To make sure we're aligned, can you share your top priority?
...
Card focus: “To make sure we're aligned, can you share your top priority?”
Conversation moment: Faris says “To make sure we're aligned, can you share your top priority?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 2 prompt — From your perspective, what's the biggest constraint?
...
Card focus: “From your perspective, what's the biggest constraint?”
Conversation moment: Faris says “Got it. From your perspective, what's the biggest constraint?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
...
## Card 3 prompt — The key constraint is capacity.
...
Card focus: “The key constraint is capacity.”
Conversation moment: Faris says “Understood. The key constraint is capacity. Can we agree that we ship a smaller scope first?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open cross-team strategy room.
- Required background cues: stakeholder lanes made of colored shapes, constraint markers, a risk matrix without labels, and a shared decision area.
- Context guardrail: Show alignment and risk communication, not a boardroom power struggle, public speech, disciplinary hearing, or closed private office.
