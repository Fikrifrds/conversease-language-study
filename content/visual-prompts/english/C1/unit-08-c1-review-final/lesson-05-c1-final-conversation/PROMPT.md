...
- Lesson 5: **C1 Final Conversation**
- Lesson key: `lesson-05-c1-final-conversation`
- Web slug: `c1-final-conversation`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-08-c1-review-final/lesson-05-c1-final-conversation`
...
| `card-1.png` | 1254×1254 | Let me frame this: we need reliable outcomes and stakeholder confidence before scaling. |
| `card-2.png` | 1254×1254 | On balance, we can move fast, but only if we limit scope and validate metrics. |
| `card-3.png` | 1254×1254 | What I'm hearing is some fear of visibility. |
...
Lesson: C1 Final Conversation (C1, Unit 8, Lesson 5)
Conversation goal: Lead a complex conversation from framing to decision: nuance, debate, leadership listening, and clear next steps.
Situation: Final: kamu memimpin percakapan kompleks yang realistis. Kamu harus frame, jawab tantangan, nangkep maksud, dan tutup dengan keputusan + next steps.
...
- Ilham: We need a final decision for next quarter.
- Faris: Let me frame this: we need reliable outcomes and stakeholder confidence before scaling.
- Ilham: Leadership wants speed.
- Faris: On balance, we can move fast, but only if we limit scope and validate metrics.
- Ilham: The team seems hesitant.
- Faris: What I'm hearing is some fear of visibility. When you say 'hesitant', do you mean scope concerns or accountability concerns?
...
## Card 1 prompt — Let me frame this: we need reliable outcomes and stakeholder confidence before scaling.
...
Card focus: “Let me frame this: we need reliable outcomes and stakeholder confidence before scaling.”
Conversation moment: Faris says “Let me frame this: we need reliable outcomes and stakeholder confidence before scaling.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open executive-language assessment room.
- Required background cues: a strategy frame, evidence cards, risk markers, coaching questions, listening-summary cards, and a decision plan arranged as one case.
- Context guardrail: Keep the final conversation as one coherent complex professional scenario, not a collage, debate stage, presentation auditorium, or multiple disconnected scenes.
...
## Card 2 prompt — On balance, we can move fast, but only if we limit scope and validate metrics.
...
Card focus: “On balance, we can move fast, but only if we limit scope and validate metrics.”
Conversation moment: Faris says “On balance, we can move fast, but only if we limit scope and validate metrics.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open executive-language assessment room.
- Required background cues: a strategy frame, evidence cards, risk markers, coaching questions, listening-summary cards, and a decision plan arranged as one case.
- Context guardrail: Keep the final conversation as one coherent complex professional scenario, not a collage, debate stage, presentation auditorium, or multiple disconnected scenes.
...
## Card 3 prompt — What I'm hearing is some fear of visibility.
...
Card focus: “What I'm hearing is some fear of visibility.”
Conversation moment: Faris says “What I'm hearing is some fear of visibility. When you say 'hesitant', do you mean scope concerns or accountability concerns?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open executive-language assessment room.
- Required background cues: a strategy frame, evidence cards, risk markers, coaching questions, listening-summary cards, and a decision plan arranged as one case.
- Context guardrail: Keep the final conversation as one coherent complex professional scenario, not a collage, debate stage, presentation auditorium, or multiple disconnected scenes.
