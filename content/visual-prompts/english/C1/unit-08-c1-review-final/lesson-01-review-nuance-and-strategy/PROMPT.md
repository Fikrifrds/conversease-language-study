...
- Lesson 1: **Review Nuance and Strategy**
- Lesson key: `lesson-01-review-nuance-and-strategy`
- Web slug: `review-nuance-and-strategy`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-08-c1-review-final/lesson-01-review-nuance-and-strategy`
...
| `card-1.png` | 1254×1254 | On balance, I support it, but I'd adjust the scope to reduce risk. |
| `card-2.png` | 1254×1254 | To be precise, I'd keep the core workflow and postpone optional add-ons. |
| `card-3.png` | 1254×1254 | What I can commit to is a pilot next week. |
...
- Ilham: So do you support the plan or not?
- Faris: On balance, I support it, but I'd adjust the scope to reduce risk.
- Ilham: What exactly would you change?
- Faris: To be precise, I'd keep the core workflow and postpone optional add-ons.
- Ilham: Can you commit to next week?
- Faris: What I can commit to is a pilot next week, and a full rollout after we validate the metrics.
...
## Card 1 prompt — On balance, I support it, but I'd adjust the scope to reduce risk.
...
## Card 2 prompt — To be precise, I'd keep the core workflow and postpone optional add-ons.
...
## Card 3 prompt — What I can commit to is a pilot next week.
