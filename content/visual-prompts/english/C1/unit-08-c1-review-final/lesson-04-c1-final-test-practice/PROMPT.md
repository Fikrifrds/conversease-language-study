...
- Lesson 4: **C1 Final Test Practice**
- Lesson key: `lesson-04-c1-final-test-practice`
- Web slug: `c1-final-test-practice`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/C1/unit-08-c1-review-final/lesson-04-c1-final-test-practice`
...
| `card-1.png` | 1254×1254 | Let me frame this: we need reliability and stakeholder confidence before scaling. |
| `card-2.png` | 1254×1254 | On balance, I support the rollout, but only after we validate pilot metrics. |
| `card-3.png` | 1254×1254 | The decision is to run a two-week pilot. |
...
Lesson: C1 Final Test Practice (C1, Unit 8, Lesson 4)
Conversation goal: Answer C1-style prompts with nuance, structure, and precise language under time pressure.
Situation: Latihan final: kamu jawab prompt C1 dengan cepat tapi tetap bernuansa (frame, asumsi, trade-off, keputusan, next steps).
...
- Faris: Final practice. Frame the issue in one line.
- Dimas: Let me frame this: we need reliability and stakeholder confidence before scaling.
- Faris: Give your nuanced position.
- Dimas: On balance, I support the rollout, but only after we validate pilot metrics.
- Faris: Be precise about next steps.
- Dimas: Next steps are: I'll send a one-page summary today, and we'll align on scope tomorrow.
...
## Card 1 prompt — Let me frame this: we need reliability and stakeholder confidence before scaling.
...
Card focus: “Let me frame this: we need reliability and stakeholder confidence before scaling.”
Conversation moment: Dimas says “Let me frame this: we need reliability and stakeholder confidence before scaling.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open language assessment room with desks and assessment materials visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — On balance, I support the rollout, but only after we validate pilot metrics.
...
Card focus: “On balance, I support the rollout, but only after we validate pilot metrics.”
Conversation moment: Dimas says “On balance, I support the rollout, but only after we validate pilot metrics.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open language assessment room with desks and assessment materials visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — The decision is to run a two-week pilot.
...
Card focus: “The decision is to run a two-week pilot.”
Conversation moment: Dimas says “The decision is to run a two-week pilot. The open questions are resourcing and change management.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open language assessment room with desks and assessment materials visible. The speakers are physically present in the same appropriate scene.
