...
- Lesson 4: **Responding Under Pressure**
- Lesson key: `lesson-04-responding-under-pressure`
- Web slug: `responding-under-pressure`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/C1/unit-04-debate-and-analysis/lesson-04-responding-under-pressure`
...
| `card-1.png` | 1254×1254 | Let me be clear: we have indicators, not proof yet. |
| `card-2.png` | 1254×1254 | I understand the concern. However, the key point is that waiting increases risk. |
| `card-3.png` | 1254×1254 | If you look at the last four weeks, incident volume has doubled. |
...
Lesson: Responding Under Pressure (C1, Unit 4, Lesson 4)
Conversation goal: Respond under pressure by staying calm, addressing the core point, and tightening your argument.
Situation: Debat mulai panas. Kamu perlu tetap calm, jawab poin inti, dan perjelas argumen kamu tanpa defensif.
...
- Faris: This is just speculation. Do you have anything solid?
- Dimas: Let me be clear: we have indicators, not proof yet.
- Faris: So why should we act now?
- Dimas: I understand the concern. However, the key point is that waiting increases risk.
- Faris: Show me the numbers.
- Dimas: If you look at the last four weeks, incident volume has doubled.
...
## Card 1 prompt — Let me be clear: we have indicators, not proof yet.
...
Card focus: “Let me be clear: we have indicators, not proof yet.”
Conversation moment: Dimas says “Let me be clear: we have indicators, not proof yet.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open moderated analysis room.
- Required background cues: a shared evidence table, assumption cards, a logic-flow diagram made of shapes, and two calm discussion positions.
- Context guardrail: Show evidence-based professional debate, not a political event, courtroom, shouting match, combat pose, or audience spectacle.
...
## Card 2 prompt — I understand the concern. However, the key point is that waiting increases risk.
...
Card focus: “I understand the concern. However, the key point is that waiting increases risk.”
Conversation moment: Dimas says “I understand the concern. However, the key point is that waiting increases risk.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open moderated analysis room.
- Required background cues: a shared evidence table, assumption cards, a logic-flow diagram made of shapes, and two calm discussion positions.
- Context guardrail: Show evidence-based professional debate, not a political event, courtroom, shouting match, combat pose, or audience spectacle.
...
## Card 3 prompt — If you look at the last four weeks, incident volume has doubled.
...
Card focus: “If you look at the last four weeks, incident volume has doubled.”
Conversation moment: Dimas says “If you look at the last four weeks, incident volume has doubled.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open moderated analysis room.
- Required background cues: a shared evidence table, assumption cards, a logic-flow diagram made of shapes, and two calm discussion positions.
- Context guardrail: Show evidence-based professional debate, not a political event, courtroom, shouting match, combat pose, or audience spectacle.
