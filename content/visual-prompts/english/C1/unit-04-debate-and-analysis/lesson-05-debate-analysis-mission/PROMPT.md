...
- Lesson 5: **Debate Analysis Mission**
- Lesson key: `lesson-05-debate-analysis-mission`
- Web slug: `debate-analysis-mission`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/C1/unit-04-debate-and-analysis/lesson-05-debate-analysis-mission`
...
| `card-1.png` | 1254×1254 | It seems you're assuming ... What's the evidence for that claim? |
| `card-2.png` | 1254×1254 | I'm not sure that follows. Could there be another explanation? |
| `card-3.png` | 1254×1254 | To be precise, the data indicates correlation, not necessarily causation. |
...
Lesson: Debate Analysis Mission (C1, Unit 4, Lesson 5)
Conversation goal: Lead a debate-style discussion: identify assumptions, challenge claims, present evidence, and respond under pressure.
Situation: Misi: kamu memimpin diskusi debat yang realistis. Kamu angkat asumsi, uji logika, bawa evidence, dan tetap calm saat ditekan.
...
- Faris: We should cut onboarding steps. Fewer steps always increase conversion.
- Dimas: It seems you're assuming fewer steps automatically mean better conversion. What's the evidence for that claim?
- Faris: It's common sense.
- Dimas: I'm not sure that follows. Could there be another explanation, like unclear copy or missing reassurance?
- Faris: Do we have data?
- Dimas: According to the support dashboard, drop-offs increased after the redesign. To be precise, the data indicates correlation, not necessarily causation.
...
## Card 1 prompt — It seems you're assuming ... What's the evidence for that claim?
...
Card focus: “It seems you're assuming ... What's the evidence for that claim?”
Conversation moment: Faris says “We should cut onboarding steps. Fewer steps always increase conversion.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open moderated analysis room.
- Required background cues: a shared evidence table, assumption cards, a logic-flow diagram made of shapes, and two calm discussion positions.
- Context guardrail: Show evidence-based professional debate, not a political event, courtroom, shouting match, combat pose, or audience spectacle.
...
## Card 2 prompt — I'm not sure that follows. Could there be another explanation?
...
Card focus: “I'm not sure that follows. Could there be another explanation?”
Conversation moment: Dimas says “I'm not sure that follows. Could there be another explanation, like unclear copy or missing reassurance?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open moderated analysis room.
- Required background cues: a shared evidence table, assumption cards, a logic-flow diagram made of shapes, and two calm discussion positions.
- Context guardrail: Show evidence-based professional debate, not a political event, courtroom, shouting match, combat pose, or audience spectacle.
...
## Card 3 prompt — To be precise, the data indicates correlation, not necessarily causation.
...
Conversation moment: Dimas says “According to the support dashboard, drop-offs increased after the redesign. To be precise, the data indicates correlation, not necessarily causation.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open moderated analysis room.
- Required background cues: a shared evidence table, assumption cards, a logic-flow diagram made of shapes, and two calm discussion positions.
- Context guardrail: Show evidence-based professional debate, not a political event, courtroom, shouting match, combat pose, or audience spectacle.
