...
- Lesson 2: **Challenging an Argument**
- Lesson key: `lesson-02-challenging-an-argument`
- Web slug: `challenging-an-argument`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/C1/unit-04-debate-and-analysis/lesson-02-challenging-an-argument`
...
| `card-1.png` | 1254×1254 | I'm not sure that follows. |
| `card-2.png` | 1254×1254 | What's the evidence for that claim? |
| `card-3.png` | 1254×1254 | Could there be another explanation? |
...
Lesson: Challenging an Argument (C1, Unit 4, Lesson 2)
Conversation goal: Challenge an argument constructively using counterexamples, alternative explanations, and precise questions.
Situation: Kamu menantang argumen orang lain secara konstruktif. Kamu fokus ke logika dan evidence, bukan menyerang personal.
...
- Faris: I keep landing on the same conclusion: fewer steps always increases conversion, so we should cut the form to one page.
- Dimas: I'm not sure that follows. What's the evidence for that claim? We've assumed it before and been wrong.
- Faris: Honestly, it's common sense. Every extra field gives people one more chance to abandon the flow.
- Dimas: Could there be another explanation, like unclear copy or missing reassurance at the payment step? Abandonment isn't always about effort.
- Faris: Maybe. Although if that were true, I'd expect complaints about trust, not about length.
- Dimas: For example, we reduced steps last quarter, but conversion didn't change. That result is hard to square with the fewer-steps theory on its own.
...
## Card 1 prompt — I'm not sure that follows.
...
Card focus: “I'm not sure that follows.”
Conversation moment: Dimas says “I'm not sure that follows. What's the evidence for that claim? We've assumed it before and been wrong.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — What's the evidence for that claim?
...
Card focus: “What's the evidence for that claim?”
Conversation moment: Dimas says “I'm not sure that follows. What's the evidence for that claim? We've assumed it before and been wrong.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — Could there be another explanation?
...
Card focus: “Could there be another explanation?”
Conversation moment: Dimas says “Could there be another explanation, like unclear copy or missing reassurance at the payment step? Abandonment isn't always about effort.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
