...
- Lesson 1: **Framing a Complex Topic**
- Lesson key: `lesson-01-framing-a-complex-topic`
- Web slug: `framing-a-complex-topic`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/C1/unit-03-advanced-presentations/lesson-01-framing-a-complex-topic`
...
| `card-2.png` | 1254×1254 | By 'modular architecture', I mean we separate features into independent components. |
| `card-3.png` | 1254×1254 | The purpose of this is to reduce coupling and speed up delivery. |
...
- Faris: Can you present the new architecture proposal?
- Dimas: Sure. Today I'd like to walk you through the proposal and why it matters.
- Faris: What's the key concept?
- Dimas: By 'modular architecture', I mean we separate features into independent components.
- Faris: And the purpose?
- Dimas: The purpose of this is to reduce coupling and speed up delivery.
...
## Card 2 prompt — By 'modular architecture', I mean we separate features into independent components.
...
## Card 3 prompt — The purpose of this is to reduce coupling and speed up delivery.
