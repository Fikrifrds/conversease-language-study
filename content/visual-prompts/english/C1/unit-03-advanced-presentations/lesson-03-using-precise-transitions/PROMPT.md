...
- Lesson 3: **Using Precise Transitions**
- Lesson key: `lesson-03-using-precise-transitions`
- Web slug: `using-precise-transitions`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/C1/unit-03-advanced-presentations/lesson-03-using-precise-transitions`
...
| `card-1.png` | 1254×1254 | That brings me to the key trade-off: speed versus reliability. |
| `card-2.png` | 1254×1254 | What's crucial here is that we set clear standards early. |
| `card-3.png` | 1254×1254 | To put it differently, ... |
...
Lesson: Using Precise Transitions (C1, Unit 3, Lesson 3)
Conversation goal: Use precise transitions to guide listeners through complex ideas smoothly.
Situation: Kamu menjelaskan ide yang panjang. Kamu perlu transisi yang rapi supaya audiens bisa ngikutin alurnya.
...
- Dimas: That brings me to the key trade-off: speed versus reliability.
- Faris: What's crucial here?
- Dimas: What's crucial here is that we set clear standards early.
- Faris: Can you restate it?
- Dimas: To put it differently, standards let teams move fast without breaking consistency.
...
## Card 1 prompt — That brings me to the key trade-off: speed versus reliability.
...
Conversation moment: Dimas says “That brings me to the key trade-off: speed versus reliability.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open advanced-presentation studio.
- Required background cues: a large blank screen with layered abstract diagrams, evidence cards, transition arrows, a question area, and rows of chairs.
- Context guardrail: Show a complex presentation or Q&A, not a lecture crowd, television studio, entertainment stage, or slide full of readable writing.
...
## Card 2 prompt — What's crucial here is that we set clear standards early.
...
Card focus: “What's crucial here is that we set clear standards early.”
Conversation moment: Faris says “What's crucial here?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open advanced-presentation studio.
- Required background cues: a large blank screen with layered abstract diagrams, evidence cards, transition arrows, a question area, and rows of chairs.
- Context guardrail: Show a complex presentation or Q&A, not a lecture crowd, television studio, entertainment stage, or slide full of readable writing.
...
## Card 3 prompt — To put it differently, ...
...
Card focus: “To put it differently, ...”
Conversation moment: Dimas says “To put it differently, standards let teams move fast without breaking consistency.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open advanced-presentation studio.
- Required background cues: a large blank screen with layered abstract diagrams, evidence cards, transition arrows, a question area, and rows of chairs.
- Context guardrail: Show a complex presentation or Q&A, not a lecture crowd, television studio, entertainment stage, or slide full of readable writing.
