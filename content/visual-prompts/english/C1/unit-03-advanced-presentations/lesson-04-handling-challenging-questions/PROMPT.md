...
- Lesson 4: **Handling Challenging Questions**
- Lesson key: `lesson-04-handling-challenging-questions`
- Web slug: `handling-challenging-questions`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/C1/unit-03-advanced-presentations/lesson-04-handling-challenging-questions`
...
| `card-1.png` | 1254×1254 | That's a fair question. |
| `card-2.png` | 1254×1254 | Let me clarify what risk we're accepting. |
| `card-3.png` | 1254×1254 | The short answer is: it's manageable if we pilot first and monitor closely. |
...
Lesson: Handling Challenging Questions (C1, Unit 3, Lesson 4)
Conversation goal: Handle challenging questions by acknowledging concerns, answering precisely, and reframing when needed.
Situation: Saat Q&A, kamu dapat pertanyaan menantang. Kamu harus tetap tenang, jawab presisi, dan bisa reframe kalau perlu.
...
- Dimas: That's a fair question. Let me clarify what risk we're accepting.
- Faris: Go ahead. I'd like to hear how you're framing it before we debate the details.
- Dimas: The short answer is: it's manageable if we pilot first and monitor closely. The scenario that worries people is a silent failure, and the monitoring is designed to catch exactly that.
- Faris: What if teams ignore the standards once the pilot pressure is off? That's what happened with the last initiative.
- Dimas: What I'd emphasize is that standards need ownership and enforcement. Every guideline will have a named owner and a review cadence, not just a document.
...
## Card 1 prompt — That's a fair question.
...
Card focus: “That's a fair question.”
Conversation moment: Dimas says “That's a fair question. Let me clarify what risk we're accepting.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open advanced-presentation studio.
- Required background cues: a large blank screen with layered abstract diagrams, evidence cards, transition arrows, a question area, and rows of chairs.
- Context guardrail: Show a complex presentation or Q&A, not a lecture crowd, television studio, entertainment stage, or slide full of readable writing.
...
## Card 2 prompt — Let me clarify what risk we're accepting.
...
Card focus: “Let me clarify what risk we're accepting.”
Conversation moment: Dimas says “That's a fair question. Let me clarify what risk we're accepting.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open advanced-presentation studio.
- Required background cues: a large blank screen with layered abstract diagrams, evidence cards, transition arrows, a question area, and rows of chairs.
...
## Card 3 prompt — The short answer is: it's manageable if we pilot first and monitor closely.
...
Card focus: “The short answer is: it's manageable if we pilot first and monitor closely.”
Conversation moment: Dimas says “The short answer is: it's manageable if we pilot first and monitor closely. The scenario that worries people is a silent failure, and the monitoring is designed to catch exactly that.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open advanced-presentation studio.
- Required background cues: a large blank screen with layered abstract diagrams, evidence cards, transition arrows, a question area, and rows of chairs.
- Context guardrail: Show a complex presentation or Q&A, not a lecture crowd, television studio, entertainment stage, or slide full of readable writing.
