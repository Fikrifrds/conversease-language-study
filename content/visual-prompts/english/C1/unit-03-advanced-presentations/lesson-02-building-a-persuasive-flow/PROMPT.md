...
- Lesson 2: **Building a Persuasive Flow**
- Lesson key: `lesson-02-building-a-persuasive-flow`
- Web slug: `building-a-persuasive-flow`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/C1/unit-03-advanced-presentations/lesson-02-building-a-persuasive-flow`
...
| `card-1.png` | 1254×1254 | The core claim is that modularization will improve delivery speed. |
| `card-2.png` | 1254×1254 | The evidence suggests teams ship faster when ownership is clear. |
| `card-3.png` | 1254×1254 | A common concern is fragmentation. |
...
Lesson: Building a Persuasive Flow (C1, Unit 3, Lesson 2)
Conversation goal: Build a persuasive flow by stating a claim, supporting it with evidence, and addressing counterarguments.
Situation: Kamu presentasi dengan tujuan meyakinkan. Kamu harus runtut: claim, evidence, counterpoint, lalu conclusion.
...
- Faris: What's the main argument for the proposal?
- Dimas: The core claim is that modularization will improve delivery speed.
- Faris: What's the evidence?
- Dimas: The evidence suggests teams ship faster when ownership is clear.
- Faris: What about the risk of fragmentation?
- Dimas: A common concern is fragmentation. That said, shared standards can mitigate it.
...
## Card 1 prompt — The core claim is that modularization will improve delivery speed.
...
Card focus: “The core claim is that modularization will improve delivery speed.”
Conversation moment: Dimas says “The core claim is that modularization will improve delivery speed.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open professional presentation room with a blank presentation screen and neatly arranged audience chairs. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — The evidence suggests teams ship faster when ownership is clear.
...
Card focus: “The evidence suggests teams ship faster when ownership is clear.”
Conversation moment: Dimas says “The evidence suggests teams ship faster when ownership is clear.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open professional presentation room with a blank presentation screen and neatly arranged audience chairs. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — A common concern is fragmentation.
...
Card focus: “A common concern is fragmentation.”
Conversation moment: Dimas says “A common concern is fragmentation. That said, shared standards can mitigate it.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open professional presentation room with a blank presentation screen and neatly arranged audience chairs. The speakers are physically present in the same appropriate scene.
