...
- Lesson 3: **Explaining Local Norms**
- Lesson key: `lesson-03-explaining-local-norms`
- Web slug: `explaining-local-norms`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-05-cross-cultural-professionalism/lesson-03-explaining-local-norms`
...
| `card-1.png` | 1254×1254 | In our context, people tend to be indirect when disagreeing in group settings. |
| `card-2.png` | 1254×1254 | It's generally expected that you raise concerns one-on-one first. |
| `card-3.png` | 1254×1254 | It might help to start with appreciation, then ask a question. |
...
Lesson: Explaining Local Norms (C1, Unit 5, Lesson 3)
Conversation goal: Explain local work norms tactfully and help others adapt without sounding judgmental.
Situation: Ada rekan baru dari budaya berbeda. Kamu jelasin kebiasaan kerja lokal dengan cara yang sopan dan membantu.
...
- Ilham: I'm not sure how direct I should be with the team.
- Faris: In our context, people tend to be indirect when disagreeing in group settings.
- Ilham: So I shouldn't disagree openly?
- Faris: It's generally expected that you raise concerns one-on-one first.
- Ilham: Interesting. Any tips?
- Faris: It might help to start with appreciation, then ask a question instead of stating a critique.
...
## Card 1 prompt — In our context, people tend to be indirect when disagreeing in group settings.
...
Card focus: “In our context, people tend to be indirect when disagreeing in group settings.”
Conversation moment: Faris says “In our context, people tend to be indirect when disagreeing in group settings.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public community or professional training center with activity materials visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — It's generally expected that you raise concerns one-on-one first.
...
Card focus: “It's generally expected that you raise concerns one-on-one first.”
Conversation moment: Faris says “It's generally expected that you raise concerns one-on-one first.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public community or professional training center with activity materials visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — It might help to start with appreciation, then ask a question.
...
Card focus: “It might help to start with appreciation, then ask a question.”
Conversation moment: Faris says “It might help to start with appreciation, then ask a question instead of stating a critique.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public community or professional training center with activity materials visible. The speakers are physically present in the same appropriate scene.
