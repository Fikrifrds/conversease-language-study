...
- Lesson 4: **Repairing Misunderstanding**
- Lesson key: `lesson-04-repairing-misunderstanding`
- Web slug: `repairing-misunderstanding`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-05-cross-cultural-professionalism/lesson-04-repairing-misunderstanding`
...
| `card-1.png` | 1254×1254 | I may have misunderstood their tone. |
| `card-2.png` | 1254×1254 | I didn't mean to come across as dismissive. |
| `card-3.png` | 1254×1254 | Just to clarify, my intent was to confirm the constraints, not reject the request. |
...
Lesson: Repairing Misunderstanding (C1, Unit 5, Lesson 4)
Conversation goal: Repair a misunderstanding by acknowledging it, clarifying intent, and proposing a constructive next step.
Situation: Terjadi miskomunikasi lintas budaya. Kamu perlu memperbaiki situasi dengan cepat, sopan, dan jelas.
...
- Ilham: The client seemed upset after your message.
- Faris: I may have misunderstood their tone. I didn't mean to come across as dismissive.
- Ilham: What should we do now?
- Faris: Just to clarify, my intent was to confirm the constraints, not reject the request.
- Ilham: Should we apologize?
- Faris: Yes. How about we send a short note acknowledging the misunderstanding and offer a quick call?
...
## Card 1 prompt — I may have misunderstood their tone.
...
Card focus: “I may have misunderstood their tone.”
Conversation moment: Faris says “I may have misunderstood their tone. I didn't mean to come across as dismissive.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open international professional training center.
- Required background cues: blank message cards, neutral workplace objects, a time-sequence diagram, and a shared clarification board.
- Context guardrail: Show workplace communication across contexts without flags, national costumes, skin-tone stereotypes, religious symbols, ceremonies, or tourist landmarks.
...
## Card 2 prompt — I didn't mean to come across as dismissive.
...
Card focus: “I didn't mean to come across as dismissive.”
Conversation moment: Faris says “I may have misunderstood their tone. I didn't mean to come across as dismissive.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open international professional training center.
- Required background cues: blank message cards, neutral workplace objects, a time-sequence diagram, and a shared clarification board.
...
## Card 3 prompt — Just to clarify, my intent was to confirm the constraints, not reject the request.
...
Card focus: “Just to clarify, my intent was to confirm the constraints, not reject the request.”
Conversation moment: Faris says “Just to clarify, my intent was to confirm the constraints, not reject the request.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open international professional training center.
- Required background cues: blank message cards, neutral workplace objects, a time-sequence diagram, and a shared clarification board.
- Context guardrail: Show workplace communication across contexts without flags, national costumes, skin-tone stereotypes, religious symbols, ceremonies, or tourist landmarks.
