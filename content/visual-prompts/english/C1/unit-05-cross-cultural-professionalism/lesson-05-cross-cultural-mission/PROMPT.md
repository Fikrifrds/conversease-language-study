...
- Level: **C1**
- Unit 5: **Cross-cultural Professionalism**
- Lesson 5: **Cross-cultural Mission**
- Lesson key: `lesson-05-cross-cultural-mission`
- Web slug: `cross-cultural-mission`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-05-cross-cultural-professionalism/lesson-05-cross-cultural-mission`
...
| `card-1.png` | 1254×1254 | My sense is that they're signaling concern indirectly. |
| `card-2.png` | 1254×1254 | Would you mind if I ask how you prefer to receive feedback? |
| `card-3.png` | 1254×1254 | In our context, it's generally expected that we raise concerns one-on-one first. |
...
Lesson: Cross-cultural Mission (C1, Unit 5, Lesson 5)
Conversation goal: Handle a cross-cultural situation: read context, ask tactful questions, explain norms, and repair misunderstandings.
Situation: Misi: kamu handle situasi lintas budaya dari interpretasi pesan sampai repair miskomunikasi, dengan tone yang profesional.

Scene and background:
- Actual conversation location: an open international professional training center.
- Required background cues: blank message cards, neutral workplace objects, a time-sequence diagram, and a shared clarification board.
- Context guardrail: Show workplace communication across contexts without flags, national costumes, skin-tone stereotypes, religious symbols, ceremonies, or tourist landmarks.
...
- Ilham: The client says the timeline is 'ambitious'.
- Faris: My sense is that they're signaling concern indirectly. Before we decide, can we clarify whether they prioritize speed or risk reduction?
- Ilham: They also dislike direct criticism.
- Faris: Would you mind if I ask how they prefer to receive feedback—writing or a call?
- Ilham: In our culture, they prefer private feedback first.
- Faris: In our context, it's generally expected that we raise concerns one-on-one first. It might help to start with appreciation.
...
## Card 1 prompt — My sense is that they're signaling concern indirectly.
...
Card focus: “My sense is that they're signaling concern indirectly.”
Conversation moment: Faris says “My sense is that they're signaling concern indirectly. Before we decide, can we clarify whether they prioritize speed or risk reduction?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open international professional training center.
- Required background cues: blank message cards, neutral workplace objects, a time-sequence diagram, and a shared clarification board.
- Context guardrail: Show workplace communication across contexts without flags, national costumes, skin-tone stereotypes, religious symbols, ceremonies, or tourist landmarks.
...
## Card 2 prompt — Would you mind if I ask how you prefer to receive feedback?
...
Card focus: “Would you mind if I ask how you prefer to receive feedback?”
Conversation moment: Faris says “My sense is that they're signaling concern indirectly. Before we decide, can we clarify whether they prioritize speed or risk reduction?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open international professional training center.
- Required background cues: blank message cards, neutral workplace objects, a time-sequence diagram, and a shared clarification board.
...
## Card 3 prompt — In our context, it's generally expected that we raise concerns one-on-one first.
...
Card focus: “In our context, it's generally expected that we raise concerns one-on-one first.”
Conversation moment: Faris says “In our context, it's generally expected that we raise concerns one-on-one first. It might help to start with appreciation.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open international professional training center.
- Required background cues: blank message cards, neutral workplace objects, a time-sequence diagram, and a shared clarification board.
- Context guardrail: Show workplace communication across contexts without flags, national costumes, skin-tone stereotypes, religious symbols, ceremonies, or tourist landmarks.
