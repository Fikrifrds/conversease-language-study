...
- Lesson 1: **Qualifying Your Opinion**
- Lesson key: `lesson-01-qualifying-your-opinion`
- Web slug: `qualifying-your-opinion`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-01-nuanced-opinions/lesson-01-qualifying-your-opinion`
...
| `card-2.png` | 1254×1254 | Broadly speaking, I support it. |
| `card-3.png` | 1254×1254 | That said, we need a clear exception for legacy systems. |
...
Lesson: Qualifying Your Opinion (C1, Unit 1, Lesson 1)
Conversation goal: Qualify your opinion with nuance by signaling scope, conditions, and limits.
Situation: Kamu lagi diskusi kerja. Kamu setuju sebagian, tapi kamu kasih batasan dan kondisi biar opini kamu lebih presisi.
...
- Ilham: Do you think we should adopt the new policy immediately?
- Faris: To some extent, yes—especially for new projects.
- Ilham: So you're fully in favor?
- Faris: Broadly speaking, I support it. That said, we need a clear exception for legacy systems.
- Ilham: What's the main concern?
- Faris: In principle it's a good move, but the rollout timeline is too aggressive.
...
Conversation moment: Faris says “To some extent, yes—especially for new projects.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open strategy discussion room.
- Required background cues: two viewpoint cards, a balance diagram, certainty markers, and a shared conclusion card without words.
- Context guardrail: Show careful professional reasoning, not a political debate, courtroom, media interview, or hostile confrontation.
...
## Card 2 prompt — Broadly speaking, I support it.
...
Card focus: “Broadly speaking, I support it.”
Conversation moment: Faris says “Broadly speaking, I support it. That said, we need a clear exception for legacy systems.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open strategy discussion room.
- Required background cues: two viewpoint cards, a balance diagram, certainty markers, and a shared conclusion card without words.
- Context guardrail: Show careful professional reasoning, not a political debate, courtroom, media interview, or hostile confrontation.
...
## Card 3 prompt — That said, we need a clear exception for legacy systems.
...
Card focus: “That said, we need a clear exception for legacy systems.”
Conversation moment: Faris says “Broadly speaking, I support it. That said, we need a clear exception for legacy systems.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open strategy discussion room.
- Required background cues: two viewpoint cards, a balance diagram, certainty markers, and a shared conclusion card without words.
