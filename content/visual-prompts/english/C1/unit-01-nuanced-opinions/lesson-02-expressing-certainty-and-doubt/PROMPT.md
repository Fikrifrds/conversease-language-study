...
- Lesson 2: **Expressing Certainty and Doubt**
- Lesson key: `lesson-02-expressing-certainty-and-doubt`
- Web slug: `expressing-certainty-and-doubt`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-01-nuanced-opinions/lesson-02-expressing-certainty-and-doubt`
...
| `card-1.png` | 1254×1254 | I'm fairly confident it will, given the support trends. |
| `card-2.png` | 1254×1254 | I'm not entirely convinced. |
| `card-3.png` | 1254×1254 | There's a strong chance we'll see edge cases. |
...
Lesson: Expressing Certainty and Doubt (C1, Unit 1, Lesson 2)
Conversation goal: Express degrees of certainty and doubt using precise language and evidence framing.
Situation: Kamu diskusi strategi. Kamu harus bilang mana yang kamu yakin, mana yang kamu ragu, tanpa terdengar ragu-ragu atau terlalu absolut.
...
- Ilham: Will this change reduce complaints?
- Faris: I'm fairly confident it will, given the support trends.
- Ilham: So we're safe to roll it out broadly?
- Faris: I'm not entirely convinced. There's a strong chance we'll see edge cases.
- Ilham: Is it risky, then?
- Faris: It's unlikely that we'll break core flows, but we should monitor closely.
...
## Card 1 prompt — I'm fairly confident it will, given the support trends.
...
Card focus: “I'm fairly confident it will, given the support trends.”
Conversation moment: Faris says “I'm fairly confident it will, given the support trends.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open strategy discussion room.
- Required background cues: two viewpoint cards, a balance diagram, certainty markers, and a shared conclusion card without words.
- Context guardrail: Show careful professional reasoning, not a political debate, courtroom, media interview, or hostile confrontation.
...
## Card 2 prompt — I'm not entirely convinced.
...
Card focus: “I'm not entirely convinced.”
Conversation moment: Faris says “I'm not entirely convinced. There's a strong chance we'll see edge cases.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open strategy discussion room.
- Required background cues: two viewpoint cards, a balance diagram, certainty markers, and a shared conclusion card without words.
- Context guardrail: Show careful professional reasoning, not a political debate, courtroom, media interview, or hostile confrontation.
...
## Card 3 prompt — There's a strong chance we'll see edge cases.
...
Card focus: “There's a strong chance we'll see edge cases.”
Conversation moment: Faris says “I'm not entirely convinced. There's a strong chance we'll see edge cases.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open strategy discussion room.
- Required background cues: two viewpoint cards, a balance diagram, certainty markers, and a shared conclusion card without words.
