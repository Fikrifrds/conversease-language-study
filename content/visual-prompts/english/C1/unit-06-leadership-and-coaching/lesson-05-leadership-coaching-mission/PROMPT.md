...
- Lesson 5: **Leadership Coaching Mission**
- Lesson key: `lesson-05-leadership-coaching-mission`
- Web slug: `leadership-coaching-mission`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-06-leadership-and-coaching/lesson-05-leadership-coaching-mission`
...
| `card-1.png` | 1254×1254 | The direction I'd like to set is ... |
| `card-2.png` | 1254×1254 | What options do you see right now? |
| `card-3.png` | 1254×1254 | One thing I'd suggest is leading with the decision. |
...
Lesson: Leadership Coaching Mission (C1, Unit 6, Lesson 5)
Conversation goal: Lead a coaching conversation: set direction, ask coaching questions, give actionable feedback, and guide a decision.
Situation: Misi: kamu memimpin percakapan coaching yang utuh, dari set direction sampai membuat keputusan dan next steps.
...
- Ilham: I'm stuck and we need to decide fast.
- Faris: The direction I'd like to set is stabilizing billing first. What options do you see?
- Ilham: Pilot or phased rollout.
- Faris: Great. What would success look like? And what's the smallest next step today?
- Ilham: Draft the checklist and metrics.
- Faris: Overall your update is solid. One thing I'd suggest is leading with the decision—the impact is people might miss it.
...
## Card 1 prompt — The direction I'd like to set is ...
...
Card focus: “The direction I'd like to set is ...”
Conversation moment: Faris says “The direction I'd like to set is stabilizing billing first. What options do you see?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
...
## Card 2 prompt — What options do you see right now?
...
Card focus: “What options do you see right now?”
Conversation moment: Faris says “The direction I'd like to set is stabilizing billing first. What options do you see?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
...
## Card 3 prompt — One thing I'd suggest is leading with the decision.
...
Conversation moment: Faris says “Overall your update is solid. One thing I'd suggest is leading with the decision—the impact is people might miss it.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
