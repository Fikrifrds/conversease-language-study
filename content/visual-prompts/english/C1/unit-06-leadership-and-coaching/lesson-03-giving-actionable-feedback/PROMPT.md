...
- Lesson key: `lesson-03-giving-actionable-feedback`
- Web slug: `giving-actionable-feedback`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-06-leadership-and-coaching/lesson-03-giving-actionable-feedback`
...
| `card-1.png` | 1254×1254 | One thing I'd suggest is leading with the decision. |
| `card-2.png` | 1254×1254 | The impact is that stakeholders scan quickly and might miss the point. |
| `card-3.png` | 1254×1254 | A concrete improvement would be a one-line summary at the top. |
...
Lesson: Giving Actionable Feedback (C1, Unit 6, Lesson 3)
Conversation goal: Give actionable feedback by describing impact, being specific, and proposing a clear improvement.
Situation: Kamu kasih feedback yang actionable: spesifik, fokus ke impact, dan ada improvement yang jelas.
...
- Ilham: How was my update message?
- Faris: Overall it's solid. One thing I'd suggest is leading with the decision.
- Ilham: Why?
- Faris: The impact is that stakeholders scan quickly and might miss the point.
- Ilham: So what should I change?
- Faris: A concrete improvement would be a one-line summary at the top.
...
## Card 1 prompt — One thing I'd suggest is leading with the decision.
...
Card focus: “One thing I'd suggest is leading with the decision.”
Conversation moment: Faris says “Overall it's solid. One thing I'd suggest is leading with the decision.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
...
## Card 2 prompt — The impact is that stakeholders scan quickly and might miss the point.
...
Card focus: “The impact is that stakeholders scan quickly and might miss the point.”
Conversation moment: Faris says “The impact is that stakeholders scan quickly and might miss the point.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
...
## Card 3 prompt — A concrete improvement would be a one-line summary at the top.
...
Card focus: “A concrete improvement would be a one-line summary at the top.”
Conversation moment: Faris says “A concrete improvement would be a one-line summary at the top.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
