...
- Lesson 4: **Guiding a Decision**
- Lesson key: `lesson-04-guiding-a-decision`
- Web slug: `guiding-a-decision`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/C1/unit-06-leadership-and-coaching/lesson-04-guiding-a-decision`
...
| `card-1.png` | 1254×1254 | We have three options: pilot, phased rollout, or full rollout. |
| `card-2.png` | 1254×1254 | The trade-off is speed versus risk and operational load. |
| `card-3.png` | 1254×1254 | Given our constraints, I'd recommend a phased rollout with clear monitoring. |
...
Lesson: Guiding a Decision (C1, Unit 6, Lesson 4)
Conversation goal: Guide a decision by structuring options, trade-offs, and a clear recommendation.
Situation: Tim buntu. Kamu bantu bikin keputusan dengan struktur: opsi, trade-off, constraint, rekomendasi, lalu alignment.

Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
...
- Ilham: We can't decide which approach to take.
- Faris: We have three options: pilot, phased rollout, or full rollout.
- Ilham: What's the trade-off?
- Faris: The trade-off is speed versus risk and operational load.
- Ilham: Given our constraints, what do you recommend?
- Faris: Given our constraints, I'd recommend a phased rollout with clear monitoring.
...
## Card 1 prompt — We have three options: pilot, phased rollout, or full rollout.
...
Card focus: “We have three options: pilot, phased rollout, or full rollout.”
Conversation moment: Faris says “We have three options: pilot, phased rollout, or full rollout.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
...
## Card 2 prompt — The trade-off is speed versus risk and operational load.
...
Card focus: “The trade-off is speed versus risk and operational load.”
Conversation moment: Faris says “The trade-off is speed versus risk and operational load.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
...
## Card 3 prompt — Given our constraints, I'd recommend a phased rollout with clear monitoring.
...
Card focus: “Given our constraints, I'd recommend a phased rollout with clear monitoring.”
Conversation moment: Faris says “Given our constraints, I'd recommend a phased rollout with clear monitoring.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open leadership coaching studio.
- Required background cues: a direction board made of shapes, ownership cards, option-and-trade-off tokens, and a next-step planner without text.
- Context guardrail: Show supportive coaching and decision guidance, not a performance review hearing, classroom lecture, motivational stage, or private closed office.
