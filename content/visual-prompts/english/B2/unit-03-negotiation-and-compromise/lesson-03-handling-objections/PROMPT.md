...
- Lesson key: `lesson-03-handling-objections`
- Web slug: `handling-objections`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-03-negotiation-and-compromise/lesson-03-handling-objections`
...
| `card-2.png` | 1254×1254 | What part feels risky to you? |
| `card-3.png` | 1254×1254 | Would it help if we limit reviews to high-risk changes only? |
...
Lesson: Handling Objections (B2, Unit 3, Lesson 3)
Conversation goal: Respond to an objection politely, ask a clarifying question, and offer a revised proposal.
Situation: Lawan bicara keberatan. Kamu respon sopan, tanya klarifikasi, lalu revisi proposal biar lebih bisa diterima.
...
- Faris: I understand the concern. What part feels risky to you?
- Ilham: The extra review steps.
- Faris: Would it help if we limit reviews to high-risk changes only?
- Ilham: Maybe, but who decides what's high-risk?
- Faris: Good question. What if we define simple criteria and review them together?
...
Conversation moment: Faris says “I understand the concern. What part feels risky to you?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
...
## Card 2 prompt — What part feels risky to you?
...
Card focus: “What part feels risky to you?”
Conversation moment: Faris says “I understand the concern. What part feels risky to you?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
...
## Card 3 prompt — Would it help if we limit reviews to high-risk changes only?
...
Card focus: “Would it help if we limit reviews to high-risk changes only?”
Conversation moment: Faris says “Would it help if we limit reviews to high-risk changes only?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
