...
- Lesson 4: **Finding Middle Ground**
- Lesson key: `lesson-04-finding-middle-ground`
- Web slug: `finding-middle-ground`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-03-negotiation-and-compromise/lesson-04-finding-middle-ground`
...
| `card-1.png` | 1254×1254 | Maybe we can find a compromise. |
| `card-2.png` | 1254×1254 | A compromise could be launching to 10% of users first. |
| `card-3.png` | 1254×1254 | If we do a small rollout, can we agree on one extra day? |
...
Lesson: Finding Middle Ground (B2, Unit 3, Lesson 4)
Conversation goal: Find a compromise, propose a middle-ground option, and confirm agreement.
Situation: Kalian beda pendapat. Kamu usul opsi tengah, jelasin trade-off singkat, lalu konfirmasi kesepakatan.
...
- Faris: I want to launch next week, but you want more testing.
- Dimas: Maybe we can find a compromise.
- Faris: Like what?
- Dimas: A compromise could be launching to 10% of users first.
- Faris: That could work. What about testing?
- Dimas: If we do a small rollout, can we agree on one extra day for testing?
...
## Card 1 prompt — Maybe we can find a compromise.
...
Card focus: “Maybe we can find a compromise.”
Conversation moment: Dimas says “Maybe we can find a compromise.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open professional client-service area with relevant documents and work objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — A compromise could be launching to 10% of users first.
...
Card focus: “A compromise could be launching to 10% of users first.”
Conversation moment: Dimas says “A compromise could be launching to 10% of users first.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open professional client-service area with relevant documents and work objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — If we do a small rollout, can we agree on one extra day?
...
Card focus: “If we do a small rollout, can we agree on one extra day?”
Conversation moment: Dimas says “If we do a small rollout, can we agree on one extra day for testing?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open professional client-service area with relevant documents and work objects visible. The speakers are physically present in the same appropriate scene.
