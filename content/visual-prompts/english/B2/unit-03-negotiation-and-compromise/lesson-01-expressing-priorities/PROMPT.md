...
- Lesson 1: **Expressing Priorities**
- Lesson key: `lesson-01-expressing-priorities`
- Web slug: `expressing-priorities`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-03-negotiation-and-compromise/lesson-01-expressing-priorities`
...
| `card-1.png` | 1254×1254 | My top priority is shipping the core feature safely. |
| `card-2.png` | 1254×1254 | What matters most is shipping safely. |
| `card-3.png` | 1254×1254 | Because the deadline is close. |
...
Lesson: Expressing Priorities (B2, Unit 3, Lesson 1)
Conversation goal: State your priorities clearly, explain what matters most, and ask about the other person's priorities.
Situation: Kamu lagi diskusi rencana kerja. Kamu jelasin prioritas utama kamu, jelasin alasannya singkat, lalu tanya prioritas lawan bicara.
...
- Faris: We have limited time. What should we focus on first?
- Dimas: My top priority is shipping the core feature safely.
- Faris: Why that first?
- Dimas: Because it's the main value for users, and the deadline is close.
- Faris: Okay. Anything else?
- Dimas: The second priority is improving monitoring, so we can catch issues early.
...
## Card 1 prompt — My top priority is shipping the core feature safely.
...
Card focus: “My top priority is shipping the core feature safely.”
Conversation moment: Dimas says “My top priority is shipping the core feature safely.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
...
## Card 2 prompt — What matters most is shipping safely.
...
Card focus: “What matters most is shipping safely.”
Conversation moment: Dimas says “My top priority is shipping the core feature safely.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
...
## Card 3 prompt — Because the deadline is close.
...
Card focus: “Because the deadline is close.”
Conversation moment: Faris says “Why that first?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
