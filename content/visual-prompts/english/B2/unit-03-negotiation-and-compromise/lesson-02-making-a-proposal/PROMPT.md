...
- Level: **B2**
- Unit 3: **Negotiation & Compromise**
- Lesson 2: **Making a Proposal**
- Lesson key: `lesson-02-making-a-proposal`
- Web slug: `making-a-proposal`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-03-negotiation-and-compromise/lesson-02-making-a-proposal`
...
| `card-1.png` | 1254×1254 | I propose we do a small pilot first. |
| `card-2.png` | 1254×1254 | How about we run it for two weeks? |
| `card-3.png` | 1254×1254 | Would that work for you? |
...
Lesson: Making a Proposal (B2, Unit 3, Lesson 2)
Conversation goal: Make a clear proposal, suggest a timeline, and ask if it works.
Situation: Kamu negosiasi rencana. Kamu ajukan proposal, sebut timeline, lalu tanya apakah itu works buat tim.

Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
...
- Faris: How should we handle the launch plan? Marketing keeps asking me for a firm date.
- Dimas: I propose we do a small pilot first. It lowers the risk without blocking the bigger plan.
- Faris: What timeline are you thinking? We can't keep the date open forever.
- Dimas: How about we run it for two weeks and review the results? Two weeks is enough to see real usage patterns.
- Faris: Would that delay the full launch? That's my main worry here.
- Dimas: Not necessarily. We can prepare in parallel. The launch checklist doesn't depend on the pilot results.
...
## Card 1 prompt — I propose we do a small pilot first.
...
Card focus: “I propose we do a small pilot first.”
Conversation moment: Dimas says “I propose we do a small pilot first. It lowers the risk without blocking the bigger plan.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
...
## Card 2 prompt — How about we run it for two weeks?
...
Card focus: “How about we run it for two weeks?”
Conversation moment: Dimas says “How about we run it for two weeks and review the results? Two weeks is enough to see real usage patterns.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
...
## Card 3 prompt — Would that work for you?
...
Card focus: “Would that work for you?”
Conversation moment: Faris says “Okay, let's draft it that way then. Would that work for you?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
