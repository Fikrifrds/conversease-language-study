...
- Lesson 5: **Negotiation Mission**
- Lesson key: `lesson-05-negotiation-mission`
- Web slug: `negotiation-mission`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-03-negotiation-and-compromise/lesson-05-negotiation-mission`
...
| `card-1.png` | 1254×1254 | My top priority is quality. What matters most to you? |
| `card-2.png` | 1254×1254 | I propose we run a small pilot for two weeks. |
| `card-3.png` | 1254×1254 | I understand the concern. Would it help if we prepare in parallel? |
...
Lesson: Negotiation Mission (B2, Unit 3, Lesson 5)
Conversation goal: Complete a negotiation: align priorities, make a proposal, handle objections, find middle ground, and agree on next steps.
Situation: Misi: kamu negosiasi rencana launch. Kamu align prioritas, usul proposal, handle keberatan, cari kompromi, lalu sepakat next step.
...
- Faris: We need to decide our launch plan.
- Dimas: My top priority is quality. What matters most to you?
- Faris: My top priority is speed.
- Dimas: I understand. I propose we run a small pilot for two weeks.
- Faris: I'm concerned it will delay the launch.
- Dimas: I understand the concern. Would it help if we prepare in parallel?
...
## Card 1 prompt — My top priority is quality. What matters most to you?
...
Card focus: “My top priority is quality. What matters most to you?”
Conversation moment: Dimas says “My top priority is quality. What matters most to you?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
...
## Card 2 prompt — I propose we run a small pilot for two weeks.
...
Card focus: “I propose we run a small pilot for two weeks.”
Conversation moment: Dimas says “I understand. I propose we run a small pilot for two weeks.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
...
## Card 3 prompt — I understand the concern. Would it help if we prepare in parallel?
...
Card focus: “I understand the concern. Would it help if we prepare in parallel?”
Conversation moment: Dimas says “I understand the concern. Would it help if we prepare in parallel?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional negotiation room.
- Required background cues: two proposal folders, a visual timeline made of blocks, priority tokens, and a central compromise card without words.
- Context guardrail: Show a collaborative work negotiation, not haggling in a market, legal signing ceremony, conflict, or handshake.
