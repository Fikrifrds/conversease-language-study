...
- Lesson key: `lesson-01-framing-the-problem`
- Web slug: `framing-the-problem`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-07-complex-problem-solving/lesson-01-framing-the-problem`
...
| `card-2.png` | 1254×1254 | Can we agree on the scope? |
| `card-3.png` | 1254×1254 | What does success look like? |
...
Lesson: Framing the Problem (B2, Unit 7, Lesson 1)
Conversation goal: Frame a complex problem clearly by defining scope, success criteria, and constraints.
Situation: Kamu lagi meeting internal. Kamu bantu tim ngerumuskan problem statement yang jelas sebelum loncat ke solusi.
...
- Faris: Our customer complaints have increased this month.
- Dimas: Okay. Let's define the problem statement first.
- Faris: Sure. Where should we start?
- Dimas: Can we agree on the scope? Which product area is affected?
- Faris: Mostly the billing flow.
- Dimas: Great. What does success look like for the next four weeks?
...
Conversation moment: Dimas says “Okay. Let's define the problem statement first.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving workshop.
- Required background cues: a blank problem frame, cause-and-effect shapes, two option boards, trade-off markers, and a recommendation card.
- Context guardrail: Show analytical collaboration around one work problem, not a laboratory experiment, emergency response, repair shop, or argumentative debate.
...
## Card 2 prompt — Can we agree on the scope?
...
Card focus: “Can we agree on the scope?”
Conversation moment: Dimas says “Can we agree on the scope? Which product area is affected?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving workshop.
- Required background cues: a blank problem frame, cause-and-effect shapes, two option boards, trade-off markers, and a recommendation card.
- Context guardrail: Show analytical collaboration around one work problem, not a laboratory experiment, emergency response, repair shop, or argumentative debate.
...
## Card 3 prompt — What does success look like?
...
Card focus: “What does success look like?”
Conversation moment: Dimas says “Great. What does success look like for the next four weeks?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving workshop.
- Required background cues: a blank problem frame, cause-and-effect shapes, two option boards, trade-off markers, and a recommendation card.
- Context guardrail: Show analytical collaboration around one work problem, not a laboratory experiment, emergency response, repair shop, or argumentative debate.
