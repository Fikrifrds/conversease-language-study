...
- Level: **B2**
- Unit 7: **Complex Problem Solving**
- Lesson 3: **Discussing Tradeoffs**
- Lesson key: `lesson-03-discussing-tradeoffs`
- Web slug: `discussing-tradeoffs`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-07-complex-problem-solving/lesson-03-discussing-tradeoffs`
...
| `card-1.png` | 1254×1254 | The trade-off is speed versus long-term reliability. |
| `card-2.png` | 1254×1254 | If we optimize for speed, we might introduce more bugs. |
| `card-3.png` | 1254×1254 | On the other hand, the slower option reduces risk. |
...
Lesson: Discussing Tradeoffs (B2, Unit 7, Lesson 3)
Conversation goal: Discuss trade-offs between options, highlighting impact on cost, time, and risk.
Situation: Kamu bandingin beberapa opsi. Kamu jelasin trade-off-nya dengan jelas: cepat vs kualitas, biaya vs risiko, dll.

Scene and background:
- Actual conversation location: an open workplace problem-solving workshop.
- Required background cues: a blank problem frame, cause-and-effect shapes, two option boards, trade-off markers, and a recommendation card.
- Context guardrail: Show analytical collaboration around one work problem, not a laboratory experiment, emergency response, repair shop, or argumentative debate.
...
- Faris: We have two solutions. Which one should we pick?
- Dimas: The trade-off is speed versus long-term reliability.
- Faris: Can you explain that?
- Dimas: If we optimize for speed, we might introduce more bugs.
- Faris: And the slower option?
- Dimas: On the other hand, the slower option reduces risk but takes more effort.
...
## Card 1 prompt — The trade-off is speed versus long-term reliability.
...
## Card 2 prompt — If we optimize for speed, we might introduce more bugs.
...
Card focus: “If we optimize for speed, we might introduce more bugs.”
Conversation moment: Dimas says “If we optimize for speed, we might introduce more bugs.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving workshop.
- Required background cues: a blank problem frame, cause-and-effect shapes, two option boards, trade-off markers, and a recommendation card.
- Context guardrail: Show analytical collaboration around one work problem, not a laboratory experiment, emergency response, repair shop, or argumentative debate.
...
## Card 3 prompt — On the other hand, the slower option reduces risk.
...
Card focus: “On the other hand, the slower option reduces risk.”
Conversation moment: Faris says “And the slower option?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving workshop.
- Required background cues: a blank problem frame, cause-and-effect shapes, two option boards, trade-off markers, and a recommendation card.
- Context guardrail: Show analytical collaboration around one work problem, not a laboratory experiment, emergency response, repair shop, or argumentative debate.
