...
- Lesson 4: **Recommending a Solution**
- Lesson key: `lesson-04-recommending-a-solution`
- Web slug: `recommending-a-solution`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-07-complex-problem-solving/lesson-04-recommending-a-solution`
...
| `card-1.png` | 1254×1254 | Given these constraints, I'd recommend starting with a two-week pilot. |
| `card-2.png` | 1254×1254 | It reduces risk and gives us data before a full rollout. |
| `card-3.png` | 1254×1254 | The main risk is slower progress if we over-scope the pilot. |
...
Lesson: Recommending a Solution (B2, Unit 7, Lesson 4)
Conversation goal: Recommend a solution clearly by summarizing reasoning, risks, and next steps.
Situation: Kamu harus kasih rekomendasi. Kamu rangkum reasoning-nya, sebut risiko utama, dan next steps yang realistis.
...
- Dimas: Given these constraints, I'd recommend starting with a two-week pilot.
- Faris: Why a pilot?
- Dimas: It reduces risk and gives us data before a full rollout.
- Faris: What's the main risk?
- Dimas: The main risk is slower progress if we over-scope the pilot.
...
## Card 1 prompt — Given these constraints, I'd recommend starting with a two-week pilot.
...
Card focus: “Given these constraints, I'd recommend starting with a two-week pilot.”
Conversation moment: Dimas says “Given these constraints, I'd recommend starting with a two-week pilot.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — It reduces risk and gives us data before a full rollout.
...
Card focus: “It reduces risk and gives us data before a full rollout.”
Conversation moment: Dimas says “It reduces risk and gives us data before a full rollout.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — The main risk is slower progress if we over-scope the pilot.
...
Card focus: “The main risk is slower progress if we over-scope the pilot.”
Conversation moment: Dimas says “The main risk is slower progress if we over-scope the pilot.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
