...
- Lesson 2: **Explaining Causes**
- Lesson key: `lesson-02-explaining-causes`
- Web slug: `explaining-causes`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-07-complex-problem-solving/lesson-02-explaining-causes`
...
| `card-1.png` | 1254×1254 | One possible cause is the new checkout design. |
| `card-2.png` | 1254×1254 | Based on the data, drop-offs increased after the redesign. |
| `card-3.png` | 1254×1254 | It might be due to slower load times. |
...
Lesson: Explaining Causes (B2, Unit 7, Lesson 2)
Conversation goal: Explain possible causes using evidence language and clarify what data supports each cause.
Situation: Kamu bahas akar masalah. Kamu jelasin kemungkinan penyebab dengan bahasa yang hati-hati dan berbasis data.
...
- Faris: Why do you think billing complaints are up?
- Dimas: One possible cause is the new checkout design.
- Faris: What makes you think that?
- Dimas: Based on the data, drop-offs increased right after the redesign.
- Faris: Could it be something else?
- Dimas: It might be due to slower load times as well.
...
## Card 1 prompt — One possible cause is the new checkout design.
...
Card focus: “One possible cause is the new checkout design.”
Conversation moment: Dimas says “One possible cause is the new checkout design.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving workshop.
- Required background cues: a blank problem frame, cause-and-effect shapes, two option boards, trade-off markers, and a recommendation card.
- Context guardrail: Show analytical collaboration around one work problem, not a laboratory experiment, emergency response, repair shop, or argumentative debate.
...
## Card 3 prompt — It might be due to slower load times.
...
Card focus: “It might be due to slower load times.”
Conversation moment: Dimas says “It might be due to slower load times as well.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open workplace problem-solving workshop.
- Required background cues: a blank problem frame, cause-and-effect shapes, two option boards, trade-off markers, and a recommendation card.
- Context guardrail: Show analytical collaboration around one work problem, not a laboratory experiment, emergency response, repair shop, or argumentative debate.
