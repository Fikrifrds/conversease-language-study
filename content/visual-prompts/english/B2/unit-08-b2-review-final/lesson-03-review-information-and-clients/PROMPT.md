...
- Lesson 3: **Review Information and Clients**
- Lesson key: `lesson-03-review-information-and-clients`
- Web slug: `review-information-and-clients`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-08-b2-review-final/lesson-03-review-information-and-clients`
...
| `card-1.png` | 1254×1254 | Based on the source, it's a partial snapshot. |
| `card-2.png` | 1254×1254 | We should verify it with our support data. |
...
Scene: an open professional client-service area with colleagues visible in the background. Use a clear split-scene composition: the speakers are in separate appropriate locations connected by phone, not physically together.
...
- Ilham: We saw a report saying complaints are up. Is it reliable?
- Faris: Based on the source, it's a partial snapshot. We should verify it with our support data.
- Ilham: Clients are worried about delays.
- Faris: I understand the concern. Just to clarify, what timeline did we promise?
- Ilham: Two weeks.
- Faris: Got it. Next steps are: I'll share an update today, and we'll confirm a revised timeline by Friday.
...
## Card 1 prompt — Based on the source, it's a partial snapshot.
...
## Card 2 prompt — We should verify it with our support data.
