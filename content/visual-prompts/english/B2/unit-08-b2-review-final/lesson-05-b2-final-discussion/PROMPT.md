...
- Lesson 5: **B2 Final Discussion**
- Lesson key: `lesson-05-b2-final-discussion`
- Web slug: `b2-final-discussion`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-08-b2-review-final/lesson-05-b2-final-discussion`
...
| `card-1.png` | 1254×1254 | Let's define the scope and what success looks like. |
| `card-2.png` | 1254×1254 | Based on the data, we should address billing first. |
| `card-3.png` | 1254×1254 | I understand the concern. |
...
Lesson: B2 Final Discussion (B2, Unit 8, Lesson 5)
Conversation goal: Hold a final B2 discussion: frame the issue, compare options, address concerns, and align on a decision.
Situation: Final: kamu pimpin diskusi profesional yang utuh dan natural (problem framing, trade-off, rekomendasi, next steps).
...
- Faris: Great. Let's define the scope and what success looks like.
- Ilham: We want fewer complaints and faster completion.
- Faris: Based on the data, the billing redesign increased drop-offs, so we should address that first.
- Ilham: But leadership wants new features too.
- Faris: I understand the concern. The trade-off is speed versus reliability. Given these constraints, I'd recommend a time-boxed pilot.
...
## Card 1 prompt — Let's define the scope and what success looks like.
...
Card focus: “Let's define the scope and what success looks like.”
Conversation moment: Faris says “Great. Let's define the scope and what success looks like.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
...
## Card 2 prompt — Based on the data, we should address billing first.
...
Card focus: “Based on the data, we should address billing first.”
Conversation moment: Faris says “Great. Let's define the scope and what success looks like.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
...
## Card 3 prompt — I understand the concern.
...
Conversation moment: Faris says “I understand the concern. The trade-off is speed versus reliability. Given these constraints, I'd recommend a time-boxed pilot.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
