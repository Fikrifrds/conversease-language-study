...
- Level: **B2**
- Unit 8: **B2 Review & Final Discussion**
- Lesson 1: **Review Arguments and Meetings**
- Lesson key: `lesson-01-review-arguments-and-meetings`
- Web slug: `review-arguments-and-meetings`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-08-b2-review-final/lesson-01-review-arguments-and-meetings`
...
| `card-1.png` | 1254×1254 | My position is that we should prioritize fixing the billing flow. |
| `card-2.png` | 1254×1254 | The main reason is it affects revenue and support workload. |
| `card-3.png` | 1254×1254 | To summarize, we focus on billing first. |
...
Lesson: Review Arguments and Meetings (B2, Unit 8, Lesson 1)
Conversation goal: Summarize your position clearly, support it with reasons, and close with clear next steps.
Situation: Review: kamu rangkum posisi kamu di meeting, kasih alasan, lalu tutup dengan next steps yang jelas.

Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
...
- Faris: Can you summarize your position for the meeting?
- Dimas: Sure. My position is that we should prioritize fixing the billing flow.
- Faris: What's your main reason?
- Dimas: The main reason is it affects revenue and support workload.
- Faris: Any counterpoints?
- Dimas: Some teams prefer new features, but the risk is higher if billing stays broken.
...
## Card 1 prompt — My position is that we should prioritize fixing the billing flow.
...
Card focus: “My position is that we should prioritize fixing the billing flow.”
Conversation moment: Dimas says “Sure. My position is that we should prioritize fixing the billing flow.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
...
## Card 2 prompt — The main reason is it affects revenue and support workload.
...
Card focus: “The main reason is it affects revenue and support workload.”
Conversation moment: Dimas says “The main reason is it affects revenue and support workload.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
...
## Card 3 prompt — To summarize, we focus on billing first.
...
Card focus: “To summarize, we focus on billing first.”
Conversation moment: Dimas says “To summarize, we focus on billing first. Next steps are: I'll share a plan today, and you'll review it by Friday.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
