...
- Lesson 4: **B2 Final Test Practice**
- Lesson key: `lesson-04-b2-final-test-practice`
- Web slug: `b2-final-test-practice`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-08-b2-review-final/lesson-04-b2-final-test-practice`
...
| `card-1.png` | 1254×1254 | My position is that we should run a two-week pilot before a full rollout. |
| `card-2.png` | 1254×1254 | Based on the data, drop-offs increased after the redesign. |
| `card-3.png` | 1254×1254 | The trade-off is speed versus long-term reliability. |
...
Lesson: B2 Final Test Practice (B2, Unit 8, Lesson 4)
Conversation goal: Answer a set of B2-style prompts: position, evidence, trade-offs, recommendation, and next steps.
Situation: Latihan final: kamu jawab prompt satu per satu dengan struktur B2 yang rapi dan natural.
...
- Faris: Final practice: what's your position?
- Dimas: My position is that we should run a two-week pilot before a full rollout.
- Faris: What's your evidence?
- Dimas: Based on the data, drop-offs increased after the redesign.
- Faris: Explain the trade-off.
- Dimas: The trade-off is speed versus long-term reliability.
...
## Card 1 prompt — My position is that we should run a two-week pilot before a full rollout.
...
Card focus: “My position is that we should run a two-week pilot before a full rollout.”
Conversation moment: Dimas says “My position is that we should run a two-week pilot before a full rollout.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
...
## Card 2 prompt — Based on the data, drop-offs increased after the redesign.
...
Card focus: “Based on the data, drop-offs increased after the redesign.”
Conversation moment: Dimas says “Based on the data, drop-offs increased after the redesign.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
...
## Card 3 prompt — The trade-off is speed versus long-term reliability.
...
Card focus: “The trade-off is speed versus long-term reliability.”
Conversation moment: Dimas says “The trade-off is speed versus long-term reliability.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional assessment boardroom.
- Required background cues: an argument board, meeting agenda shapes, negotiation timeline, source cards, and a client plan arranged as one integrated case.
- Context guardrail: Keep the final task as one coherent professional case discussion, not a collage of meetings, calls, presentations, and unrelated rooms.
