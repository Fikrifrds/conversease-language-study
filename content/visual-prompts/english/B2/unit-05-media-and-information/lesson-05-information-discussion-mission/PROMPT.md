...
- Lesson 5: **Information Discussion Mission**
- Lesson key: `lesson-05-information-discussion-mission`
- Web slug: `information-discussion-mission`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-05-media-and-information/lesson-05-information-discussion-mission`
...
| `card-1.png` | 1254×1254 | The article is about ... The main point is ... |
| `card-2.png` | 1254×1254 | I'm not sure it's reliable because it doesn't cite data. |
| `card-3.png` | 1254×1254 | From my perspective, ... The reason is ... |
...
Lesson: Information Discussion Mission (B2, Unit 5, Lesson 5)
Conversation goal: Complete a discussion: summarize an article, evaluate source reliability, explain a viewpoint, and respond to new information with next steps.
Situation: Misi: kamu diskusi informasi. Kamu ringkas artikel, nilai sumber, jelasin viewpoint, lalu respon info baru dan tentuin langkah lanjut.
Scene: a public library media workspace with reference materials visible. The speakers are physically present in the same appropriate scene.
...
- Faris: Can you summarize the article you read?
- Dimas: Sure. The article is about remote work and productivity. The main point is clear rules improve focus.
- Faris: Is the source reliable?
- Dimas: I'm not sure it's reliable because it doesn't cite data. I'd check official reports.
- Faris: What's your viewpoint overall?
- Dimas: From my perspective, hybrid work is a good balance. The reason is it supports focus and connection.
...
## Card 1 prompt — The article is about ... The main point is ...
...
Card focus: “The article is about ... The main point is ...”
Conversation moment: Faris says “Can you summarize the article you read?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — I'm not sure it's reliable because it doesn't cite data.
...
Card focus: “I'm not sure it's reliable because it doesn't cite data.”
Conversation moment: Dimas says “I'm not sure it's reliable because it doesn't cite data. I'd check official reports.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — From my perspective, ... The reason is ...
...
Card focus: “From my perspective, ... The reason is ...”
Conversation moment: Faris says “Is the source reliable?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials visible. The speakers are physically present in the same appropriate scene.
