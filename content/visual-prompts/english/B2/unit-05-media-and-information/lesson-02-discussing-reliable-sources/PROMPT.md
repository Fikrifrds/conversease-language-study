...
- Lesson 2: **Discussing Reliable Sources**
- Lesson key: `lesson-02-discussing-reliable-sources`
- Web slug: `discussing-reliable-sources`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-05-media-and-information/lesson-02-discussing-reliable-sources`
...
| `card-1.png` | 1254×1254 | I'm not sure that source is reliable. |
| `card-2.png` | 1254×1254 | Because it doesn't cite data or mention the author. |
| `card-3.png` | 1254×1254 | I'd check official reports. |
...
Lesson: Discussing Reliable Sources (B2, Unit 5, Lesson 2)
Conversation goal: Discuss whether a source is reliable, explain why, and suggest a better source.
Situation: Kamu bahas berita. Kamu nilai sumbernya reliable atau tidak, jelasin alasannya, lalu saranin sumber yang lebih baik.
...
- Faris: I'm not sure that source is reliable.
- Ilham: Why not?
- Faris: Because it doesn't cite data or mention who wrote it.
- Ilham: So what would you check?
- Faris: I'd check official reports or reputable news outlets.
...
## Card 1 prompt — I'm not sure that source is reliable.
...
Card focus: “I'm not sure that source is reliable.”
Conversation moment: Faris says “I'm not sure that source is reliable.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
- Context guardrail: Show people evaluating information, not a newsroom broadcast, social-media feed, political rally, or literal scene from the article.
...
## Card 2 prompt — Because it doesn't cite data or mention the author.
...
Card focus: “Because it doesn't cite data or mention the author.”
Conversation moment: Faris says “I'm not sure that source is reliable.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
...
## Card 3 prompt — I'd check official reports.
...
Card focus: “I'd check official reports.”
Conversation moment: Faris says “I'd check official reports or reputable news outlets.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
- Context guardrail: Show people evaluating information, not a newsroom broadcast, social-media feed, political rally, or literal scene from the article.
