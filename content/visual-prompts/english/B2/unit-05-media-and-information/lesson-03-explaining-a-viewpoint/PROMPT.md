...
- Level: **B2**
- Unit 5: **Media & Information**
- Lesson 3: **Explaining a Viewpoint**
- Lesson key: `lesson-03-explaining-a-viewpoint`
- Web slug: `explaining-a-viewpoint`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-05-media-and-information/lesson-03-explaining-a-viewpoint`
...
| `card-1.png` | 1254×1254 | From my perspective, some regulation is necessary. |
| `card-2.png` | 1254×1254 | The reason is it protects users from misinformation. |
| `card-3.png` | 1254×1254 | I see the other side, but... |
...
Lesson: Explaining a Viewpoint (B2, Unit 5, Lesson 3)
Conversation goal: Explain a viewpoint clearly, support it with one reason, and acknowledge another perspective.
Situation: Kamu diskusi isu publik. Kamu jelasin viewpoint kamu, kasih alasan, dan akui perspektif lain dengan sopan.

Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
- Context guardrail: Show people evaluating information, not a newsroom broadcast, social-media feed, political rally, or literal scene from the article.
...
- Faris: I read two completely opposite opinions about this today. What's your take on regulating AI tools?
- Dimas: From my perspective, some regulation is necessary. Especially for tools that reach millions of people.
- Faris: Why do you say that? A lot of people argue the market will correct itself.
- Dimas: The reason is it protects users from misuse and misinformation. Ordinary users can't always tell what's reliable.
- Faris: But regulation could slow innovation. Smaller companies might not afford the compliance costs.
- Dimas: I see the other side, but basic safety rules can still support innovation. Clear rules actually give builders more confidence to invest.
...
## Card 1 prompt — From my perspective, some regulation is necessary.
...
Card focus: “From my perspective, some regulation is necessary.”
Conversation moment: Dimas says “From my perspective, some regulation is necessary. Especially for tools that reach millions of people.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
- Context guardrail: Show people evaluating information, not a newsroom broadcast, social-media feed, political rally, or literal scene from the article.
...
## Card 2 prompt — The reason is it protects users from misinformation.
...
Card focus: “The reason is it protects users from misinformation.”
Conversation moment: Dimas says “From my perspective, some regulation is necessary. Especially for tools that reach millions of people.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
...
## Card 3 prompt — I see the other side, but...
...
Card focus: “I see the other side, but...”
Conversation moment: Dimas says “I see the other side, but basic safety rules can still support innovation. Clear rules actually give builders more confidence to invest.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
- Context guardrail: Show people evaluating information, not a newsroom broadcast, social-media feed, political rally, or literal scene from the article.
