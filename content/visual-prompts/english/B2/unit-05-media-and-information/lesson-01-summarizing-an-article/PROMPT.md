...
- Lesson 1: **Summarizing an Article**
- Lesson key: `lesson-01-summarizing-an-article`
- Web slug: `summarizing-an-article`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-05-media-and-information/lesson-01-summarizing-an-article`
...
| `card-1.png` | 1254×1254 | The article is about how remote work affects productivity. |
| `card-2.png` | 1254×1254 | The main point is productivity improves with clear rules. |
| `card-3.png` | 1254×1254 | It mentions isolation as a downside. |
...
Lesson: Summarizing an Article (B2, Unit 5, Lesson 1)
Conversation goal: Summarize an article in 2–3 sentences: main topic, key point, and conclusion.
Situation: Kamu habis baca artikel. Kamu jelasin topiknya, poin utama, dan kesimpulan singkat ke teman kerja.
Scene: a public library media workspace with reference materials and colleagues visible. The speakers are physically present in the same appropriate scene.
...
- Faris: Did you read that article about remote work?
- Dimas: Yes. The article is about how remote work affects productivity.
- Faris: What's the main point?
- Dimas: The main point is productivity improves when teams set clear communication rules.
- Faris: Interesting. Does it mention any downsides?
- Dimas: Yes, it mentions isolation, especially for new hires.
...
## Card 1 prompt — The article is about how remote work affects productivity.
...
Card focus: “The article is about how remote work affects productivity.”
Conversation moment: Dimas says “Yes. The article is about how remote work affects productivity.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials and colleagues visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — The main point is productivity improves with clear rules.
...
Card focus: “The main point is productivity improves with clear rules.”
Conversation moment: Dimas says “Yes. The article is about how remote work affects productivity.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials and colleagues visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — It mentions isolation as a downside.
...
Card focus: “It mentions isolation as a downside.”
Conversation moment: Faris says “What's the main point?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials and colleagues visible. The speakers are physically present in the same appropriate scene.
