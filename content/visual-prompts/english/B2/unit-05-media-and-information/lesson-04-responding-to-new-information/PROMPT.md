...
- Lesson 4: **Responding to New Information**
- Lesson key: `lesson-04-responding-to-new-information`
- Web slug: `responding-to-new-information`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-05-media-and-information/lesson-04-responding-to-new-information`
...
| `card-1.png` | 1254×1254 | I wasn't aware of that. |
| `card-2.png` | 1254×1254 | That changes things. |
| `card-3.png` | 1254×1254 | I'd like to understand the methodology. |
...
Lesson: Responding to New Information (B2, Unit 5, Lesson 4)
Conversation goal: Respond to new information, update your opinion, and ask a follow-up question.
Situation: Kamu dapat info baru. Kamu respon dengan terbuka, update pendapat kamu, dan tanya pertanyaan follow-up.
...
- Ilham: I found a report that contradicts the article we read.
- Faris: Oh, I wasn't aware of that.
- Ilham: It says the data sample was very small.
- Faris: That changes things. I'd like to understand the methodology.
- Ilham: We should check the full report.
- Faris: Agreed. Can you share the link?
...
## Card 1 prompt — I wasn't aware of that.
...
Card focus: “I wasn't aware of that.”
Conversation moment: Faris says “Oh, I wasn't aware of that.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
- Context guardrail: Show people evaluating information, not a newsroom broadcast, social-media feed, political rally, or literal scene from the article.
...
## Card 2 prompt — That changes things.
...
Card focus: “That changes things.”
Conversation moment: Faris says “That changes things. I'd like to understand the methodology.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
- Context guardrail: Show people evaluating information, not a newsroom broadcast, social-media feed, political rally, or literal scene from the article.
...
## Card 3 prompt — I'd like to understand the methodology.
...
Card focus: “I'd like to understand the methodology.”
Conversation moment: Faris says “That changes things. I'd like to understand the methodology.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public library media-review workspace.
- Required background cues: several textless article sheets, source-comparison cards, reference books with blank spines, and a laptop with abstract data shapes.
