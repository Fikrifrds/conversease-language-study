...
- Lesson 4: **Summarizing Decisions**
- Lesson key: `lesson-04-summarizing-decisions`
- Web slug: `summarizing-decisions`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-02-professional-meetings/lesson-04-summarizing-decisions`
...
| `card-1.png` | 1254×1254 | To summarize, we agreed to keep scope limited to the core feature. |
| `card-2.png` | 1254×1254 | Action items are: I'll update the tickets, and you'll confirm the design handoff. |
| `card-3.png` | 1254×1254 | Ilham will review QA coverage. |
...
- Faris: We're almost out of time, and I want everyone to leave with the same understanding.
- Dimas: To summarize, we agreed to keep scope limited to the core feature. Everything else moves to the next cycle.
- Faris: Right. That matches what I noted during the discussion.
- Dimas: Action items are: I'll update the tickets, and you'll confirm the design handoff. Both by tomorrow afternoon, ideally.
- Faris: Yes. And Ilham will review QA coverage. He mentioned he needs the updated tickets first.
- Dimas: Great. We'll check progress on Thursday. If anything slips, raise it before then, not at the meeting.
...
## Card 1 prompt — To summarize, we agreed to keep scope limited to the core feature.
...
## Card 2 prompt — Action items are: I'll update the tickets, and you'll confirm the design handoff.
...
## Card 3 prompt — Ilham will review QA coverage.
