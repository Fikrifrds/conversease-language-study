...
- Lesson 3: **Giving Constructive Feedback**
- Lesson key: `lesson-03-giving-constructive-feedback`
- Web slug: `giving-constructive-feedback`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-02-professional-meetings/lesson-03-giving-constructive-feedback`
...
| `card-1.png` | 1254×1254 | Overall it was clear. |
| `card-2.png` | 1254×1254 | I noticed the introduction was a bit long. |
| `card-3.png` | 1254×1254 | Some people lost focus, so the key message came late. |
...
Lesson: Giving Constructive Feedback (B2, Unit 2, Lesson 3)
Conversation goal: Give constructive feedback politely, focus on impact, and suggest one improvement.
Situation: Kamu kasih feedback ke rekan kerja. Kamu tetap sopan, jelasin dampaknya, lalu kasih satu saran perbaikan.
...
- Ilham: How did the demo go? Any feedback?
- Faris: Overall it was clear. I noticed the introduction was a bit long.
- Ilham: Oh, okay. What was the impact?
- Faris: Some people lost focus, so the key message came late.
- Ilham: What would you suggest?
- Faris: One suggestion is to start with the main takeaway, then show details.
...
## Card 1 prompt — Overall it was clear.
...
Card focus: “Overall it was clear.”
Conversation moment: Faris says “Overall it was clear. I noticed the introduction was a bit long.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional meeting room with a glass corridor visible.
- Required background cues: a blank agenda board, scope boundary diagram made of shapes, action cards, and neatly arranged chairs.
- Context guardrail: Show the specific meeting phase in the dialogue; do not depict a presentation stage, classroom, private executive office, or social meal.
...
## Card 2 prompt — I noticed the introduction was a bit long.
...
Card focus: “I noticed the introduction was a bit long.”
Conversation moment: Faris says “Overall it was clear. I noticed the introduction was a bit long.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional meeting room with a glass corridor visible.
- Required background cues: a blank agenda board, scope boundary diagram made of shapes, action cards, and neatly arranged chairs.
...
## Card 3 prompt — Some people lost focus, so the key message came late.
...
Card focus: “Some people lost focus, so the key message came late.”
Conversation moment: Faris says “Some people lost focus, so the key message came late.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional meeting room with a glass corridor visible.
- Required background cues: a blank agenda board, scope boundary diagram made of shapes, action cards, and neatly arranged chairs.
- Context guardrail: Show the specific meeting phase in the dialogue; do not depict a presentation stage, classroom, private executive office, or social meal.
