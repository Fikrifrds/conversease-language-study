...
- Level: **B2**
- Unit 2: **Professional Meetings**
- Lesson 5: **Meeting Participation Mission**
- Lesson key: `lesson-05-meeting-participation-mission`
- Web slug: `meeting-participation-mission`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-02-professional-meetings/lesson-05-meeting-participation-mission`
...
| `card-1.png` | 1254×1254 | I'd like to bring up the timeline for the next release. |
| `card-2.png` | 1254×1254 | Just to clarify, does this include the admin dashboard changes? |
| `card-3.png` | 1254×1254 | Overall it was clear. I noticed the introduction was a bit long. |
...
Lesson: Meeting Participation Mission (B2, Unit 2, Lesson 5)
Conversation goal: Complete a mini meeting: open a point, clarify scope, give constructive feedback, and summarize decisions with action items.
Situation: Misi: kamu aktif di meeting secara profesional dari awal sampai rangkuman akhir.
...
- Faris: Any topics to discuss today?
- Dimas: I'd like to bring up the timeline for the next release.
- Faris: Okay. Any scope questions?
- Dimas: Just to clarify, does this include the admin dashboard changes?
- Faris: No, that's out of scope for now.
- Dimas: Understood. Thanks for clarifying.
...
## Card 1 prompt — I'd like to bring up the timeline for the next release.
...
Card focus: “I'd like to bring up the timeline for the next release.”
Conversation moment: Dimas says “I'd like to bring up the timeline for the next release.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — Just to clarify, does this include the admin dashboard changes?
...
Card focus: “Just to clarify, does this include the admin dashboard changes?”
Conversation moment: Dimas says “Just to clarify, does this include the admin dashboard changes?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — Overall it was clear. I noticed the introduction was a bit long.
...
Card focus: “Overall it was clear. I noticed the introduction was a bit long.”
Conversation moment: Dimas says “Overall it was clear. I noticed the introduction was a bit long, so the key message came late.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
