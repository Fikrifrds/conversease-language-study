...
- Lesson 1: **Opening a Meeting Point**
- Lesson key: `lesson-01-opening-a-meeting-point`
- Web slug: `opening-a-meeting-point`
- Dialogue speakers: **Dimas, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-02-professional-meetings/lesson-01-opening-a-meeting-point`
...
| `card-2.png` | 1254×1254 | The main point is we need to confirm the scope today. |
| `card-3.png` | 1254×1254 | Because the design handoff depends on it. |
...
Lesson: Opening a Meeting Point (B2, Unit 2, Lesson 1)
Conversation goal: Open a discussion point clearly, explain why it matters, and invite input.
Situation: Kamu lagi meeting. Kamu buka satu poin diskusi, jelasin kenapa penting, lalu minta pendapat tim.
...
- Faris: Sure. What's the main point?
- Dimas: The main point is we need to confirm the scope today.
- Faris: Why today?
- Dimas: Because the design handoff depends on it, and we don't want to block the team.
- Faris: Makes sense. What do you propose?
...
## Card 2 prompt — The main point is we need to confirm the scope today.
...
Card focus: “The main point is we need to confirm the scope today.”
Conversation moment: Dimas says “The main point is we need to confirm the scope today.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — Because the design handoff depends on it.
...
Card focus: “Because the design handoff depends on it.”
Conversation moment: Dimas says “Because the design handoff depends on it, and we don't want to block the team.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
