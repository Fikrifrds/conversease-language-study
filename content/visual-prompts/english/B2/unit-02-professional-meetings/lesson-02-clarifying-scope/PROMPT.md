...
- Lesson 2: **Clarifying Scope**
- Lesson key: `lesson-02-clarifying-scope`
- Web slug: `clarifying-scope`
- Dialogue speakers: **Dimas, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-02-professional-meetings/lesson-02-clarifying-scope`
...
| `card-1.png` | 1254×1254 | Just to clarify, what exactly is in scope? |
| `card-2.png` | 1254×1254 | Does this include the admin dashboard changes? |
| `card-3.png` | 1254×1254 | That's out of scope for now. |
...
Lesson: Clarifying Scope (B2, Unit 2, Lesson 2)
Conversation goal: Clarify scope, ask what is included, and confirm what is out of scope.
Situation: Kamu ingin scope jelas. Kamu tanya apa yang termasuk, apa yang tidak, dan konfirmasi biar nggak salah paham.
...
- Dimas: Just to clarify, what exactly is in scope for this sprint?
- Faris: The core feature and the basic UI updates.
- Dimas: Does this include the admin dashboard changes?
- Faris: Not this sprint. That's out of scope for now.
- Dimas: Got it. So we focus on the core feature only?
- Faris: Yes, plus the UI updates for the main flow.
...
## Card 1 prompt — Just to clarify, what exactly is in scope?
...
Card focus: “Just to clarify, what exactly is in scope?”
Conversation moment: Dimas says “Just to clarify, what exactly is in scope for this sprint?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — Does this include the admin dashboard changes?
...
Card focus: “Does this include the admin dashboard changes?”
Conversation moment: Dimas says “Does this include the admin dashboard changes?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — That's out of scope for now.
...
Card focus: “That's out of scope for now.”
Conversation moment: Faris says “Not this sprint. That's out of scope for now.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
