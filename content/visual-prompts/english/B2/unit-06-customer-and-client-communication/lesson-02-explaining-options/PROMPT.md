...
- Lesson 2: **Explaining Options**
- Lesson key: `lesson-02-explaining-options`
- Web slug: `explaining-options`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-06-customer-and-client-communication/lesson-02-explaining-options`
...
| `card-2.png` | 1254×1254 | Option A is a quick fix we can deliver this week. |
| `card-3.png` | 1254×1254 | Option B is more robust, but it takes two more weeks. |
...
Lesson: Explaining Options (B2, Unit 6, Lesson 2)
Conversation goal: Explain two options clearly, compare trade-offs, and recommend one option.
Situation: Kamu jelasin dua opsi solusi ke klien. Kamu bandingin trade-off-nya dan kasih rekomendasi.
...
- Faris: We have two options. Option A is a quick fix we can deliver this week.
- Ilham: And option B?
- Faris: Option B is a more robust solution, but it takes two more weeks.
- Ilham: What's the trade-off?
- Faris: The trade-off is speed versus long-term stability.
...
Conversation moment: Faris says “We have two options. Option A is a quick fix we can deliver this week.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
- Context guardrail: Show a service consultation, not a retail checkout, complaint counter, contract-signing ceremony, or private executive office.
...
## Card 2 prompt — Option A is a quick fix we can deliver this week.
...
Card focus: “Option A is a quick fix we can deliver this week.”
Conversation moment: Faris says “We have two options. Option A is a quick fix we can deliver this week.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
...
## Card 3 prompt — Option B is more robust, but it takes two more weeks.
...
Card focus: “Option B is more robust, but it takes two more weeks.”
Conversation moment: Ilham says “And option B?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
- Context guardrail: Show a service consultation, not a retail checkout, complaint counter, contract-signing ceremony, or private executive office.
