...
- Lesson 1: **Understanding Client Needs**
- Lesson key: `lesson-01-understanding-client-needs`
- Web slug: `understanding-client-needs`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-06-customer-and-client-communication/lesson-01-understanding-client-needs`
...
| `card-2.png` | 1254×1254 | Could you share more about the biggest pain point? |
| `card-3.png` | 1254×1254 | So what you need is a clear starting point, right? |
...
Lesson: Understanding Client Needs (B2, Unit 6, Lesson 1)
Conversation goal: Ask clarifying questions to understand client needs, confirm requirements, and summarize what you heard.
Situation: Kamu ngobrol sama klien. Kamu gali kebutuhan, tanya detail, lalu rangkum supaya nggak salah paham.

Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
- Context guardrail: Show a service consultation, not a retail checkout, complaint counter, contract-signing ceremony, or private executive office.
...
- Ilham: We want to improve our onboarding experience.
- Faris: Got it. Just to clarify, who is the main user group?
- Ilham: Mostly new hires in engineering.
- Faris: Thanks. Could you share more about the biggest pain point today?
- Ilham: They don't know where to find key docs.
- Faris: Understood. So what you need is a clear starting point and a simple checklist, right?
...
Conversation moment: Faris says “Got it. Just to clarify, who is the main user group?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
- Context guardrail: Show a service consultation, not a retail checkout, complaint counter, contract-signing ceremony, or private executive office.
...
## Card 2 prompt — Could you share more about the biggest pain point?
...
Card focus: “Could you share more about the biggest pain point?”
Conversation moment: Faris says “Thanks. Could you share more about the biggest pain point today?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
- Context guardrail: Show a service consultation, not a retail checkout, complaint counter, contract-signing ceremony, or private executive office.
...
## Card 3 prompt — So what you need is a clear starting point, right?
...
Card focus: “So what you need is a clear starting point, right?”
Conversation moment: Ilham says “Mostly new hires in engineering.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
- Context guardrail: Show a service consultation, not a retail checkout, complaint counter, contract-signing ceremony, or private executive office.
