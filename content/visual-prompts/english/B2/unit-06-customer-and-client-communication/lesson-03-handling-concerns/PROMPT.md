...
- Lesson 3: **Handling Concerns**
- Lesson key: `lesson-03-handling-concerns`
- Web slug: `handling-concerns`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-06-customer-and-client-communication/lesson-03-handling-concerns`
...
| `card-1.png` | 1254×1254 | I understand the concern. |
| `card-2.png` | 1254×1254 | Could you clarify what disruption you expect? |
| `card-3.png` | 1254×1254 | To reduce the risk, we can send a weekly summary. |
...
Lesson: Handling Concerns (B2, Unit 6, Lesson 3)
Conversation goal: Acknowledge a client concern, ask a clarifying question, and propose a mitigation plan.
Situation: Klien punya kekhawatiran. Kamu respon dengan empati, tanya detail, lalu kasih mitigasi.
...
- Ilham: I'm concerned this change will disrupt our team.
- Faris: I understand the concern. Could you clarify what disruption you expect?
- Ilham: People might miss updates.
- Faris: That makes sense. To reduce the risk, we can send a weekly summary and keep a monthly live meeting.
- Ilham: Okay, that helps.
- Faris: We can also run a two-week trial and gather feedback.
...
## Card 1 prompt — I understand the concern.
...
Conversation moment: Faris says “I understand the concern. Could you clarify what disruption you expect?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
- Context guardrail: Show a service consultation, not a retail checkout, complaint counter, contract-signing ceremony, or private executive office.
...
## Card 2 prompt — Could you clarify what disruption you expect?
...
Card focus: “Could you clarify what disruption you expect?”
Conversation moment: Faris says “I understand the concern. Could you clarify what disruption you expect?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
...
## Card 3 prompt — To reduce the risk, we can send a weekly summary.
...
Card focus: “To reduce the risk, we can send a weekly summary.”
Conversation moment: Faris says “That makes sense. To reduce the risk, we can send a weekly summary and keep a monthly live meeting.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional client-service meeting alcove.
- Required background cues: a needs map made of shapes, two option cards, risk markers, a pilot timeline, and a blank next-step plan.
- Context guardrail: Show a service consultation, not a retail checkout, complaint counter, contract-signing ceremony, or private executive office.
