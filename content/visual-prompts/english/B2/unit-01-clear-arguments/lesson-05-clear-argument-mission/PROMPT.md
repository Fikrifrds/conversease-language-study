...
- Level: **B2**
- Unit 1: **Clear Arguments**
- Lesson 5: **Clear Argument Mission**
- Lesson key: `lesson-05-clear-argument-mission`
- Web slug: `clear-argument-mission`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-01-clear-arguments/lesson-05-clear-argument-mission`
...
| `card-1.png` | 1254×1254 | In my view, we should move routine updates to a written summary. |
| `card-2.png` | 1254×1254 | One reason is it saves time. |
| `card-3.png` | 1254×1254 | For example, last month we spent 30 minutes repeating updates. |
...
Lesson: Clear Argument Mission (B2, Unit 1, Lesson 5)
Conversation goal: Complete a mini argument: state your position, give reasons and an example, respond to a counterpoint, and agree on next steps.
Situation: Misi: kamu usul perubahan proses kerja. Kamu jelasin posisi, dua alasan, satu contoh, respon counterpoint, lalu sepakat next step.

Scene and background:
- Actual conversation location: an open team decision room.
- Required background cues: a central discussion table, two evidence cards, a blank process diagram, and one next-step marker.
- Context guardrail: Show a structured professional argument about a work process, not a courtroom, political rally, public debate stage, or personal confrontation.
...
- Faris: Should we change our weekly meeting format?
- Dimas: In my view, we should move routine updates to a written summary.
- Faris: Why?
- Dimas: One reason is it saves time. Another reason is it improves focus.
- Faris: Can you give an example?
- Dimas: For example, last month we spent 30 minutes repeating status updates.
...
## Card 1 prompt — In my view, we should move routine updates to a written summary.
...
Card focus: “In my view, we should move routine updates to a written summary.”
Conversation moment: Dimas says “In my view, we should move routine updates to a written summary.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open team decision room.
- Required background cues: a central discussion table, two evidence cards, a blank process diagram, and one next-step marker.
- Context guardrail: Show a structured professional argument about a work process, not a courtroom, political rally, public debate stage, or personal confrontation.
...
## Card 2 prompt — One reason is it saves time.
...
Card focus: “One reason is it saves time.”
Conversation moment: Dimas says “One reason is it saves time. Another reason is it improves focus.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open team decision room.
- Required background cues: a central discussion table, two evidence cards, a blank process diagram, and one next-step marker.
- Context guardrail: Show a structured professional argument about a work process, not a courtroom, political rally, public debate stage, or personal confrontation.
...
## Card 3 prompt — For example, last month we spent 30 minutes repeating updates.
...
Card focus: “For example, last month we spent 30 minutes repeating updates.”
Conversation moment: Faris says “Why?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open team decision room.
- Required background cues: a central discussion table, two evidence cards, a blank process diagram, and one next-step marker.
- Context guardrail: Show a structured professional argument about a work process, not a courtroom, political rally, public debate stage, or personal confrontation.
