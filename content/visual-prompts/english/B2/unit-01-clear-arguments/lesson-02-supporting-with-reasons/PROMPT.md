...
- Lesson 2: **Supporting With Reasons**
- Lesson key: `lesson-02-supporting-with-reasons`
- Web slug: `supporting-with-reasons`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-01-clear-arguments/lesson-02-supporting-with-reasons`
...
| `card-1.png` | 1254×1254 | One reason is it reduces bugs in production. |
| `card-2.png` | 1254×1254 | Another reason is it speeds up releases. |
| `card-3.png` | 1254×1254 | That's true, but... |
...
Lesson: Supporting With Reasons (B2, Unit 1, Lesson 2)
Conversation goal: Support your argument with two structured reasons and keep it concise.
Situation: Kamu lagi meyakinkan tim. Kamu kasih dua alasan yang terstruktur dan tetap ringkas.
...
- Faris: Do we really need to invest time in automated tests?
- Dimas: I think we should. One reason is it reduces bugs in production.
- Faris: Okay. What's another reason?
- Dimas: Another reason is it speeds up releases because we can deploy with more confidence.
- Faris: But writing tests takes time.
- Dimas: That's true, but it saves time later when we avoid firefighting.
...
## Card 1 prompt — One reason is it reduces bugs in production.
...
Card focus: “One reason is it reduces bugs in production.”
Conversation moment: Dimas says “I think we should. One reason is it reduces bugs in production.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — Another reason is it speeds up releases.
...
Card focus: “Another reason is it speeds up releases.”
Conversation moment: Dimas says “Another reason is it speeds up releases because we can deploy with more confidence.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
Card focus: “That's true, but...”
Conversation moment: Dimas says “That's true, but it saves time later when we avoid firefighting.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
