...
- Lesson 1: **Stating Your Position**
- Lesson key: `lesson-01-stating-your-position`
- Web slug: `stating-your-position`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-01-clear-arguments/lesson-01-stating-your-position`
...
| `card-1.png` | 1254×1254 | In my view, a written update would be better. |
| `card-2.png` | 1254×1254 | Because it saves time. |
| `card-3.png` | 1254×1254 | I see your point, but... |
...
Lesson: Stating Your Position (B2, Unit 1, Lesson 1)
Conversation goal: State your position clearly, acknowledge another view, and give one short reason.
Situation: Kamu lagi diskusi di meeting. Kamu jelasin posisi kamu, akui pendapat orang lain, lalu kasih satu alasan utama.
...
- Faris: Should we switch our weekly meeting to a written update?
- Dimas: In my view, a written update would be better for routine topics.
- Faris: Why do you think that?
- Dimas: Because it saves time and lets people focus on deep work.
- Faris: But some people like real-time discussion.
- Dimas: I see your point, but we can keep one live meeting per month for open discussions.
...
## Card 1 prompt — In my view, a written update would be better.
...
Card focus: “In my view, a written update would be better.”
Conversation moment: Dimas says “In my view, a written update would be better for routine topics.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — Because it saves time.
...
Card focus: “Because it saves time.”
Conversation moment: Dimas says “Because it saves time and lets people focus on deep work.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — I see your point, but...
...
Card focus: “I see your point, but...”
Conversation moment: Dimas says “I see your point, but we can keep one live meeting per month for open discussions.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
