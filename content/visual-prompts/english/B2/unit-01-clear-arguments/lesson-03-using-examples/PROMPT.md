...
- Lesson 3: **Using Examples**
- Lesson key: `lesson-03-using-examples`
- Web slug: `using-examples`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-01-clear-arguments/lesson-03-using-examples`
...
| `card-1.png` | 1254×1254 | For example, last quarter we had three new joiners who felt lost. |
| `card-2.png` | 1254×1254 | They didn't know which tools to use. |
| `card-3.png` | 1254×1254 | So they kept asking in multiple channels. |
...
Lesson: Using Examples (B2, Unit 1, Lesson 3)
Conversation goal: Support your point with a clear example and connect it back to your argument.
Situation: Kamu lagi diskusi ide. Kamu kasih contoh yang jelas supaya argumen kamu lebih kuat.
...
- Ilham: Why do you think onboarding should be more structured?
- Faris: Because new hires need clarity. For example, last quarter we had three new joiners who felt lost in week one.
- Ilham: What happened exactly?
- Faris: They didn't know which tools to use, so they kept asking in multiple channels.
- Ilham: Okay, that's a good point.
- Faris: For instance, a simple checklist would reduce repeated questions.
...
## Card 1 prompt — For example, last quarter we had three new joiners who felt lost.
...
Card focus: “For example, last quarter we had three new joiners who felt lost.”
Conversation moment: Faris says “Because new hires need clarity. For example, last quarter we had three new joiners who felt lost in week one.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open team decision room.
- Required background cues: a central discussion table, two evidence cards, a blank process diagram, and one next-step marker.
- Context guardrail: Show a structured professional argument about a work process, not a courtroom, political rally, public debate stage, or personal confrontation.
...
## Card 2 prompt — They didn't know which tools to use.
...
Card focus: “They didn't know which tools to use.”
Conversation moment: Faris says “They didn't know which tools to use, so they kept asking in multiple channels.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open team decision room.
- Required background cues: a central discussion table, two evidence cards, a blank process diagram, and one next-step marker.
- Context guardrail: Show a structured professional argument about a work process, not a courtroom, political rally, public debate stage, or personal confrontation.
...
## Card 3 prompt — So they kept asking in multiple channels.
...
Card focus: “So they kept asking in multiple channels.”
Conversation moment: Faris says “They didn't know which tools to use, so they kept asking in multiple channels.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open team decision room.
- Required background cues: a central discussion table, two evidence cards, a blank process diagram, and one next-step marker.
