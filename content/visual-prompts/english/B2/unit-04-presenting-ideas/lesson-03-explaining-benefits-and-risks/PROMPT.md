...
- Lesson 3: **Explaining Benefits and Risks**
- Lesson key: `lesson-03-explaining-benefits-and-risks`
- Web slug: `explaining-benefits-and-risks`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-04-presenting-ideas/lesson-03-explaining-benefits-and-risks`
...
| `card-1.png` | 1254×1254 | The main benefit is faster onboarding for new hires. |
| `card-2.png` | 1254×1254 | Another benefit is fewer repeated questions. |
| `card-3.png` | 1254×1254 | A key risk is that the checklist becomes outdated. |
...
Lesson: Explaining Benefits and Risks (B2, Unit 4, Lesson 3)
Conversation goal: Explain two benefits, mention one risk, and propose a mitigation plan.
Situation: Kamu jelasin ide dan trade-off-nya. Kamu sebut manfaat, risikonya, lalu mitigasinya.
...
- Dimas: The main benefit is faster onboarding for new hires.
- Faris: Anything else?
- Dimas: Another benefit is fewer repeated questions for the team.
- Faris: Okay. Any risks?
- Dimas: A key risk is that the checklist becomes outdated.
...
## Card 1 prompt — The main benefit is faster onboarding for new hires.
...
Card focus: “The main benefit is faster onboarding for new hires.”
Conversation moment: Dimas says “The main benefit is faster onboarding for new hires.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — Another benefit is fewer repeated questions.
...
Card focus: “Another benefit is fewer repeated questions.”
Conversation moment: Dimas says “Another benefit is fewer repeated questions for the team.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — A key risk is that the checklist becomes outdated.
...
Card focus: “A key risk is that the checklist becomes outdated.”
Conversation moment: Dimas says “A key risk is that the checklist becomes outdated.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: an open modern workplace collaboration area with relevant documents or objects visible. The speakers are physically present in the same appropriate scene.
