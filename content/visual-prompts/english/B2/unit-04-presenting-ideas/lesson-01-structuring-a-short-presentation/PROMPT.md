...
- Lesson 1: **Structuring a Short Presentation**
- Lesson key: `lesson-01-structuring-a-short-presentation`
- Web slug: `structuring-a-short-presentation`
- Dialogue speakers: **Dimas, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-04-presenting-ideas/lesson-01-structuring-a-short-presentation`
...
| `card-1.png` | 1254×1254 | Today I'd like to share an idea to improve our onboarding. |
| `card-2.png` | 1254×1254 | The problem is new hires often feel lost. |
| `card-3.png` | 1254×1254 | My proposal is a simple checklist and a buddy system. |
...
Lesson: Structuring a Short Presentation (B2, Unit 4, Lesson 1)
Conversation goal: Present an idea with a clear structure: context, proposal, and next steps.
Situation: Kamu presentasi ide di meeting singkat. Kamu kasih konteks, jelasin proposal, dan tutup dengan next steps.
...
- Dimas: Today I'd like to share an idea to improve our onboarding.
- Faris: Great. What's the context?
- Dimas: The problem is new hires often feel lost in the first week.
- Faris: Okay. What's your proposal?
- Dimas: My proposal is a simple onboarding checklist and a buddy for the first two weeks.
- Faris: Sounds practical. What are the next steps?
...
## Card 1 prompt — Today I'd like to share an idea to improve our onboarding.
...
Card focus: “Today I'd like to share an idea to improve our onboarding.”
Conversation moment: Dimas says “Today I'd like to share an idea to improve our onboarding.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
...
## Card 2 prompt — The problem is new hires often feel lost.
...
Card focus: “The problem is new hires often feel lost.”
Conversation moment: Dimas says “The problem is new hires often feel lost in the first week.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
...
## Card 3 prompt — My proposal is a simple checklist and a buddy system.
...
Card focus: “My proposal is a simple checklist and a buddy system.”
Conversation moment: Dimas says “The problem is new hires often feel lost in the first week.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
