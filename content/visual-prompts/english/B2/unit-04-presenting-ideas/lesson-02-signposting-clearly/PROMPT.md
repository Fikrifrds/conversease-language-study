...
- Lesson 2: **Signposting Clearly**
- Lesson key: `lesson-02-signposting-clearly`
- Web slug: `signposting-clearly`
- Dialogue speakers: **Faris, Ilham**
- Prompt folder: `content/visual-prompts/english/B2/unit-04-presenting-ideas/lesson-02-signposting-clearly`
...
| `card-1.png` | 1254×1254 | Let me quickly walk you through the plan. |
| `card-2.png` | 1254×1254 | First, I'll explain the problem. |
| `card-3.png` | 1254×1254 | Next, I'll share the proposal. |
...
Lesson: Signposting Clearly (B2, Unit 4, Lesson 2)
Conversation goal: Use clear signposting to guide listeners through your presentation.
Situation: Kamu presentasi ide. Kamu pakai signposting supaya alurnya mudah diikutin.
...
- Faris: Let me quickly walk you through the plan.
- Ilham: Sure.
- Faris: First, I'll explain the problem. Next, I'll share the proposal. Finally, I'll outline next steps.
- Ilham: Great. Go ahead.
- Faris: First, the problem is that onboarding is inconsistent across teams.
- Ilham: Okay.
...
## Card 1 prompt — Let me quickly walk you through the plan.
...
Card focus: “Let me quickly walk you through the plan.”
Conversation moment: Faris says “Let me quickly walk you through the plan.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
...
## Card 2 prompt — First, I'll explain the problem.
...
Card focus: “First, I'll explain the problem.”
Conversation moment: Faris says “First, I'll explain the problem. Next, I'll share the proposal. Finally, I'll outline next steps.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
...
## Card 3 prompt — Next, I'll share the proposal.
...
Card focus: “Next, I'll share the proposal.”
Conversation moment: Faris says “First, I'll explain the problem. Next, I'll share the proposal. Finally, I'll outline next steps.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
