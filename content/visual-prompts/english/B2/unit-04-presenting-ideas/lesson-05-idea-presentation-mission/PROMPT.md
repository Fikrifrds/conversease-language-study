...
- Lesson 5: **Idea Presentation Mission**
- Lesson key: `lesson-05-idea-presentation-mission`
- Web slug: `idea-presentation-mission`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/B2/unit-04-presenting-ideas/lesson-05-idea-presentation-mission`
...
| `card-1.png` | 1254×1254 | Today I'd like to propose a shared onboarding checklist. |
| `card-2.png` | 1254×1254 | First... Next... Finally... |
| `card-3.png` | 1254×1254 | The main benefit is ... Another benefit is ... |
...
Lesson: Idea Presentation Mission (B2, Unit 4, Lesson 5)
Conversation goal: Complete a mini presentation: structure the idea, signpost clearly, explain benefits and risks, and answer questions professionally.
Situation: Misi: kamu presentasi ide singkat lalu Q&A. Kamu pakai struktur, signposting, trade-offs, dan jawaban profesional.

Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
...
- Faris: You have two minutes. Present your idea.
- Dimas: Today I'd like to propose a shared onboarding checklist. First, the problem is onboarding is inconsistent. Next, the proposal is a checklist plus a buddy. Finally, we'll pilot it next week.
- Faris: What are the benefits?
- Dimas: The main benefit is faster onboarding. Another benefit is fewer repeated questions.
- Faris: Any risks?
- Dimas: A key risk is it becomes outdated. To reduce the risk, we'll review it monthly and assign an owner.
...
## Card 1 prompt — Today I'd like to propose a shared onboarding checklist.
...
Card focus: “Today I'd like to propose a shared onboarding checklist.”
Conversation moment: Dimas says “Today I'd like to propose a shared onboarding checklist. First, the problem is onboarding is inconsistent. Next, the proposal is a checklist plus a buddy. Finally, we'll pilot it next week.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
...
## Card 2 prompt — First... Next... Finally...
...
## Card 3 prompt — The main benefit is ... Another benefit is ...
...
Card focus: “The main benefit is ... Another benefit is ...”
Conversation moment: Faris says “What are the benefits?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
