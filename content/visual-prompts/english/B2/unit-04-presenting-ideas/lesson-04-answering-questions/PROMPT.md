...
- Lesson 4: **Answering Questions**
- Lesson key: `lesson-04-answering-questions`
- Web slug: `answering-questions`
- Dialogue speakers: **Ilham, Faris**
- Prompt folder: `content/visual-prompts/english/B2/unit-04-presenting-ideas/lesson-04-answering-questions`
...
| `card-1.png` | 1254×1254 | That's a good question. |
| `card-2.png` | 1254×1254 | As far as I know, it takes about one day. |
| `card-3.png` | 1254×1254 | I'm not sure yet, but I can follow up by tomorrow. |
...
Lesson: Answering Questions (B2, Unit 4, Lesson 4)
Conversation goal: Answer a question clearly, admit uncertainty when needed, and offer to follow up.
Situation: Setelah presentasi, kamu jawab pertanyaan dengan jelas. Kalau belum yakin, kamu bilang jujur dan janji follow up.
...
## Card 1 prompt — That's a good question.
...
Card focus: “That's a good question.”
Conversation moment: Faris says “That's a good question. As far as I know, the first version takes about one day.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
...
## Card 2 prompt — As far as I know, it takes about one day.
...
Card focus: “As far as I know, it takes about one day.”
Conversation moment: Faris says “That's a good question. As far as I know, the first version takes about one day.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
...
## Card 3 prompt — I'm not sure yet, but I can follow up by tomorrow.
...
Card focus: “I'm not sure yet, but I can follow up by tomorrow.”
Conversation moment: Ilham says “What about maintenance?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open professional presentation room.
- Required background cues: a blank screen with abstract chart shapes, a standing presentation table, question cards, and rows of chairs.
- Context guardrail: Show the relevant presentation or Q&A moment; do not add readable slides, an auditorium crowd, award ceremony, or entertainment stage.
