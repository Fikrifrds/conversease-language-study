...
- Lesson 1: **Asking Where a Place Is**
- Lesson key: `lesson-01-asking-where-a-place-is`
- Web slug: `asking-where-a-place-is`
- Dialogue speakers: **Dimas, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-05-places-directions/lesson-01-asking-where-a-place-is`
...
| `card-1.png` | 1254×1254 | Excuse me. |
| `card-2.png` | 1254×1254 | Where is the classroom? |
| `card-3.png` | 1254×1254 | It is on the first floor. |
...
Lesson: Asking Where a Place Is (A1, Unit 5, Lesson 1)
Conversation goal: Learners can ask where a place is and understand a short location answer.
Situation: 

Scene and background:
- Actual conversation location: an outdoor public campus information point before the destination.
- Required background cues: a line-only map, two branching paths, and a destination marker shown only as a plain geometric block.
- Context guardrail: The location is being asked about; do not place the speakers inside it or draw a labeled sign, landmark, statue, or religious building.
...
Conversation moment: Dimas says “Excuse me. Where is the classroom?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor public campus information point before the destination.
- Required background cues: a line-only map, two branching paths, and a destination marker shown only as a plain geometric block.
- Context guardrail: The location is being asked about; do not place the speakers inside it or draw a labeled sign, landmark, statue, or religious building.
...
## Card 2 prompt — Where is the classroom?
...
Card focus: “Where is the classroom?”
Conversation moment: Dimas says “Excuse me. Where is the classroom?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor public campus information point before the destination.
- Required background cues: a line-only map, two branching paths, and a destination marker shown only as a plain geometric block.
...
## Card 3 prompt — It is on the first floor.
...
Card focus: “It is on the first floor.”
Conversation moment: Ben says “It is on the first floor.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor public campus information point before the destination.
- Required background cues: a line-only map, two branching paths, and a destination marker shown only as a plain geometric block.
- Context guardrail: The location is being asked about; do not place the speakers inside it or draw a labeled sign, landmark, statue, or religious building.
