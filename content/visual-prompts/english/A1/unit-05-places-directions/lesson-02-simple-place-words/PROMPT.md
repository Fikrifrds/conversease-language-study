...
- Lesson 2: **Simple Place Words**
- Lesson key: `lesson-02-simple-place-words`
- Web slug: `simple-place-words`
- Dialogue speakers: **Faris, Dimas**
- Prompt folder: `content/visual-prompts/english/A1/unit-05-places-directions/lesson-02-simple-place-words`
...
| `card-1.png` | 1254×1254 | Where are you going? |
| `card-2.png` | 1254×1254 | I'm going to the cafe. |
| `card-3.png` | 1254×1254 | near here |
...
Lesson: Simple Place Words (A1, Unit 5, Lesson 2)
Conversation goal: Learners can name common places and answer where someone is going.
Situation: 

Scene and background:
- Actual conversation location: an open neighborhood orientation plaza.
- Required background cues: several neutral building blocks, a road, a park shape, and position markers without labels.
- Context guardrail: Use generic civic shapes only; no real landmarks, flags, worship buildings, signs, or people beyond the permitted cast.
...
## Card 1 prompt — Where are you going?
...
Card focus: “Where are you going?”
Conversation moment: Faris says “Where are you going?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open neighborhood orientation plaza.
- Required background cues: several neutral building blocks, a road, a park shape, and position markers without labels.
- Context guardrail: Use generic civic shapes only; no real landmarks, flags, worship buildings, signs, or people beyond the permitted cast.
...
## Card 2 prompt — I'm going to the cafe.
...
Card focus: “I'm going to the cafe.”
Conversation moment: Dimas says “I'm going to the cafe.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open neighborhood orientation plaza.
- Required background cues: several neutral building blocks, a road, a park shape, and position markers without labels.
- Context guardrail: Use generic civic shapes only; no real landmarks, flags, worship buildings, signs, or people beyond the permitted cast.
...
Card focus: “near here”
Conversation moment: Faris says “Is the cafe near here?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open neighborhood orientation plaza.
- Required background cues: several neutral building blocks, a road, a park shape, and position markers without labels.
- Context guardrail: Use generic civic shapes only; no real landmarks, flags, worship buildings, signs, or people beyond the permitted cast.
