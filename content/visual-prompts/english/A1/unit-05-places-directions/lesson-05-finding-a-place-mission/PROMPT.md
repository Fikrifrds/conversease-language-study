...
- Lesson 5: **Finding a Place Mission**
- Lesson key: `lesson-05-finding-a-place-mission`
- Web slug: `finding-a-place-mission`
- Dialogue speakers: **Ben, Omar**
- Prompt folder: `content/visual-prompts/english/A1/unit-05-places-directions/lesson-05-finding-a-place-mission`
...
| `card-1.png` | 1254×1254 | How do I get to room A? |
| `card-2.png` | 1254×1254 | Go straight and turn left. |
| `card-3.png` | 1254×1254 | next to the office |
...
- The named cast must match the dialogue speakers: Ben, Omar. Do not change their genders, duplicate them, or replace them with generic people.
...
Lesson: Finding a Place Mission (A1, Unit 5, Lesson 5)
Conversation goal: Learners can complete a short place-finding conversation from question to confirmation.
Situation: 

Scene and background:
- Actual conversation location: an outdoor campus orientation point connecting several paths.
- Required background cues: one coherent line-only map with start, turns, and destination dots plus visible matching paths.
- Context guardrail: Keep the complete mission at the route-planning point; do not create multiple panels or show arrival inside the destination.
...
- Omar: adult man wearing a navy long-sleeved modest shirt, loose beige trousers ending above the ankle bones, visible socks, and closed shoes.
...
- Ben: Excuse me. How do I get to room A?
- Omar: Go straight and turn left.
- Ben: Go straight and turn left.
- Omar: Yes. Room A is next to the office.
- Ben: Is it on the first floor?
- Omar: Yes, it is.
...
## Card 1 prompt — How do I get to room A?
...
Card focus: “How do I get to room A?”
Conversation moment: Ben says “Excuse me. How do I get to room A?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor campus orientation point connecting several paths.
- Required background cues: one coherent line-only map with start, turns, and destination dots plus visible matching paths.
- Context guardrail: Keep the complete mission at the route-planning point; do not create multiple panels or show arrival inside the destination.
...
## Card 2 prompt — Go straight and turn left.
...
Card focus: “Go straight and turn left.”
Conversation moment: Omar says “Go straight and turn left.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor campus orientation point connecting several paths.
- Required background cues: one coherent line-only map with start, turns, and destination dots plus visible matching paths.
- Context guardrail: Keep the complete mission at the route-planning point; do not create multiple panels or show arrival inside the destination.
...
Composition: medium or close conversational shot, clear focus on Omar, all needed conversation partners still contextually visible, and no cropped hands.
```

## Card 3 prompt — next to the office
...
Card focus: “next to the office”
Conversation moment: Omar says “Yes. Room A is next to the office.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor campus orientation point connecting several paths.
- Required background cues: one coherent line-only map with start, turns, and destination dots plus visible matching paths.
- Context guardrail: Keep the complete mission at the route-planning point; do not create multiple panels or show arrival inside the destination.
