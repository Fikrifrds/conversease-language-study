...
- Lesson 3: **Understanding Simple Directions**
- Lesson key: `lesson-03-understanding-simple-directions`
- Web slug: `understanding-simple-directions`
- Dialogue speakers: **Omar, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-05-places-directions/lesson-03-understanding-simple-directions`
...
| `card-1.png` | 1254×1254 | Go straight. |
| `card-2.png` | 1254×1254 | Turn left. |
| `card-3.png` | 1254×1254 | on the right |
...
- The named cast must match the dialogue speakers: Omar, Ben. Do not change their genders, duplicate them, or replace them with generic people.
...
Lesson: Understanding Simple Directions (A1, Unit 5, Lesson 3)
Conversation goal: Learners can understand very simple directions with go straight, turn left, and turn right.
Situation: 

Scene and background:
- Actual conversation location: an outdoor pedestrian path junction.
- Required background cues: a visible left turn, right turn, straight path, and simple arrow markers without words.
- Context guardrail: Show the route decision before arrival; do not show the destination interior or use road-sign text.
...
Conversation moment: Ben says “Go straight.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor pedestrian path junction.
- Required background cues: a visible left turn, right turn, straight path, and simple arrow markers without words.
- Context guardrail: Show the route decision before arrival; do not show the destination interior or use road-sign text.
...
Card focus: “Turn left.”
Conversation moment: Ben says “Then turn left.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor pedestrian path junction.
- Required background cues: a visible left turn, right turn, straight path, and simple arrow markers without words.
- Context guardrail: Show the route decision before arrival; do not show the destination interior or use road-sign text.
...
Card focus: “on the right”
Conversation moment: Ben says “Yes. The room is on the right.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an outdoor pedestrian path junction.
- Required background cues: a visible left turn, right turn, straight path, and simple arrow markers without words.
- Context guardrail: Show the route decision before arrival; do not show the destination interior or use road-sign text.
