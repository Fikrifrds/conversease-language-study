...
- Lesson 4: **Asking How to Get There**
- Lesson key: `lesson-04-asking-how-to-get-there`
- Web slug: `asking-how-to-get-there`
- Dialogue speakers: **Dimas, Faris**
- Prompt folder: `content/visual-prompts/english/A1/unit-05-places-directions/lesson-04-asking-how-to-get-there`
...
| `card-1.png` | 1254×1254 | How do I get to the station? |
| `card-2.png` | 1254×1254 | for two minutes |
| `card-3.png` | 1254×1254 | at the bank |
...
- Actual conversation location: an open transit-stop map point before a walking route.
- Required background cues: a line-only route diagram, a start dot, one turn arrow, and a distant generic destination block.
- Context guardrail: The speakers are planning the route; do not show them already traveling, driving, or standing inside the destination.
...
- Dimas: How do I get to the station?
- Faris: Go straight for two minutes.
- Dimas: Okay. Go straight for two minutes.
- Faris: Then turn right at the bank.
...
## Card 1 prompt — How do I get to the station?
...
Card focus: “How do I get to the station?”
Conversation moment: Dimas says “How do I get to the station?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open transit-stop map point before a walking route.
- Required background cues: a line-only route diagram, a start dot, one turn arrow, and a distant generic destination block.
- Context guardrail: The speakers are planning the route; do not show them already traveling, driving, or standing inside the destination.
...
Card focus: “for two minutes”
Conversation moment: Faris says “Go straight for two minutes.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open transit-stop map point before a walking route.
- Required background cues: a line-only route diagram, a start dot, one turn arrow, and a distant generic destination block.
- Context guardrail: The speakers are planning the route; do not show them already traveling, driving, or standing inside the destination.
...
Card focus: “at the bank”
Conversation moment: Faris says “Then turn right at the bank.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open transit-stop map point before a walking route.
- Required background cues: a line-only route diagram, a start dot, one turn arrow, and a distant generic destination block.
- Context guardrail: The speakers are planning the route; do not show them already traveling, driving, or standing inside the destination.
