...
- Lesson 3: **Sharing Email Addresses**
- Lesson key: `lesson-03-sharing-email-addresses`
- Web slug: `sharing-email-addresses`
- Dialogue speakers: **Officer, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-02-spelling-numbers-contact/lesson-03-sharing-email-addresses`
...
| `card-1.png` | 1254×1254 | What is your email address? |
| `card-2.png` | 1254×1254 | It's ben dot rama at example dot com. |
| `card-3.png` | 1254×1254 | Can you spell that, please? |
...
- PEOPLE COUNT — show exactly 1 adult man and 1 adult woman as the named foreground speakers: Officer, Ben. Include exactly two additional modestly dressed adult men as small, distant background figures to make the setting clearly public and prevent mixed-gender seclusion. No additional women, children, silhouettes, reflections, portraits, people on screens, or other human figures anywhere.
...
- The named cast must match the dialogue speakers: Officer, Ben. Do not change their genders, duplicate them, or replace them with generic people.
...
- Officer: Thank you. Is that correct?
...
## Card 1 prompt — What is your email address?
...
## Card 2 prompt — It's ben dot rama at example dot com.
...
## Card 3 prompt — Can you spell that, please?
