...
- Lesson 4: **Asking for Repetition**
- Lesson key: `lesson-04-asking-for-repetition`
- Web slug: `asking-for-repetition`
- Dialogue speakers: **Dimas, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-02-spelling-numbers-contact/lesson-04-asking-for-repetition`
...
| `card-1.png` | 1254×1254 | Sorry, can you repeat that, please? |
| `card-2.png` | 1254×1254 | Sure. |
| `card-3.png` | 1254×1254 | Did you say two two five five? |
...
Lesson: Asking for Repetition (A1, Unit 2, Lesson 4)
Conversation goal: Ask someone to repeat a name, number, or email address politely.
Situation: Kamu tidak mendengar informasi dengan jelas. Daripada menebak, kamu meminta orang lain mengulang dengan sopan dan mengecek bagian yang kamu dengar.
...
- The foreground cast must match the named dialogue speakers: Dimas, Ben. Do not change their genders, duplicate them, or replace them with generic people.
...
## Card 1 prompt — Sorry, can you repeat that, please?
...
Card focus: “Sorry, can you repeat that, please?”
Conversation moment: Ben says “Sorry, can you repeat that, please?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials and colleagues visible. The speakers are physically present in the same appropriate scene.
...
Card focus: “Sure.”
Conversation moment: Dimas says “Sure. Zero eight one three, two two five five, nine zero one.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials and colleagues visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — Did you say two two five five?
...
Card focus: “Did you say two two five five?”
Conversation moment: Ben says “Thank you. Did you say two two five five?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a public library media workspace with reference materials and colleagues visible. The speakers are physically present in the same appropriate scene.
