...
- Lesson 2: **Asking About Prices**
- Lesson key: `lesson-02-asking-about-prices`
- Web slug: `asking-about-prices`
- Dialogue speakers: **Dimas, Omar**
- Prompt folder: `content/visual-prompts/english/A1/unit-06-food-shopping-prices/lesson-02-asking-about-prices`
...
| `card-1.png` | 1254×1254 | How much is the coffee? |
| `card-2.png` | 1254×1254 | It is twenty thousand rupiah. |
| `card-3.png` | 1254×1254 | Twenty thousand rupiah? |
...
Lesson: Asking About Prices (A1, Unit 6, Lesson 2)
Conversation goal: Learners can ask the price of one item and understand a short price answer.
Situation: 
...
## Card 1 prompt — How much is the coffee?
...
Card focus: “How much is the coffee?”
Conversation moment: Dimas says “Excuse me. How much is the coffee?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a tidy public retail shop with relevant products visible. The speakers are physically present in the same appropriate scene.
...
## Card 2 prompt — It is twenty thousand rupiah.
...
Card focus: “It is twenty thousand rupiah.”
Conversation moment: Omar says “It is twenty thousand rupiah.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a tidy public retail shop with relevant products visible. The speakers are physically present in the same appropriate scene.
...
## Card 3 prompt — Twenty thousand rupiah?
...
Card focus: “Twenty thousand rupiah?”
Conversation moment: Omar says “It is twenty thousand rupiah.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene: a tidy public retail shop with relevant products visible. The speakers are physically present in the same appropriate scene.
