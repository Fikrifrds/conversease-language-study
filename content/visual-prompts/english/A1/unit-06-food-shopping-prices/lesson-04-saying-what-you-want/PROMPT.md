...
- Level: **A1**
- Unit 6: **Food, Shopping & Prices**
- Lesson 4: **Saying What You Want**
- Lesson key: `lesson-04-saying-what-you-want`
- Web slug: `saying-what-you-want`
- Dialogue speakers: **Omar, Dimas**
- Prompt folder: `content/visual-prompts/english/A1/unit-06-food-shopping-prices/lesson-04-saying-what-you-want`
...
| `card-1.png` | 1254×1254 | What do you want? |
| `card-2.png` | 1254×1254 | I want a sandwich. |
| `card-3.png` | 1254×1254 | Tea, please. |
...
Lesson: Saying What You Want (A1, Unit 6, Lesson 4)
Conversation goal: Learners can say what they want and choose between two simple options.
Situation: 

Scene and background:
- Actual conversation location: a public café service counter before ordering.
- Required background cues: two simple drink or snack options, a tray, and object-only menu cards without words.
- Context guardrail: Show the speaker indicating a preference at the counter; do not depict eating, a banquet, or a restaurant dining room.
...
## Card 1 prompt — What do you want?
...
Card focus: “What do you want?”
Conversation moment: Omar says “What do you want?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public café service counter before ordering.
- Required background cues: two simple drink or snack options, a tray, and object-only menu cards without words.
- Context guardrail: Show the speaker indicating a preference at the counter; do not depict eating, a banquet, or a restaurant dining room.
...
## Card 2 prompt — I want a sandwich.
...
Card focus: “I want a sandwich.”
Conversation moment: Dimas says “I want a sandwich.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public café service counter before ordering.
- Required background cues: two simple drink or snack options, a tray, and object-only menu cards without words.
- Context guardrail: Show the speaker indicating a preference at the counter; do not depict eating, a banquet, or a restaurant dining room.
...
Card focus: “Tea, please.”
Conversation moment: Dimas says “Tea, please.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a public café service counter before ordering.
- Required background cues: two simple drink or snack options, a tray, and object-only menu cards without words.
- Context guardrail: Show the speaker indicating a preference at the counter; do not depict eating, a banquet, or a restaurant dining room.
