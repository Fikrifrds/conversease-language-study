...
- Lesson 3: **Buying a Simple Item**
- Lesson key: `lesson-03-buying-a-simple-item`
- Web slug: `buying-a-simple-item`
- Dialogue speakers: **Ben, Dimas**
- Prompt folder: `content/visual-prompts/english/A1/unit-06-food-shopping-prices/lesson-03-buying-a-simple-item`
...
| `card-1.png` | 1254×1254 | Can I have this pen? |
| `card-2.png` | 1254×1254 | How much is it? |
| `card-3.png` | 1254×1254 | Here you go. |
...
Lesson: Buying a Simple Item (A1, Unit 6, Lesson 3)
Conversation goal: Learners can buy one simple item, ask the price, and complete the payment.
Situation: 

Scene and background:
- Actual conversation location: a small public retail shop counter.
- Required background cues: one basic item being selected, two shelf alternatives, a reusable bag, and a blank checkout display.
- Context guardrail: Show one simple purchase; do not turn the scene into a restaurant, supermarket crowd, or home delivery.
...
## Card 1 prompt — Can I have this pen?
...
Card focus: “Can I have this pen?”
Conversation moment: Ben says “Excuse me. Can I have this pen?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a small public retail shop counter.
- Required background cues: one basic item being selected, two shelf alternatives, a reusable bag, and a blank checkout display.
- Context guardrail: Show one simple purchase; do not turn the scene into a restaurant, supermarket crowd, or home delivery.
...
Card focus: “How much is it?”
Conversation moment: Ben says “How much is it?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a small public retail shop counter.
- Required background cues: one basic item being selected, two shelf alternatives, a reusable bag, and a blank checkout display.
- Context guardrail: Show one simple purchase; do not turn the scene into a restaurant, supermarket crowd, or home delivery.
...
Card focus: “Here you go.”
Conversation moment: Ben says “Okay. Here you go.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a small public retail shop counter.
- Required background cues: one basic item being selected, two shelf alternatives, a reusable bag, and a blank checkout display.
- Context guardrail: Show one simple purchase; do not turn the scene into a restaurant, supermarket crowd, or home delivery.
