...
- Lesson key: `lesson-01-telling-the-time`
- Web slug: `telling-the-time`
- Dialogue speakers: **Dimas, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-03-daily-routine-time/lesson-01-telling-the-time`
...
| `card-1.png` | 1254×1254 | What time is the class? |
| `card-2.png` | 1254×1254 | It's at nine o'clock. |
| `card-3.png` | 1254×1254 | In the morning? |
...
Lesson: Telling the Time (A1, Unit 3, Lesson 1)
Conversation goal: Learners can ask and answer a simple question about time.
Situation: Kamu ingin tahu jam mulai kelas online. Tanyakan waktunya, lalu cek apakah itu pagi, siang, atau malam.
...
## Card 1 prompt — What time is the class?
...
Card focus: “What time is the class?”
Conversation moment: Dimas says “What time is the class?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
## Card 2 prompt — It's at nine o'clock.
...
Card focus: “It's at nine o'clock.”
Conversation moment: Ben says “It's at nine o'clock.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
Card focus: “In the morning?”
Conversation moment: Dimas says “In the morning?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
