...
- Lesson 4: **Asking When Something Happens**
- Lesson key: `lesson-04-asking-when-something-happens`
- Web slug: `asking-when-something-happens`
- Dialogue speakers: **Dimas, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-03-daily-routine-time/lesson-04-asking-when-something-happens`
...
| `card-1.png` | 1254×1254 | When is the meeting? |
| `card-2.png` | 1254×1254 | It's tomorrow at ten. |
| `card-3.png` | 1254×1254 | Is it online? |
...
Lesson: Asking When Something Happens (A1, Unit 3, Lesson 4)
Conversation goal: Learners can ask when a simple event happens and confirm the details.
Situation: Kamu perlu ikut meeting singkat. Tanyakan kapan meeting berlangsung, apakah online, dan konfirmasi waktunya.
...
- Ben: It's tomorrow at ten.
- Dimas: Is it online?
- Ben: Yes, it is online.
- Dimas: Tomorrow at ten. Is that right?
...
## Card 1 prompt — When is the meeting?
...
Card focus: “When is the meeting?”
Conversation moment: Dimas says “When is the meeting?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
## Card 2 prompt — It's tomorrow at ten.
...
Card focus: “It's tomorrow at ten.”
Conversation moment: Ben says “It's tomorrow at ten.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
Card focus: “Is it online?”
Conversation moment: Dimas says “Is it online?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
