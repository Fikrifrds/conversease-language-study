...
- Level: **A1**
- Unit 3: **Daily Routine & Time**
- Lesson 5: **Routine Conversation Mission**
- Lesson key: `lesson-05-routine-conversation-mission`
- Web slug: `routine-conversation-mission`
- Dialogue speakers: **Dimas, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-03-daily-routine-time/lesson-05-routine-conversation-mission`
...
| `card-1.png` | 1254×1254 | What time do you wake up? |
| `card-2.png` | 1254×1254 | I wake up at six. |
| `card-3.png` | 1254×1254 | When do you study English? |
...
Lesson: Routine Conversation Mission (A1, Unit 3, Lesson 5)
Conversation goal: Learners can combine time, routine, days, and schedule questions in one simple conversation.
Situation: Ini misi akhir unit. Kamu berbicara tentang rutinitas pagi, jadwal belajar, hari kelas, dan waktu meeting sederhana.

Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
- Dimas: Is the class online?
- Ben: Yes, it is online.
...
## Card 1 prompt — What time do you wake up?
...
Card focus: “What time do you wake up?”
Conversation moment: Dimas says “Hi, Ben. What time do you wake up?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
## Card 2 prompt — I wake up at six.
...
Card focus: “I wake up at six.”
Conversation moment: Ben says “I wake up at six.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
## Card 3 prompt — When do you study English?
...
Card focus: “When do you study English?”
Conversation moment: Dimas says “When do you study English?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
