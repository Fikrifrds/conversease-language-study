...
- Lesson key: `lesson-02-talking-about-daily-routines`
- Web slug: `talking-about-daily-routines`
- Dialogue speakers: **Dimas, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-03-daily-routine-time/lesson-02-talking-about-daily-routines`
...
| `card-1.png` | 1254×1254 | What do you do in the morning? |
| `card-2.png` | 1254×1254 | I wake up at six. |
| `card-3.png` | 1254×1254 | What do you do after that? |
...
Lesson: Talking About Daily Routines (A1, Unit 3, Lesson 2)
Conversation goal: Learners can say a simple daily routine with time words.
Situation: Kamu mengobrol dengan teman kelas tentang kebiasaan pagi. Sebutkan kegiatan sederhana dan kapan kamu melakukannya.
...
- Dimas: Nice. Do you work in the afternoon?
- Ben: Yes, I work at one.
...
## Card 1 prompt — What do you do in the morning?
...
Card focus: “What do you do in the morning?”
Conversation moment: Dimas says “What do you do in the morning?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
## Card 3 prompt — What do you do after that?
...
Card focus: “What do you do after that?”
Conversation moment: Dimas says “What do you do after that?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
