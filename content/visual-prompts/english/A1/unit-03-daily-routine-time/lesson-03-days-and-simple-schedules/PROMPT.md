...
- Lesson 3: **Days and Simple Schedules**
- Lesson key: `lesson-03-days-and-simple-schedules`
- Web slug: `days-and-simple-schedules`
- Dialogue speakers: **Dimas, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-03-daily-routine-time/lesson-03-days-and-simple-schedules`
...
| `card-1.png` | 1254×1254 | When is the English class? |
| `card-2.png` | 1254×1254 | It's on Monday and Wednesday. |
| `card-3.png` | 1254×1254 | What time? |
...
Lesson: Days and Simple Schedules (A1, Unit 3, Lesson 3)
Conversation goal: Learners can talk about simple days and class schedules.
Situation: Kamu ingin tahu hari apa kelas berlangsung. Tanyakan jadwal sederhana, lalu ulangi hari dan jamnya.
...
## Card 1 prompt — When is the English class?
...
Card focus: “When is the English class?”
Conversation moment: Dimas says “When is the English class?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
## Card 2 prompt — It's on Monday and Wednesday.
...
Card focus: “It's on Monday and Wednesday.”
Conversation moment: Ben says “It's on Monday and Wednesday.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
...
Card focus: “What time?”
Conversation moment: Dimas says “What time?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open classroom schedule-planning corner.
- Required background cues: a clock face with hands but no numerals, a weekly planner made only of colored blocks, and study books.
- Context guardrail: The speakers are discussing routines and schedules now; do not turn the image into a bedroom, kitchen, morning montage, or literal meeting already in progress.
