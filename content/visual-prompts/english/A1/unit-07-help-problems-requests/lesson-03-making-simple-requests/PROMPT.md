...
- Lesson key: `lesson-03-making-simple-requests`
- Web slug: `making-simple-requests`
- Dialogue speakers: **Faris, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-07-help-problems-requests/lesson-03-making-simple-requests`
...
| `card-1.png` | 1254×1254 | Can you send me the link, please? |
| `card-2.png` | 1254×1254 | Yes, of course. |
...
Lesson: Making Simple Requests (A1, Unit 7, Lesson 3)
Conversation goal: Learners can make a simple request with please and respond to yes or no.
Situation: 
...
## Card 1 prompt — Can you send me the link, please?
...
Card focus: “Can you send me the link, please?”
Conversation moment: Faris says “Can you send me the link, please?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
Card focus: “Yes, of course.”
Conversation moment: Ben says “Yes, of course.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
Conversation moment: Ben says “Can you wait a minute?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
