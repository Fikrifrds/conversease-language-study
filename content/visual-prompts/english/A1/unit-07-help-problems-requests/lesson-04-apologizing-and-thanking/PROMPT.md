...
- Level: **A1**
- Unit 7: **Help, Problems & Requests**
- Lesson 4: **Apologizing and Thanking**
- Lesson key: `lesson-04-apologizing-and-thanking`
- Web slug: `apologizing-and-thanking`
- Dialogue speakers: **Ben, Omar**
- Prompt folder: `content/visual-prompts/english/A1/unit-07-help-problems-requests/lesson-04-apologizing-and-thanking`
...
| `card-1.png` | 1254×1254 | Sorry I'm late. |
| `card-2.png` | 1254×1254 | That's okay. |
| `card-3.png` | 1254×1254 | My internet was slow. |
...
Lesson: Apologizing and Thanking (A1, Unit 7, Lesson 4)
Conversation goal: Learners can apologize for a small problem and thank someone for help.
Situation: 

Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
Card focus: “Sorry I'm late.”
Conversation moment: Ben says “(breath) Sorry I'm late.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
Card focus: “That's okay.”
Conversation moment: Omar says “That's okay.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
## Card 3 prompt — My internet was slow.
...
Card focus: “My internet was slow.”
Conversation moment: Ben says “My internet was slow.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
