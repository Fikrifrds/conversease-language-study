...
- Lesson 1: **Saying You Do Not Understand**
- Lesson key: `lesson-01-saying-you-do-not-understand`
- Web slug: `saying-you-do-not-understand`
- Dialogue speakers: **Dimas, Ben**
- Prompt folder: `content/visual-prompts/english/A1/unit-07-help-problems-requests/lesson-01-saying-you-do-not-understand`
...
| `card-2.png` | 1254×1254 | Can you repeat that, please? |
| `card-3.png` | 1254×1254 | Open my book? |
...
Lesson: Saying You Do Not Understand (A1, Unit 7, Lesson 1)
Conversation goal: Learners can say they do not understand and ask for repetition politely.
Situation: 
...
Conversation moment: Dimas says “Sorry, I don't understand.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
## Card 2 prompt — Can you repeat that, please?
...
Card focus: “Can you repeat that, please?”
Conversation moment: Dimas says “Can you repeat that, please?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
Card focus: “Open my book?”
Conversation moment: Dimas says “Open my book?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
