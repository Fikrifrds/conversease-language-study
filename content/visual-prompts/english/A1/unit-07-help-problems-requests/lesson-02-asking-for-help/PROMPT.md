...
- Lesson key: `lesson-02-asking-for-help`
- Web slug: `asking-for-help`
- Dialogue speakers: **Dimas, Omar**
- Prompt folder: `content/visual-prompts/english/A1/unit-07-help-problems-requests/lesson-02-asking-for-help`
...
| `card-1.png` | 1254×1254 | Can you help me? |
| `card-2.png` | 1254×1254 | What is the problem? |
| `card-3.png` | 1254×1254 | I can't open this file. |
...
- The named cast must match the dialogue speakers: Dimas, Omar. Do not change their genders, duplicate them, or replace them with generic people.
...
Lesson: Asking for Help (A1, Unit 7, Lesson 2)
Conversation goal: Learners can ask for help with one simple task and respond to the helper.
Situation: 
...
Card focus: “Can you help me?”
Conversation moment: Dimas says “Excuse me. Can you help me?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
## Card 2 prompt — What is the problem?
...
Card focus: “What is the problem?”
Conversation moment: Omar says “Sure. What is the problem?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
...
## Card 3 prompt — I can't open this file.
...
Conversation moment: Dimas says “I can't open this file.”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: an open learning-center help desk.
- Required background cues: a blank form, pen, small study device, and neatly arranged task materials that make the request visible.
- Context guardrail: This is a small everyday learning problem, not an emergency, police station, hospital crisis, or private room.
