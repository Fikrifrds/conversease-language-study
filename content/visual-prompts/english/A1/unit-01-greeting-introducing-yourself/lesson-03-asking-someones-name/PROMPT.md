...
- Lesson 3: **Asking Someone's Name**
- Lesson key: `lesson-03-asking-someones-name`
- Web slug: `asking-someones-name`
- Dialogue speakers: **Adi, Raka**
- Prompt folder: `content/visual-prompts/english/A1/unit-01-greeting-introducing-yourself/lesson-03-asking-someones-name`
...
| `card-1.png` | 1254×1254 | What's your name? |
| `card-2.png` | 1254×1254 | May I know your name? |
| `card-3.png` | 1254×1254 | Is it Raka? |
...
- The foreground cast must match the named dialogue speakers: Adi, Raka. Do not change their genders, duplicate them, or replace them with generic people.
...
## Card 1 prompt — What's your name?
...
## Card 2 prompt — May I know your name?
