...
- Lesson 5: **First Conversation Mission**
- Lesson key: `lesson-05-first-conversation-mission`
- Web slug: `first-conversation-mission`
- Dialogue speakers: **Raka, Adi**
- Prompt folder: `content/visual-prompts/english/A1/unit-01-greeting-introducing-yourself/lesson-05-first-conversation-mission`
...
| `card-1.png` | 1254×1254 | Good morning. My name is ... |
| `card-2.png` | 1254×1254 | Where are you from? |
...
Lesson: First Conversation Mission (A1, Unit 1, Lesson 5)
Conversation goal: Combine greeting, name, origin, and a polite closing in one short conversation.
Situation: 
...
## Card 1 prompt — Good morning. My name is ...
...
Card focus: “Good morning. My name is ...”
Conversation moment: Raka says “Hi, my name is Raka. What is your name?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a bright open English classroom beside the classroom entrance.
- Required background cues: a blank whiteboard, two learner desks, notebooks, and a small plant; the doorway remains visibly open.
- Context guardrail: This is a first meeting before or after class, not a home, private room, ceremony, or formal presentation.
...
## Card 2 prompt — Where are you from?
...
Card focus: “Where are you from?”
Conversation moment: Raka says “Nice to meet you too. I'm from Indonesia. Where are you from?”. Show this meaning through natural gesture, attention, and relevant props; do not render the quote or any other words in the image.
Scene and background:
- Actual conversation location: a bright open English classroom beside the classroom entrance.
- Required background cues: a blank whiteboard, two learner desks, notebooks, and a small plant; the doorway remains visibly open.
- Context guardrail: This is a first meeting before or after class, not a home, private room, ceremony, or formal presentation.
