...
After this lesson, learners can hold a final B2 discussion: frame the issue, compare options, address concerns, and align on a decision.

## Situation

Final: kamu pimpin diskusi profesional yang utuh dan natural (problem framing, trade-off, rekomendasi, next steps).
