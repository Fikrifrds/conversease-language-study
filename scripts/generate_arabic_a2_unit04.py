...
UNIT: dict[str, Any] = {
    ...
    "lessons": [
        ...
        },
        {
            ...
            "dialogue": [
                line("Ahmad", "أُرِيدُ قَمِيصًا أَبْيَضَ، مِنْ فَضْلِكَ.", "Saya ingin kemeja putih, tolong."),
                line("Karim", "هَذَا قَمِيصٌ أَبْيَضُ. هَلِ الْمَقَاسُ مُنَاسِبٌ؟", "Ini kemeja putih. Apakah ukurannya cocok?"),
                line("Ahmad", "هَذَا صَغِيرٌ جِدًّا. هَلْ عِنْدَكُمْ مَقَاسٌ أَكْبَرُ؟", "Ini terlalu kecil. Apakah kalian punya ukuran yang lebih besar?"),
                line("Karim", "نَعَمْ، هَذَا مَقَاسٌ أَكْبَرُ.", "Ya, ini ukuran yang lebih besar."),
                line("Ahmad", "هَلْ أَسْتَطِيعُ أَنْ أُجَرِّبَهُ؟", "Bolehkah saya mencobanya?"),
                line("Karim", "نَعَمْ، غُرْفَةُ التَّجْرِبَةِ هُنَاكَ.", "Ya, ruang cobanya di sana."),
                line("Ahmad", "جَيِّدٌ، هَذَا مُنَاسِبٌ.", "Bagus, ini cocok."),
            ],
        },
        {
        ...
        },
        {
            ...
            "dialogue": [
                ...
                line("Fatimah", "عِنْدَنَا هَذِهِ الْحَقِيبَةُ بِاللَّوْنِ الْأَسْوَدِ.", "Kami punya tas ini dengan warna hitam."),
                line("Layla", "هَلْ يُوجَدُ لَوْنٌ أَزْرَقُ؟", "Apakah ada warna biru?"),
                line("Fatimah", "نَعَمْ، وَهَذَا الْمَقَاسُ أَكْبَرُ قَلِيلًا.", "Ya, dan ukuran ini sedikit lebih besar."),
                line("Layla", "أَيُّهُمَا أَفْضَلُ؟", "Mana yang lebih baik?"),
                line("Fatimah", "الْأَزْرَقُ أَجْوَدُ، وَلَكِنَّهُ أَغْلَى.", "Yang biru lebih bagus kualitasnya, tetapi lebih mahal."),
                ...
                line("Fatimah", "زَمِيلِي كَرِيمٌ فِي قِسْمِ الْخِدْمَةِ.", "Rekan saya Karim ada di bagian layanan."),
