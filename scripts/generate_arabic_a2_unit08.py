...
UNIT: dict[str, Any] = {
    ...
    "lessons": [
        ...
        },
        {
            ...
            "dialogue": [
                line("Dimas", "أُرِيدُ تَذْكِرَةً إِلَى بَانْدُونْغ، مِنْ فَضْلِكِ.", "Saya ingin tiket ke Bandung, tolong."),
                line("Huda", "ذَهَابًا فَقَطْ؟", "Sekali jalan saja?"),
                line("Dimas", "نَعَمْ. مَتَى يَغَادِرُ الْقِطَارُ؟", "Ya. Kapan keretanya berangkat?"),
                line("Huda", "يُغَادِرُ السَّاعَةَ الثَّامِنَةَ مِنَ الرَّصِيفِ الثَّانِي.", "Berangkat jam delapan dari peron dua."),
                line("Dimas", "كَيْفَ أَذْهَبُ إِلَى الرَّصِيفِ؟", "Bagaimana saya pergi ke peron?"),
                line("Huda", "اِمْشِ مُسْتَقِيمًا، ثُمَّ اِتَّجِهْ يَمِينًا.", "Berjalan lurus, lalu belok kanan."),
                ...
                line("Huda", "قِسْمُ الْخِدْمَةِ بِجَانِبِ الْبَابِ.", "Bagian layanan ada di samping pintu."),
            ],
        },
        {
