    ...
    "lessons": [
        {
            ...
            "dialogue": [
                line("Ahmad", "أُرِيدُ تَذْكِرَةً إِلَى جَاكَرْتَا، مِنْ فَضْلِكَ.", "Saya ingin tiket ke Jakarta, tolong."),
                line("Karim", "ذَهَابًا فَقَطْ أَمْ ذَهَابًا وَعَوْدَةً؟", "Sekali jalan saja atau pulang pergi?"),
                line("Ahmad", "ذَهَابًا فَقَطْ.", "Sekali jalan saja."),
                line("Karim", "الدَّرَجَةُ الِاقْتِصَادِيَّةُ أَمِ الدَّرَجَةُ الْأُولَى؟", "Kelas ekonomi atau kelas pertama?"),
                line("Ahmad", "الدَّرَجَةُ الِاقْتِصَادِيَّةُ، مِنْ فَضْلِكَ.", "Kelas ekonomi, tolong."),
                line("Karim", "السِّعْرُ خَمْسُونَ أَلْفَ رُوبِيَّةٍ.", "Harganya lima puluh ribu rupiah."),
                line("Ahmad", "تَفَضَّلْ. شُكْرًا.", "Silakan. Terima kasih."),
            ],
        },
        {
        ...
        },
        {
            ...
            "dialogue": [
                line("Dimas", "أُرِيدُ تَذْكِرَةً إِلَى الْمَدِينَةِ، مِنْ فَضْلِكَ.", "Saya ingin tiket ke kota, tolong."),
                line("Ahmad", "ذَهَابًا فَقَطْ؟", "Sekali jalan saja?"),
                line("Dimas", "نَعَمْ. مَتَى يَغَادِرُ الْقِطَارُ؟", "Ya. Kapan keretanya berangkat?"),
                line("Ahmad", "يُغَادِرُ السَّاعَةَ الثَّامِنَةَ مِنَ الرَّصِيفِ الْأَوَّلِ.", "Berangkat jam delapan dari peron satu."),
                line("Dimas", "شُكْرًا. كَيْفَ أَذْهَبُ إِلَى الرَّصِيفِ؟", "Terima kasih. Bagaimana saya pergi ke peron?"),
                line("Ahmad", "اِمْشِ مُسْتَقِيمًا، ثُمَّ اِتَّجِهْ يَسَارًا.", "Berjalan lurus, lalu belok kiri."),
