...
8. Do not use religious source text, hadith, dhikr, or devotional phrases with
   ...
   exists.
9. Use conversation-first visuals: show who is speaking, who they are speaking
   ...
   same-gender, or clearly separated compositions for mixed speaker sets. Arabic
   visuals do not automatically need peci/songkok or other culture-specific
   clothing unless the speaker/context calls for it. Reuse English/Arabic assets
   when the scene, speaker profile, and phrase context match. Use UI/online
